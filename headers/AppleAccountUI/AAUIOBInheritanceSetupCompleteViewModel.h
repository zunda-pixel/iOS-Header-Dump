...
@class AACustodianshipInfo, AAOBInheritanceSetupCompleteModel, UIImage, UIView;
...
/* instance methods */
- (id)initWithBeneficiaryName:(id)name accessKeyShareType:(unsigned long long)type;
- (id)initWithBeneficiaryName:(id)name accessKeyShareType:(unsigned long long)type inviteType:(unsigned long long)type;
- (void)_setInheritanceInvitationImageIfNecessary;

@end

#endif /* AAUIOBInheritanceSetupCompleteViewModel_h */
