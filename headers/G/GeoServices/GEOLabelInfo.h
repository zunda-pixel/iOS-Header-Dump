...
@interface GEOLabelInfo : PBCodable <NSCopying> {
    ...
    struct { unsigned int read_unknownFields:1; unsigned int read_detail:1; unsigned int read_iconArtwork:1; unsigned int read_labelStyleAttributes:1; unsigned int read_title:1; unsigned int wrote_anyField:1; } _flags;
}
