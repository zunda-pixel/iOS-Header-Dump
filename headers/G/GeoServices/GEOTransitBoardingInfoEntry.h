...
@interface GEOTransitBoardingInfoEntry : PBCodable <NSCopying> {
    ...
    struct { unsigned int has_expectedDepartureTime:1; unsigned int has_clearExitPlanInfo:1; unsigned int read_unknownFields:1; unsigned int read_alternativeText:1; unsigned int read_alternativeTimeInstruction:1; unsigned int read_exitPlanInfoOverride:1; unsigned int read_mainText:1; unsigned int read_mainTimeInstruction:1; unsigned int read_occupancyInfo:1; unsigned int wrote_anyField:1; } _flags;
}
