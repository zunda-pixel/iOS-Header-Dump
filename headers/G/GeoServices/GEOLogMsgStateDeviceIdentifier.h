...
@interface GEOLogMsgStateDeviceIdentifier : PBCodable <NSCopying> {
    ...
    struct { unsigned int has_deviceDarkMode:1; unsigned int has_isInternalInstall:1; unsigned int has_isInternalTool:1; unsigned int read_unknownFields:1; unsigned int read_deviceHwIdentifier:1; unsigned int read_deviceOsVersion:1; unsigned int wrote_anyField:1; } _flags;
}
