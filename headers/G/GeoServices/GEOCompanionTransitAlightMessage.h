...
@interface GEOCompanionTransitAlightMessage : PBCodable <NSCopying> {
    ...
    struct { unsigned int has_stepID:1; unsigned int has_stopID:1; unsigned int read_artwork:1; unsigned int read_detail:1; unsigned int read_identifier:1; unsigned int read_title:1; unsigned int wrote_anyField:1; } _flags;
}
