...
@interface GEORPUserLocationDetails : PBCodable <NSCopying> {
    ...
    struct { unsigned int read_currentTime:1; unsigned int read_currentUserLocation:1; unsigned int read_deviceHistoricalLocations:1; unsigned int read_lastKnownRoadLocation:1; unsigned int wrote_anyField:1; } _flags;
}
