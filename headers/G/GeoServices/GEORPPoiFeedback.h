...
@interface GEORPPoiFeedback : PBCodable <NSCopying> {
    ...
    struct { unsigned int has_correctionType:1; unsigned int has_addOtherPoi:1; unsigned int read_unknownFields:1; unsigned int read_corrections:1; unsigned int read_placeRequest:1; unsigned int read_place:1; unsigned int read_poiCuratedCollectionContext:1; unsigned int wrote_anyField:1; } _flags;
}
