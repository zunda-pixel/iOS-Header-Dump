...
@interface GEORPLayoutField : PBCodable <NSCopying> {
    ...
    struct { unsigned int has_ordinal:1; unsigned int has_type:1; unsigned int has_enabled:1; unsigned int read_displayText:1; unsigned int read_name:1; unsigned int wrote_anyField:1; } _flags;
}
