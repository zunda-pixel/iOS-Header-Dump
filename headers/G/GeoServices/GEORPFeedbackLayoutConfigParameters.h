...
@interface GEORPFeedbackLayoutConfigParameters : PBCodable <NSCopying> {
    ...
    struct { unsigned int has_formType:1; unsigned int read_coordinate:1; unsigned int read_mapRegion:1; unsigned int read_mapsId:1; unsigned int wrote_anyField:1; } _flags;
}
