...
@interface GEORPFeedbackBusinessHours : PBCodable <NSCopying> {
    ...
    struct { unsigned int has_end:1; unsigned int has_start:1; unsigned int has_hoursType:1; unsigned int read_comments:1; unsigned int read_weeklyHours:1; unsigned int wrote_anyField:1; } _flags;
}
