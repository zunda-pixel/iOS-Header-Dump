...
@interface GEOLPRVehicle : PBCodable <NSCopying> {
    ...
    struct { unsigned int read_licensePlate:1; unsigned int read_name:1; unsigned int read_powerTypeKey:1; unsigned int read_vehicleTypeKey:1; unsigned int wrote_anyField:1; } _flags;
}
