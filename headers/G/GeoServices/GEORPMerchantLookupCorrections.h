...
@interface GEORPMerchantLookupCorrections : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int has_isCategoryIncorrect:1; unsigned int has_isMerchantIncorrect:1; unsigned int has_isOtherIssue:1; } _flags;
}
...
#endif /* GEORPMerchantLookupCorrections_h */
