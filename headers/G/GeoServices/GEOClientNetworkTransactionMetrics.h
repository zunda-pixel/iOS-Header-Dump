...
@interface GEOClientNetworkTransactionMetrics : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int has_connectEnd:1; unsigned int has_connectStart:1; unsigned int has_domainLookupEnd:1; unsigned int has_domainLookupStart:1; unsigned int has_fetchStart:1; unsigned int has_requestEnd:1; unsigned int has_requestStart:1; unsigned int has_responseEnd:1; unsigned int has_responseStart:1; unsigned int has_secureConnectEnd:1; unsigned int has_secureConnectStart:1; unsigned int has_multipathServiceType:1; unsigned int has_protocolName:1; unsigned int has_resourceFetchType:1; unsigned int has_isMultipath:1; unsigned int has_proxyConnection:1; unsigned int has_reusedConnection:1; unsigned int has_usedCellular:1; } _flags;
}
