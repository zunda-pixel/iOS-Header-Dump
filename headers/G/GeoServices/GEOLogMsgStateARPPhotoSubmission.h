...
@interface GEOLogMsgStateARPPhotoSubmission : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int has_numberOfAprSuggestedPhotos:1; unsigned int has_numberOfPhotos:1; unsigned int has_isFromMapsSuggesions:1; unsigned int has_isFromRecommendationCard:1; unsigned int has_isPlacecardInlineSubmission:1; } _flags;
}
