...
@interface GEOCollectionDetails : PBCodable <NSCopying> {
    ...
    struct { unsigned int has_targetId:1; unsigned int has_currentlySaved:1; unsigned int read_unknownFields:1; unsigned int read_collectionIds:1; unsigned int read_collectionCategory:1; unsigned int wrote_anyField:1; } _flags;
}
