...
@interface GEOLogMsgEventRefineSearchSession : PBCodable <NSCopying> {
    ...
    struct { unsigned int has_refineSearchType:1; unsigned int has_searchType:1; unsigned int read_searchString:1; unsigned int read_suggestionItems:1; unsigned int wrote_anyField:1; } _flags;
}
