...
@interface GEOLogMsgStateLookAroundView : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int has_zoomLevel:1; unsigned int has_heading:1; unsigned int has_numberPoisInView:1; unsigned int has_isLabelingShown:1; } _flags;
}
...
#endif /* GEOLogMsgStateLookAroundView_h */
