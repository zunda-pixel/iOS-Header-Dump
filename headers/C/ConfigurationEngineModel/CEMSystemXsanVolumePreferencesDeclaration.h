...
+ (id)buildWithIdentifier:(id)identifier withOnlyMount:(id)mount withDenyMount:(id)mount withDenyDLC:(id)dlc withPreferDLC:(id)dlc withUseDLC:(id)dlc;
...
#endif /* CEMSystemXsanVolumePreferencesDeclaration_h */
