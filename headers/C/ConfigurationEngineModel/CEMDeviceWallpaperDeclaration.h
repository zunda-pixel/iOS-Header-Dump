...
+ (id)buildWithIdentifier:(id)identifier withLockScreenAsset:(id)asset withHomeScreenAsset:(id)asset withAllowWallpaperModification:(id)modification;
...
#endif /* CEMDeviceWallpaperDeclaration_h */
