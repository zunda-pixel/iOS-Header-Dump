...
@class OS_remote_device, OS_remote_device_browser, OS_xpc_remote_connection;
...
- (id)initWithQueue:(id)queue IsRemoteRecording:(_Bool)recording;
- (_Bool)isRemoteDeviceDarwin;
- (_Bool)isRemoteDeviceGibraltar;
