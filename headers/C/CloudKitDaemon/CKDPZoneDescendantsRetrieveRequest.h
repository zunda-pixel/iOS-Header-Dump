...
//
#ifndef CKDPZoneDescendantsRetrieveRequest_h
#define CKDPZoneDescendantsRetrieveRequest_h
@import Foundation;
...
@interface CKDPZoneDescendantsRetrieveRequest : PBRequest <NSCopying> {
    /* instance variables */
    struct { unsigned int limit:1; unsigned int traversalType:1; } _has;
}
...
#endif /* CKDPZoneDescendantsRetrieveRequest_h */
