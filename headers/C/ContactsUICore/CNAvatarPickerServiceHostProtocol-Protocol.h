...
//
#ifndef CNAvatarPickerServiceHostProtocol_Protocol_h
#define CNAvatarPickerServiceHostProtocol_Protocol_h
@import Foundation;
...
#endif /* CNAvatarPickerServiceHostProtocol_Protocol_h */
