...
//
#ifndef VFXRECachedRenderCommandEncoder_h
#define VFXRECachedRenderCommandEncoder_h
@import Foundation;
...
@interface VFXRECachedRenderCommandEncoder : NSObject <MTLRenderCommandEncoder> {
    ...
    struct RenderCommandEncoder { id m_object; struct RenderEncoderImpCache *m_impCache; } _encoderCPP;
    void * _encoderState;
}
...
#endif /* VFXRECachedRenderCommandEncoder_h */
