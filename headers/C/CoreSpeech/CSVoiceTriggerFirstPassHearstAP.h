...
#include "CSVoiceTriggerHearstAPEnabledPolicy.h"
#include "CSVoiceTriggerSecondChanceContext.h"
#include "CSVoiceTriggerSecondPass.h"
#include "CSVoiceTriggerUserSelectedPhrase.h"

@class CSAsset, CSAudioProvider, CSAudioStream, CSKeywordAnalyzerNDAPI, CSOSTransaction, CSRemoteVADSignalExtractor, CSSiriClientBehaviorMonitor;
@protocol CSOtherAppRecordingStateMonitorProviding, OS_dispatch_group, OS_dispatch_queue;
...
@property (nonatomic) _Bool isAPHearstFirstPassEnabled;
...
- (void)_startListenWithAudioProviderUUID:(id)uuid completion:(id /* block */)completion;
- (void)_teardownSecondPass;
- (void)_transitHearstAPEnable:(_Bool)apenable withAudioProviderUUID:(id)uuid;
- (id)initWithSpeechManager:(id)manager voiceTriggerEnabledMonitor:(id)monitor siriClientBehaviorMonitor:(id)monitor opportuneSpeakEventMonitor:(id)monitor phoneCallStateMonitor:(id)monitor otherAppRecordingStateMonitor:(id)monitor voiceTriggerHearstAPEnabledPolicy:(id)policy;
