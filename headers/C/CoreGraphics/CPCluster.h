...
@interface CPCluster : NSObject <CPDisposable> {
    /* instance variables */
    const struct { double x0; unsigned int x1; double x2; double x3; unsigned int x4; double x5; double x6; _Bool x7; double x8; double x9; double x10; double x11; double x12; double x13; double x14; double x15; double x16; double x17; double x18; _Bool x19; } * profile;
    unsigned int xCount;
    double * x;
    double * dx;
...
+ (unsigned int *)createOrderIndexFor:(double *)_for ofSize:(unsigned int)size;
+ (void)reclusterTextLine:(id)line fromWordIndex:(unsigned int)index count:(unsigned int *)count;

/* instance methods */
- (id)initWithProfile:(const struct { double x0; unsigned int x1; double x2; double x3; unsigned int x4; double x5; double x6; _Bool x7; double x8; double x9; double x10; double x11; double x12; double x13; double x14; double x15; double x16; double x17; double x18; _Bool x19; } *)profile;
- (void)dealloc;
- (void)finalize;
- (void)dispose;
- (id)init;
...
- (_Bool)applyDifferenceHints:(struct { unsigned int x0; double x1; double x2; double x3; } *)hints count:(unsigned int)count;
...
- (void)tryLevel0SplitBetween:(double)between and:(double)_and usingHints:(struct { unsigned int x0; double x1; double x2; double x3; } *)hints;
