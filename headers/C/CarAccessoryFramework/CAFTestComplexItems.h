...
//
#ifndef CAFTestComplexItems_h
#define CAFTestComplexItems_h
@import Foundation;

@interface CAFTestComplexItems : NSObject <NSFastEnumeration>

@property (readonly, nonatomic) NSArray *testComplexItems;
...
- (id)initWithTestComplexItems:(id)items;

@end

#endif /* CAFTestComplexItems_h */
