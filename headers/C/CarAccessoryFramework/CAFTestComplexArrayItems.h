...
//
#ifndef CAFTestComplexArrayItems_h
#define CAFTestComplexArrayItems_h
@import Foundation;

@interface CAFTestComplexArrayItems : NSObject <NSFastEnumeration>

@property (readonly, nonatomic) NSArray *testComplexArrayItems;
...
- (id)initWithTestComplexArrayItems:(id)items;

@end

#endif /* CAFTestComplexArrayItems_h */
