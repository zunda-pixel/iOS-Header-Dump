...
//
#ifndef CAFHistoricalNotificationUserActions_h
#define CAFHistoricalNotificationUserActions_h
@import Foundation;

@interface CAFHistoricalNotificationUserActions : NSObject <NSFastEnumeration>

@property (readonly, nonatomic) NSArray *historicalNotificationUserActions;
...
- (id)initWithHistoricalNotificationUserActions:(id)actions;

@end

#endif /* CAFHistoricalNotificationUserActions_h */
