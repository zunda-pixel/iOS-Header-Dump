...
@interface SGM2ContactRejected : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int app:1; unsigned int extracted:1; unsigned int extractionModelVersion:1; unsigned int type:1; unsigned int uiType:1; unsigned int selfId:1; } _has;
}
