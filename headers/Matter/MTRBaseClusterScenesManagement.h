...
//
#ifndef MTRBaseClusterScenesManagement_h
#define MTRBaseClusterScenesManagement_h
@import Foundation;
...
+ (void)readAttributeFabricSceneInfoWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
...
- (void)readAttributeFabricSceneInfoWithParams:(id)params completion:(id /* block */)completion;
...
- (void)subscribeAttributeFabricSceneInfoWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
...
#endif /* MTRBaseClusterScenesManagement_h */
