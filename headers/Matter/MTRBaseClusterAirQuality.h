...
//
#ifndef MTRBaseClusterAirQuality_h
#define MTRBaseClusterAirQuality_h
@import Foundation;
...
+ (void)readAttributeAirQualityWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
...
- (void)readAttributeAirQualityWithCompletion:(id /* block */)completion;
...
- (void)subscribeAttributeAirQualityWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
...
#endif /* MTRBaseClusterAirQuality_h */
