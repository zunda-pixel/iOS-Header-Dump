...
//
#ifndef MTRBaseClusterSoilMeasurement_h
#define MTRBaseClusterSoilMeasurement_h
@import Foundation;
...
+ (void)readAttributeSoilMoistureMeasuredValueWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
+ (void)readAttributeSoilMoistureMeasurementLimitsWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
...
- (void)readAttributeSoilMoistureMeasuredValueWithCompletion:(id /* block */)completion;
- (void)readAttributeSoilMoistureMeasurementLimitsWithCompletion:(id /* block */)completion;
...
- (void)subscribeAttributeSoilMoistureMeasuredValueWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)subscribeAttributeSoilMoistureMeasurementLimitsWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;

@end

#endif /* MTRBaseClusterSoilMeasurement_h */
