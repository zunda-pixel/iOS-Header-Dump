...
//
#ifndef MTRBaseClusterGroupcast_h
#define MTRBaseClusterGroupcast_h
@import Foundation;
...
+ (void)readAttributeMaxMembershipCountWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
+ (void)readAttributeMembershipWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;

/* instance methods */
- (void)joinGroupWithParams:(id)params completion:(id /* block */)completion;
- (void)configureAuxiliaryACLWithParams:(id)params completion:(id /* block */)completion;
- (void)expireGracePeriodWithParams:(id)params completion:(id /* block */)completion;
- (void)leaveGroupWithParams:(id)params completion:(id /* block */)completion;
...
- (void)readAttributeMaxMembershipCountWithCompletion:(id /* block */)completion;
- (void)readAttributeMembershipWithParams:(id)params completion:(id /* block */)completion;
...
- (void)subscribeAttributeMaxMembershipCountWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)subscribeAttributeMembershipWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)updateGroupKeyWithParams:(id)params completion:(id /* block */)completion;

@end

#endif /* MTRBaseClusterGroupcast_h */
