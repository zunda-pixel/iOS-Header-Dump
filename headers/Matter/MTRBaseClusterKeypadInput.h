...
- (void)sendKeyWithParams:(id)params completion:(id /* block */)completion;
- (void)sendKeyWithParams:(id)params completionHandler:(id /* block */)handler;
...
#endif /* MTRBaseClusterKeypadInput_h */
