...
+ (void)readAttributeSourcesWithAttributeCache:(id)cache endpoint:(id)endpoint queue:(id)queue completionHandler:(id /* block */)handler;
+ (void)readAttributeSourcesWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
...
- (void)readAttributeSourcesWithCompletion:(id /* block */)completion;
- (void)readAttributeSourcesWithCompletionHandler:(id /* block */)handler;
...
- (void)subscribeAttributeSourcesWithMinInterval:(id)interval maxInterval:(id)interval params:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)subscribeAttributeSourcesWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;

@end

#endif /* MTRBaseClusterPowerSourceConfiguration_h */
