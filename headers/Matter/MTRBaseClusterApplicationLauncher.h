...
+ (void)readAttributeCatalogListWithAttributeCache:(id)cache endpoint:(id)endpoint queue:(id)queue completionHandler:(id /* block */)handler;
+ (void)readAttributeCatalogListWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
...
+ (void)readAttributeCurrentAppWithAttributeCache:(id)cache endpoint:(id)endpoint queue:(id)queue completionHandler:(id /* block */)handler;
+ (void)readAttributeCurrentAppWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
...
- (void)launchAppWithParams:(id)params completion:(id /* block */)completion;
- (void)hideAppWithCompletion:(id /* block */)completion;
- (void)hideAppWithParams:(id)params completion:(id /* block */)completion;
- (void)hideAppWithParams:(id)params completionHandler:(id /* block */)handler;
- (void)launchAppWithCompletion:(id /* block */)completion;
- (void)launchAppWithParams:(id)params completionHandler:(id /* block */)handler;
...
- (void)readAttributeCatalogListWithCompletion:(id /* block */)completion;
- (void)readAttributeCatalogListWithCompletionHandler:(id /* block */)handler;
...
- (void)readAttributeCurrentAppWithCompletion:(id /* block */)completion;
- (void)readAttributeCurrentAppWithCompletionHandler:(id /* block */)handler;
...
- (void)stopAppWithCompletion:(id /* block */)completion;
- (void)stopAppWithParams:(id)params completion:(id /* block */)completion;
- (void)stopAppWithParams:(id)params completionHandler:(id /* block */)handler;
...
- (void)subscribeAttributeCatalogListWithMinInterval:(id)interval maxInterval:(id)interval params:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)subscribeAttributeCatalogListWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
...
- (void)subscribeAttributeCurrentAppWithMinInterval:(id)interval maxInterval:(id)interval params:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)subscribeAttributeCurrentAppWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
...
- (void)writeAttributeCurrentAppWithValue:(id)value completion:(id /* block */)completion;
- (void)writeAttributeCurrentAppWithValue:(id)value completionHandler:(id /* block */)handler;
- (void)writeAttributeCurrentAppWithValue:(id)value params:(id)params completion:(id /* block */)completion;
- (void)writeAttributeCurrentAppWithValue:(id)value params:(id)params completionHandler:(id /* block */)handler;

@end

#endif /* MTRBaseClusterApplicationLauncher_h */
