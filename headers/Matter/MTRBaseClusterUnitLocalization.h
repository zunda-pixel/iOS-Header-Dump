...
+ (void)readAttributeSupportedTemperatureUnitsWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
+ (void)readAttributeTemperatureUnitWithAttributeCache:(id)cache endpoint:(id)endpoint queue:(id)queue completionHandler:(id /* block */)handler;
+ (void)readAttributeTemperatureUnitWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
...
- (void)readAttributeSupportedTemperatureUnitsWithCompletion:(id /* block */)completion;
- (void)readAttributeTemperatureUnitWithCompletion:(id /* block */)completion;
- (void)readAttributeTemperatureUnitWithCompletionHandler:(id /* block */)handler;
...
- (void)subscribeAttributeSupportedTemperatureUnitsWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)subscribeAttributeTemperatureUnitWithMinInterval:(id)interval maxInterval:(id)interval params:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)subscribeAttributeTemperatureUnitWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)writeAttributeTemperatureUnitWithValue:(id)value completion:(id /* block */)completion;
- (void)writeAttributeTemperatureUnitWithValue:(id)value completionHandler:(id /* block */)handler;
- (void)writeAttributeTemperatureUnitWithValue:(id)value params:(id)params completion:(id /* block */)completion;
- (void)writeAttributeTemperatureUnitWithValue:(id)value params:(id)params completionHandler:(id /* block */)handler;

@end

#endif /* MTRBaseClusterUnitLocalization_h */
