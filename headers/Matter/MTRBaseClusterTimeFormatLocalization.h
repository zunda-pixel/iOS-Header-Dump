...
+ (void)readAttributeActiveCalendarTypeWithAttributeCache:(id)cache endpoint:(id)endpoint queue:(id)queue completionHandler:(id /* block */)handler;
+ (void)readAttributeActiveCalendarTypeWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
...
+ (void)readAttributeHourFormatWithAttributeCache:(id)cache endpoint:(id)endpoint queue:(id)queue completionHandler:(id /* block */)handler;
+ (void)readAttributeHourFormatWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
+ (void)readAttributeSupportedCalendarTypesWithAttributeCache:(id)cache endpoint:(id)endpoint queue:(id)queue completionHandler:(id /* block */)handler;
+ (void)readAttributeSupportedCalendarTypesWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
...
- (void)readAttributeActiveCalendarTypeWithCompletion:(id /* block */)completion;
- (void)readAttributeActiveCalendarTypeWithCompletionHandler:(id /* block */)handler;
...
- (void)readAttributeHourFormatWithCompletion:(id /* block */)completion;
- (void)readAttributeHourFormatWithCompletionHandler:(id /* block */)handler;
- (void)readAttributeSupportedCalendarTypesWithCompletion:(id /* block */)completion;
- (void)readAttributeSupportedCalendarTypesWithCompletionHandler:(id /* block */)handler;
...
- (void)subscribeAttributeActiveCalendarTypeWithMinInterval:(id)interval maxInterval:(id)interval params:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)subscribeAttributeActiveCalendarTypeWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
...
- (void)subscribeAttributeHourFormatWithMinInterval:(id)interval maxInterval:(id)interval params:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)subscribeAttributeHourFormatWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)subscribeAttributeSupportedCalendarTypesWithMinInterval:(id)interval maxInterval:(id)interval params:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)subscribeAttributeSupportedCalendarTypesWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)writeAttributeActiveCalendarTypeWithValue:(id)value completion:(id /* block */)completion;
- (void)writeAttributeActiveCalendarTypeWithValue:(id)value completionHandler:(id /* block */)handler;
- (void)writeAttributeActiveCalendarTypeWithValue:(id)value params:(id)params completion:(id /* block */)completion;
- (void)writeAttributeActiveCalendarTypeWithValue:(id)value params:(id)params completionHandler:(id /* block */)handler;
- (void)writeAttributeHourFormatWithValue:(id)value completion:(id /* block */)completion;
- (void)writeAttributeHourFormatWithValue:(id)value completionHandler:(id /* block */)handler;
- (void)writeAttributeHourFormatWithValue:(id)value params:(id)params completion:(id /* block */)completion;
- (void)writeAttributeHourFormatWithValue:(id)value params:(id)params completionHandler:(id /* block */)handler;

@end

#endif /* MTRBaseClusterTimeFormatLocalization_h */
