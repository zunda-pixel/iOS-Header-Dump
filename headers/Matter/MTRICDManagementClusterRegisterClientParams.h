...
//
#ifndef MTRICDManagementClusterRegisterClientParams_h
#define MTRICDManagementClusterRegisterClientParams_h
@import Foundation;
...
#endif /* MTRICDManagementClusterRegisterClientParams_h */
