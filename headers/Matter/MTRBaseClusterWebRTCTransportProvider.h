...
//
#ifndef MTRBaseClusterWebRTCTransportProvider_h
#define MTRBaseClusterWebRTCTransportProvider_h
@import Foundation;
...
+ (void)readAttributeCurrentSessionsWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
...
/* instance methods */
- (void)endSessionWithParams:(id)params completion:(id /* block */)completion;
- (void)provideAnswerWithParams:(id)params completion:(id /* block */)completion;
- (void)provideICECandidatesWithParams:(id)params completion:(id /* block */)completion;
- (void)provideOfferWithParams:(id)params completion:(id /* block */)completion;
...
- (void)readAttributeCurrentSessionsWithParams:(id)params completion:(id /* block */)completion;
...
- (void)solicitOfferWithParams:(id)params completion:(id /* block */)completion;
...
- (void)subscribeAttributeCurrentSessionsWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
...
#endif /* MTRBaseClusterWebRTCTransportProvider_h */
