...
//
#ifndef MTRClusterCarbonDioxideConcentrationMeasurement_h
#define MTRClusterCarbonDioxideConcentrationMeasurement_h
@import Foundation;
...
#endif /* MTRClusterCarbonDioxideConcentrationMeasurement_h */
