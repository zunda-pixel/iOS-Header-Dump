...
//
#ifndef MDFMDMv1StartManagingAppRequest_h
#define MDFMDMv1StartManagingAppRequest_h
@import Foundation;

#include "MDFAppRequest.h"

@interface MDFMDMv1StartManagingAppRequest : MDFAppRequest
...
#endif /* MDFMDMv1StartManagingAppRequest_h */
