...
//
#ifndef MDFMDMv1UpdateAppRequest_h
#define MDFMDMv1UpdateAppRequest_h
@import Foundation;

#include "MDFUpdateAppRequest.h"

@interface MDFMDMv1UpdateAppRequest : MDFUpdateAppRequest
...
#endif /* MDFMDMv1UpdateAppRequest_h */
