...
@property (readonly, copy, nonatomic) NSString *localizedDisplayString;
...
- (id)initWithType:(long long)type localizedDisplayString:(id)string;

@end

#endif /* INSupportedTrafficIncidentType_h */
