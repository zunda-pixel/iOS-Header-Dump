...
/* class methods */
+ (id)confirmationRequiredWithPlaybackRepeatModeToConfirm:(long long)confirm;
+ (id)successWithResolvedPlaybackRepeatMode:(long long)mode;
...
#endif /* INPlaybackRepeatModeResolutionResult_h */
