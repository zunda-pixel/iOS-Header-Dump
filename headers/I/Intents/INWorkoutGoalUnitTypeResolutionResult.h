...
+ (id)confirmationRequiredWithWorkoutGoalUnitTypeToConfirm:(long long)confirm;
+ (id)successWithResolvedValue:(long long)value;
+ (id)successWithResolvedWorkoutGoalUnitType:(long long)type;
...
#endif /* INWorkoutGoalUnitTypeResolutionResult_h */
