...
/* class methods */
+ (id)confirmationRequiredWithPaymentStatusToConfirm:(long long)confirm;
+ (id)confirmationRequiredWithValueToConfirm:(long long)confirm;
+ (id)successWithResolvedPaymentStatus:(long long)status;
...
#endif /* INPaymentStatusResolutionResult_h */
