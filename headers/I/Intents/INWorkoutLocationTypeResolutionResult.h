...
+ (id)confirmationRequiredWithWorkoutLocationTypeToConfirm:(long long)confirm;
+ (id)successWithResolvedValue:(long long)value;
+ (id)successWithResolvedWorkoutLocationType:(long long)type;
...
#endif /* INWorkoutLocationTypeResolutionResult_h */
