...
/* class methods */
+ (id)confirmationRequiredWithCallCapabilityToConfirm:(long long)confirm;
+ (id)successWithResolvedCallCapability:(long long)capability;
...
#endif /* INCallCapabilityResolutionResult_h */
