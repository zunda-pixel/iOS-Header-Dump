...
/* class methods */
+ (id)confirmationRequiredWithCarAirCirculationModeToConfirm:(long long)confirm;
+ (id)confirmationRequiredWithValueToConfirm:(long long)confirm;
+ (id)successWithResolvedCarAirCirculationMode:(long long)mode;
...
#endif /* INCarAirCirculationModeResolutionResult_h */
