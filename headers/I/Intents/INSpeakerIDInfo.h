...
@property (readonly, nonatomic) long long speakerIDConfidence;
...
- (id)initWithSharedUserID:(id)id speakerIDConfidence:(long long)idconfidence;

@end

#endif /* INSpeakerIDInfo_h */
