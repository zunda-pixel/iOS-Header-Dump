...
/* class methods */
+ (id)confirmationRequiredWithRelativeReferenceToConfirm:(long long)confirm;
+ (id)confirmationRequiredWithValueToConfirm:(long long)confirm;
+ (id)successWithResolvedRelativeReference:(long long)reference;
...
#endif /* INRelativeReferenceResolutionResult_h */
