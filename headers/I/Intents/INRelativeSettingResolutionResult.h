...
/* class methods */
+ (id)confirmationRequiredWithRelativeSettingToConfirm:(long long)confirm;
+ (id)confirmationRequiredWithValueToConfirm:(long long)confirm;
+ (id)successWithResolvedRelativeSetting:(long long)setting;
...
#endif /* INRelativeSettingResolutionResult_h */
