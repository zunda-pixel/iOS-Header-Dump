...
#include "INIntent.h"
#include "INSetBinarySettingIntentExport-Protocol.h"
...
- (id)initWithSettingMetadata:(id)metadata binaryValue:(long long)value temporalEventTrigger:(id)trigger;
- (id)parametersByName;
...
#endif /* INSetBinarySettingIntent_h */
