...
/* class methods */
+ (id)confirmationRequiredWithVisualCodeTypeToConfirm:(long long)confirm;
+ (id)successWithResolvedVisualCodeType:(long long)type;
...
#endif /* INVisualCodeTypeResolutionResult_h */
