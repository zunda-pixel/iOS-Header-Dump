...
//
#ifndef _INPBGetCarPowerLevelStatusIntentResponse_Protocol_h
#define _INPBGetCarPowerLevelStatusIntentResponse_Protocol_h
@import Foundation;
...
#endif /* _INPBGetCarPowerLevelStatusIntentResponse_Protocol_h */
