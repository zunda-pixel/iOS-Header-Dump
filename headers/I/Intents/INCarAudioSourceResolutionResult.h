...
/* class methods */
+ (id)confirmationRequiredWithCarAudioSourceToConfirm:(long long)confirm;
+ (id)confirmationRequiredWithValueToConfirm:(long long)confirm;
+ (id)successWithResolvedCarAudioSource:(long long)source;
...
#endif /* INCarAudioSourceResolutionResult_h */
