...
/* class methods */
+ (id)confirmationRequiredWithWellnessQueryResultTypeToConfirm:(long long)confirm;
+ (id)successWithResolvedWellnessQueryResultType:(long long)type;
...
#endif /* INWellnessQueryResultTypeResolutionResult_h */
