...
/* class methods */
+ (id)confirmationRequiredWithTaskPriorityToConfirm:(long long)confirm;
+ (id)successWithResolvedTaskPriority:(long long)priority;
...
#endif /* INTaskPriorityResolutionResult_h */
