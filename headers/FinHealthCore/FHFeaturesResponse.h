...
- (id)initWithSmartFeatures:(id)features aggregateFeatureswithProcessingWindow:(id)window compoundFeatures:(id)features transactionID:(id)id;

@end

#endif /* FHFeaturesResponse_h */
