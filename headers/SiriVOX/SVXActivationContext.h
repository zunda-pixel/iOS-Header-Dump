...
- (id)initWithSource:(long long)source timestamp:(unsigned long long)timestamp buttonEvent:(id)event systemEvent:(id)event clientInfo:(id)info requestInfo:(id)info userInfo:(id)info;

@end

#endif /* SVXActivationContext_h */
