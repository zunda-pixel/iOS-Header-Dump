...
@property (nonatomic) _Bool hasTermID;
...
- (id)initWithTermType:(int)type termString:(id)string termID:(id)id;

@end

#endif /* BMIntelligencePlatformMessageTermsTermCountTerm_h */
