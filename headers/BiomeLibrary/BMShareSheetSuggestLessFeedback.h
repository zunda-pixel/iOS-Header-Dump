...
- (id)initWithBundleID:(id)id conversationIdentifier:(id)identifier derivedIntentIdentifier:(id)identifier handle:(id)handle contactID:(id)id;

@end

#endif /* BMShareSheetSuggestLessFeedback_h */
