...
@interface CLPCellTowerLocation : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int arfcn:1; unsigned int ecn0:1; unsigned int psc:1; unsigned int rat:1; unsigned int rscp:1; unsigned int serverHash:1; unsigned int transmit:1; unsigned int hasWifiFallback:1; unsigned int isLimitedService:1; unsigned int uniqueCount:1; } _has;
}
