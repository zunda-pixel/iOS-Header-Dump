...
//
#ifndef ASCAppDistributionOffer_h
#define ASCAppDistributionOffer_h
@import Foundation;
...
- (id)initWithID:(id)id titles:(id)titles subtitles:(id)subtitles flags:(long long)flags ageRating:(id)rating metrics:(id)metrics appVersionId:(id)id distributorId:(id)id;
- (id)offerWithMetrics:(id)metrics;

@end

#endif /* ASCAppDistributionOffer_h */
