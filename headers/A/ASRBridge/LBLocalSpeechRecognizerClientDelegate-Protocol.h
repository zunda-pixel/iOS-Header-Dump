...
- (void)localSpeechRecognizerClient:(id)client receivedFinalEndpointDetectedAtTime:(double)time;
...
- (void)localSpeechRecognizerClient:(id)client receivedSpeechDetectionEvent:(id)event;
- (void)localSpeechRecognizerClient:(id)client receivedSpeechDetectionUpdate:(id)update;
