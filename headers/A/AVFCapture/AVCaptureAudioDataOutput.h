...
- (void)_handleConfigurationLiveEventForID:(long long)id updatedFormatDescription:(struct opaqueCMFormatDescription *)description;
- (void)_handleSampleBufferEventForSampleBuffer:(struct opaqueCMSampleBuffer *)buffer;
- (id)recommendedAudioSettingsForAssetWriterWithOutputFileType:(id)type;
- (id)supportedAssetWriterOutputFileTypes;

@end

#endif /* AVCaptureAudioDataOutput_h */
