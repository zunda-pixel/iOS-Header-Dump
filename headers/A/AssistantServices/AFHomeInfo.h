...
@property (readonly, nonatomic) _Bool activityNotificationsEnabledForPersonalRequests;
...
- (id)initWithHomeIdentifier:(id)identifier activityNotificationsEnabledForPersonalRequests:(_Bool)requests;
