...
- (id)initWithUtterance:(id)utterance beginTimestamp:(unsigned long long)timestamp endTimestamp:(unsigned long long)timestamp;

@end

#endif /* AFSpeechSynthesisRecord_h */
