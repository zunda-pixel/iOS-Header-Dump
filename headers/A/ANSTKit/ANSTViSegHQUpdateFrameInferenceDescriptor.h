...
//
#ifndef ANSTViSegHQUpdateFrameInferenceDescriptor_h
#define ANSTViSegHQUpdateFrameInferenceDescriptor_h
@import Foundation;
...
@property (readonly, nonatomic) _Bool isE5;
...
#endif /* ANSTViSegHQUpdateFrameInferenceDescriptor_h */
