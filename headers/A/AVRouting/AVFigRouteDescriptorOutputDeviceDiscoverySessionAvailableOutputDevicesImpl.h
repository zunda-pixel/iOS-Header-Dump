...
/* instance methods */
- (void)dealloc;
- (id)initWithRouteDescriptors:(id)descriptors routeDiscoverer:(struct OpaqueFigRouteDiscoverer *)discoverer;
- (id)init;

@end

#endif /* AVFigRouteDescriptorOutputDeviceDiscoverySessionAvailableOutputDevicesImpl_h */
