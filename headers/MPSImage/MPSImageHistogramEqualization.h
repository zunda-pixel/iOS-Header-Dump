...
- (void)encodeTransformToCommandBuffer:(id)buffer sourceTexture:(id)texture histogram:(id)histogram histogramOffset:(unsigned long long)offset;

@end

#endif /* MPSImageHistogramEqualization_h */
