...
@property (nonatomic) _Bool useFastMode;
...
- (id)initWithDevice:(id)device linearToGrayScaleTransform:(const float *)transform sigma:(float)sigma;

@end

#endif /* MPSImageCanny_h */
