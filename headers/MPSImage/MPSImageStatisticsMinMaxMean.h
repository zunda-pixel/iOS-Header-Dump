...
//
#ifndef MPSImageStatisticsMinMaxMean_h
#define MPSImageStatisticsMinMaxMean_h
@import Foundation;
...
@property (nonatomic)  strides;
@property (retain, nonatomic) id <MTLFunction> colorConversionFunction;
@property (retain, nonatomic) id <MTLBuffer> colorConversionData;
...
#endif /* MPSImageStatisticsMinMaxMean_h */
