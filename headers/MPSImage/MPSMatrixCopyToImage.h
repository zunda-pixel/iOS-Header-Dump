...
- (void)encodeBatchToCommandBuffer:(id)buffer sourceMatrix:(id)matrix destinationImages:(id)images;
- (void)encodeToCommandBuffer:(id)buffer sourceMatrix:(id)matrix destinationImage:(id)image;
