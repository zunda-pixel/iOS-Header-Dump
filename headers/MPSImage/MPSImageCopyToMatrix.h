...
@property (nonatomic) struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } destinationMatrixOrigin;
@property (nonatomic) unsigned long long destinationMatrixBatchIndex;
@property (readonly, nonatomic) unsigned long long dataLayout;
...
- (void)encodeBatchToCommandBuffer:(id)buffer sourceImages:(id)images destinationMatrix:(id)matrix;
- (id)initWithDevice:(id)device dataLayout:(unsigned long long)layout;
...
- (void)encodeToCommandBuffer:(id)buffer sourceImage:(id)image destinationMatrix:(id)matrix;
- (void)encodeToCommandEncoder:(id)encoder commandBuffer:(id)buffer sourceImage:(id)image destinationMatrix:(id)matrix;

@end

#endif /* MPSImageCopyToMatrix_h */
