...
@property (readonly, nonatomic) unsigned long long kernelDepth;
...
- (void)dealloc;
- (id)initWithDevice:(id)device kernelWidth:(unsigned long long)width kernelHeight:(unsigned long long)height kernelDepth:(unsigned long long)depth;

@end

#endif /* MPSImageBox3D_h */
