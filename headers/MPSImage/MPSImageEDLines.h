...
- (void)encodeInternalToCommandEncoder:(id)encoder commandBuffer:(id)buffer sourceTexture:(id)texture destinationTexture:(id)texture endpointBuffer:(id)buffer endpointOffset:(unsigned long long)offset inputExtent:(struct { struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } x0; struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; } x1; })extent;
- (void)encodeToCommandBuffer:(id)buffer sourceTexture:(id)texture destinationTexture:(id)texture endpointBuffer:(id)buffer endpointOffset:(unsigned long long)offset;
- (void)encodeToCommandEncoder:(id)encoder commandBuffer:(id)buffer sourceTexture:(id)texture destinationTexture:(id)texture endpointBuffer:(id)buffer endpointOffset:(unsigned long long)offset;
- (id)initWithDevice:(id)device gaussianSigma:(float)sigma minLineLength:(unsigned short)length maxLines:(unsigned long long)lines detailRatio:(unsigned short)ratio gradientThreshold:(float)threshold lineErrorThreshold:(float)threshold mergeLocalityThreshold:(float)threshold;
