...
@interface MPSImageThresholdBinaryInverse : MPSUnaryImageKernel {
    /* instance variables */
    struct { float threshold_value; float max_value; float matrix[3]; } filterInfo;
}
...
- (id)initWithDevice:(id)device thresholdValue:(float)value maximumValue:(float)value linearGrayColorTransform:(const float *)transform;

@end

#endif /* MPSImageThresholdBinaryInverse_h */
