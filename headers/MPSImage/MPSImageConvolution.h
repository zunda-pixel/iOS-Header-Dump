...
- (void)initFilterWithKernelWidth:(unsigned long long)width kernelHeight:(unsigned long long)height weights:(const float *)weights;
- (id)initWithDevice_private:(id)device_private;
