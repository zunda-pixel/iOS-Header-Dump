...
//
#ifndef SPUISResultBuilder_h
#define SPUISResultBuilder_h
@import Foundation;

@class SFColor, SFSearchResult_SpotlightExtras, SPSearchQueryContext, UTType;
