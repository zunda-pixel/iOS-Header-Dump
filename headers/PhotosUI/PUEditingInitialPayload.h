...
@class CLLocation, PHAdjustmentData;
...
@property (nonatomic) struct { long long x0; int x1; unsigned int x2; long long x3; } livePhotoStillDisplayTime;
...
#endif /* PUEditingInitialPayload_h */
