...
- (id)initWithCollaborationItemIdentifier:(id)identifier options:(id)options fileOrFolderURL:(id)url share:(id)share setupInfo:(id)info sharingURL:(id)url appName:(id)name appIconData:(id)data;
