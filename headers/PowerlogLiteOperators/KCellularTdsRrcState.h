...
@interface KCellularTdsRrcState : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int timestamp:1; unsigned int newRrcState:1; unsigned int prevStateDurMs:1; unsigned int rrcState:1; unsigned int subsId:1; } _has;
}
