...
@interface KCellularWcdmaCpcStat : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int timestamp:1; unsigned int energy:1; unsigned int rxOnDurationMs:1; unsigned int rxTxOffDurationMs:1; unsigned int subsId:1; unsigned int totalDurationMs:1; } _has;
}
