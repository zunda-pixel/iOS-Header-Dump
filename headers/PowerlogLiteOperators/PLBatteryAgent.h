...
#include "ChargingStateProvider.h"
...
@interface PLBatteryAgent : PLAgent <ACCConnectionInfoDelegateProtocol, ChargingStateProviderDelegate>
...
@property (retain) ChargingStateProvider *chargingStateProvider;
