...
@interface UtraFddStats : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int startTime:1; unsigned int activeDuration:1; unsigned int clkHighDuration:1; unsigned int clkLowDuration:1; unsigned int clkMedDuration:1; unsigned int deepSleepCycleCount:1; unsigned int deepSleepDuration:1; unsigned int duration:1; unsigned int lightSleepCycleCount:1; unsigned int lightSleepDuration:1; unsigned int voltHighDuration:1; unsigned int voltLowDuration:1; unsigned int voltMedDuration:1; } _has;
}
