...
//
#ifndef BlastDoorBasicEmojiTapback_h
#define BlastDoorBasicEmojiTapback_h
@import Foundation;
...
@interface BlastDoorBasicEmojiTapback : NSObject { // (Swift)
    /* instance variables */
    v24@?0@"NSArray"8@"NSError"16 basicEmojiTapback;
}
...
#endif /* BlastDoorBasicEmojiTapback_h */
