...
//
#ifndef BlastDoorStickerTapBack_h
#define BlastDoorStickerTapBack_h
@import Foundation;
...
@interface BlastDoorStickerTapBack : NSObject { // (Swift)
    /* instance variables */
    v24@?0@"NSArray"8@"NSError"16 stickerTapBack;
}
...
#endif /* BlastDoorStickerTapBack_h */
