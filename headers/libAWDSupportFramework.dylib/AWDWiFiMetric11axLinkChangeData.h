...
//
#ifndef AWDWiFiMetric11axLinkChangeData_h
#define AWDWiFiMetric11axLinkChangeData_h
@import Foundation;
...
@interface AWDWiFiMetric11axLinkChangeData : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int timestamp:1; unsigned int akmSuites:1; unsigned int capabilities:1; unsigned int channel:1; unsigned int channelWidth:1; unsigned int enhancedSecurityType:1; unsigned int flags:1; unsigned int gatewayARPHistory:1; unsigned int heBEParamRecord:1; unsigned int heBKParamRecord:1; unsigned int heBssMcsNss:1; unsigned int heMacCapSubfields:1; unsigned int heOpsParams:1; unsigned int hePhyCapSubfields:1; unsigned int heRxTxMcsMap:1; unsigned int heStaCnt:1; unsigned int heUtilization:1; unsigned int heVIParamRecord:1; unsigned int heVOParamRecord:1; unsigned int htASel:1; unsigned int htAmpduParams:1; unsigned int htExtended:1; unsigned int htInfo:1; unsigned int htTxBf:1; unsigned int mcastCipher:1; unsigned int phyMode:1; unsigned int reason:1; unsigned int securityType:1; unsigned int subreason:1; unsigned int ucastCipher:1; unsigned int vhtInfo:1; unsigned int wpaProtocol:1; unsigned int isInVol:1; unsigned int isLinkUp:1; } _has;
}
...
#endif /* AWDWiFiMetric11axLinkChangeData_h */
