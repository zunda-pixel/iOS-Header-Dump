...
//
#ifndef AWDIMessageReceivedMessage_h
#define AWDIMessageReceivedMessage_h
@import Foundation;
...
@interface AWDIMessageReceivedMessage : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int timestamp:1; unsigned int fzError:1; unsigned int hasAttachments:1; unsigned int isFromEmail:1; unsigned int isFromPhoneNumber:1; unsigned int isGroupMessage:1; unsigned int isTypingIndicator:1; unsigned int messageError:1; } _has;
}
...
#endif /* AWDIMessageReceivedMessage_h */
