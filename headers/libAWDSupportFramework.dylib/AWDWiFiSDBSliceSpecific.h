...
//
#ifndef AWDWiFiSDBSliceSpecific_h
#define AWDWiFiSDBSliceSpecific_h
@import Foundation;
...
@interface AWDWiFiSDBSliceSpecific : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int timestamp:1; unsigned int txDeferDuration:1; unsigned int txPriDuration:1; unsigned int txaDuration:1; unsigned int ackTxPowerBackoffCount:1; unsigned int txDeferredCount:1; unsigned int txMuteCount:1; unsigned int txPathEnableReqCount:1; unsigned int txPathMuteCount:1; unsigned int txPriorityCount:1; unsigned int txaONCount:1; unsigned int txaPORCount:1; unsigned int txaTimeoutCount:1; } _has;
}
...
#endif /* AWDWiFiSDBSliceSpecific_h */
