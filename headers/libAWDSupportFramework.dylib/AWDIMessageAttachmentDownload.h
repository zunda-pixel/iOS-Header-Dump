...
//
#ifndef AWDIMessageAttachmentDownload_h
#define AWDIMessageAttachmentDownload_h
@import Foundation;
...
@interface AWDIMessageAttachmentDownload : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int timestamp:1; unsigned int attachmentSize:1; unsigned int connectionType:1; unsigned int downloadDuration:1; unsigned int firstLevelMMCSError:1; unsigned int fourthLevelMMCSError:1; unsigned int fzError:1; unsigned int genericError:1; unsigned int linkQuality:1; unsigned int messageError:1; unsigned int secondLevelMMCSError:1; unsigned int thirdLevelMMCSError:1; unsigned int tokenError:1; } _has;
}
...
#endif /* AWDIMessageAttachmentDownload_h */
