...
@class UILocalizedIndexedCollation, UITableView, UIView;
...
- (id)cellAtPoint:(struct CGPoint { double x0; double x1; })point;
- (id)fileAtPoint:(struct CGPoint { double x0; double x1; })point;
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })frameOfCellAtPoint:(struct CGPoint { double x0; double x1; })point;
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })frame collation:(id)collation;
- (void)updateCheckmarkForFile:(id)file;

@end

#endif /* WFRemoteFileListView_h */
