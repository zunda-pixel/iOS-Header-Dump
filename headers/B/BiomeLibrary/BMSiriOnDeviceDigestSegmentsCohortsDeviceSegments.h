...
//
#ifndef BMSiriOnDeviceDigestSegmentsCohortsDeviceSegments_h
#define BMSiriOnDeviceDigestSegmentsCohortsDeviceSegments_h
@import Foundation;
...
- (id)initWithSegmentType:(id)type segmentDataAvailabilityState:(id)state daysWithTwoValidAssistantTurnsPerWeek:(id)week daysWithTwoAssistantSpeechRequestsPerWeek:(id)week;

@end

#endif /* BMSiriOnDeviceDigestSegmentsCohortsDeviceSegments_h */
