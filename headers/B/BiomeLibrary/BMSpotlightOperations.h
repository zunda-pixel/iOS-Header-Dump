...
//
#ifndef BMSpotlightOperations_h
#define BMSpotlightOperations_h
@import Foundation;
...
@property (nonatomic) _Bool hasItemsCount;
...
- (id)initWithClient:(id)client itemsCount:(id)count operation:(id)operation reason:(id)reason stringIdentifier:(id)identifier stringReason:(id)reason;

@end

#endif /* BMSpotlightOperations_h */
