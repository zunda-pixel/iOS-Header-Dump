...
@property (nonatomic) _Bool hasBrandIdentifier;
...
- (id)initWithDiscardReason:(int)reason placement:(int)placement bundleID:(id)id brandIdentifier:(id)identifier displayOrder:(id)order searchTerms:(id)terms;

@end

#endif /* BMAdPlatformsDiscardReasons_h */
