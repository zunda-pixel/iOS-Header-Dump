...
//
#ifndef BMSiriSegmentsCohortsDeviceSegments_h
#define BMSiriSegmentsCohortsDeviceSegments_h
@import Foundation;
...
- (id)initWithSegmentType:(id)type segmentDataAvailabilityState:(id)state daysWithTwoValidAssistantTurnsPerWeek:(id)week;

@end

#endif /* BMSiriSegmentsCohortsDeviceSegments_h */
