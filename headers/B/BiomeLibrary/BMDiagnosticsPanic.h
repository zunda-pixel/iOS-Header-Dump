...
//
#ifndef BMDiagnosticsPanic_h
#define BMDiagnosticsPanic_h
@import Foundation;
...
@property (nonatomic) _Bool hasCaptureTime;
...
- (id)initWithCaptureTime:(id)time incidentID:(id)id patternUUID:(id)uuid patternType:(id)type;

@end

#endif /* BMDiagnosticsPanic_h */
