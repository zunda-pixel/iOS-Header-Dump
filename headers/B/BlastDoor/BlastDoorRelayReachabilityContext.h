...
//
#ifndef BlastDoorRelayReachabilityContext_h
#define BlastDoorRelayReachabilityContext_h
@import Foundation;

@class v24@?0@"NSArray"8@"NSError"16;

@interface BlastDoorRelayReachabilityContext : NSObject { // (Swift)
    /* instance variables */
    v24@?0@"NSArray"8@"NSError"16 relayReachabilityContext;
}
...
#endif /* BlastDoorRelayReachabilityContext_h */
