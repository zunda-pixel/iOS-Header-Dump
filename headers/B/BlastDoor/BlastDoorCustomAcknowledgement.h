...
//
#ifndef BlastDoorCustomAcknowledgement_h
#define BlastDoorCustomAcknowledgement_h
@import Foundation;
...
@interface BlastDoorCustomAcknowledgement : NSObject { // (Swift)
    /* instance variables */
    v24@?0@"NSArray"8@"NSError"16 customAcknowledgement;
}
...
#endif /* BlastDoorCustomAcknowledgement_h */
