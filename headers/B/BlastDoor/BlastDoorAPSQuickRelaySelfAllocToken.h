...
@interface BlastDoorAPSQuickRelaySelfAllocToken : NSObject { // (Swift)
    /* instance variables */
    v24@?0@"NSArray"8@"NSError"16 aPSQuickRelaySelfAllocToken;
}
...
#endif /* BlastDoorAPSQuickRelaySelfAllocToken_h */
