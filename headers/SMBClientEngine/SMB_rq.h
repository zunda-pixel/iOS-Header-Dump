...
@property struct timespec { long long x0; long long x1; } sr_credit_timesent;
@property struct timespec { long long x0; long long x1; } sr_timesent;
...
- (void)smb_rq_set_extflag:(unsigned int)smb_rq_set_extflag;
- (void)smb_rq_set_sr_nextcmdp:(unsigned long long)smb_rq_set_sr_nextcmdp;
- (void)smb_rq_set_srflags:(unsigned int)smb_rq_set_srflags;
- (void)smb_rq_set_srflagsp:(unsigned int)smb_rq_set_srflagsp;
