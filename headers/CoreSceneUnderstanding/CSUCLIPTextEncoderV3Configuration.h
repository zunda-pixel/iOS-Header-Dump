...
//
#ifndef CSUCLIPTextEncoderV3Configuration_h
#define CSUCLIPTextEncoderV3Configuration_h
@import Foundation;
...
/* class methods */
+ (id)CLIPTextEncoderV3ConfigurationForRevision:(long long)revision error:(id *)error;
+ (long long)_resolvedRevision:(long long)revision;
+ (id)availableRevisions;

/* instance methods */
- (id)initCLIPTextEncoderV3ConfigurationForRevision:(long long)revision vocabularyModelPath:(id)path tokenEmbeddingNetworkPath:(id)path textEncoderNetworkPath:(id)path;
- (_Bool)isCLIPTextEncoderPresent;

@end

#endif /* CSUCLIPTextEncoderV3Configuration_h */
