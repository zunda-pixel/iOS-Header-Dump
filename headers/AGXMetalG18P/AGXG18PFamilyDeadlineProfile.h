...
//
#ifndef AGXG18PFamilyDeadlineProfile_h
#define AGXG18PFamilyDeadlineProfile_h
@import Foundation;

#include "MTLDeadlineProfile-Protocol.h"

@interface AGXG18PFamilyDeadlineProfile : NSObject <MTLDeadlineProfile> {
    /* instance variables */
