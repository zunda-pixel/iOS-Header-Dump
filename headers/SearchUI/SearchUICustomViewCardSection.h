...
//
#ifndef SearchUICustomViewCardSection_h
#define SearchUICustomViewCardSection_h
@import Foundation;

#include "SearchUICustomViewCardSection-Protocol.h"

@class SFAppEntityAnnotation, SFCard, SFCardSection, SFColor, SFCommand, SFCopyItem, SFUserReportRequest;
...
#endif /* SearchUICustomViewCardSection_h */
