...
@interface TVMediaPlaybackManager : NSObject <UIGestureRecognizerDelegate> {
    ...
    struct { _Bool hasShouldEnableUIModeImplicitly; _Bool hasEvaluateSwipeUpMessage; _Bool hasPresentPlaybackController; } _delegateFlags;
...
#endif /* TVMediaPlaybackManager_h */
