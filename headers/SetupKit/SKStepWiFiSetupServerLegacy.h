...
//
#ifndef SKStepWiFiSetupServerLegacy_h
#define SKStepWiFiSetupServerLegacy_h
@import Foundation;
...
@class CUBonjourAdvertiser, CUReachabilityMonitor;
...
#endif /* SKStepWiFiSetupServerLegacy_h */
