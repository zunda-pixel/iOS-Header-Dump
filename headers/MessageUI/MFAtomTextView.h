...
@protocol MFAtomTextViewDelegate, MFAtomTextViewDelegateInternal, UITextInputDelegate, UITextInputSuggestionDelegate;
...
@property (readonly, nonatomic) _MFAtomFieldEditor *fieldEditor;
...
- (_Bool)_cursorAccessoriesVisible;
- (void)_setCursorAccessoriesVisible:(_Bool)visible;

@end

#endif /* MFAtomTextView_h */
