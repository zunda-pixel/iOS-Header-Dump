...
- (id)initWithMicrophoneAttributionListDataDiff:(id)diff mutedMicrophoneRecordingAttributionListDataDiff:(id)diff systemAudioRecordingAttributionListDataDiff:(id)diff cameraAttributionListDataDiff:(id)diff screenCaptureAttributionListDataDiff:(id)diff;
...
#endif /* STMediaStatusDomainDataDiff_h */
