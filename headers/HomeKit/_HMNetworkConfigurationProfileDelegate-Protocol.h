...
//
#ifndef _HMNetworkConfigurationProfileDelegate_Protocol_h
#define _HMNetworkConfigurationProfileDelegate_Protocol_h
@import Foundation;
...
#endif /* _HMNetworkConfigurationProfileDelegate_Protocol_h */
