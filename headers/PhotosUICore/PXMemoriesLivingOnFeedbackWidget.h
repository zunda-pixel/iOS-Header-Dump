...
@class PHMemory, PXAssetActionManager, PXSectionedSelectionManager, UIView;
...
- (struct CGSize { double x0; double x1; })_layoutTokenViewsWithWidth:(double)width;
...
#endif /* PXMemoriesLivingOnFeedbackWidget_h */
