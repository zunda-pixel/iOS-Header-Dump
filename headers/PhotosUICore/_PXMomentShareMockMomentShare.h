...
/* class methods */
+ (id)momentShareWithStatus:(unsigned short)status photosCount:(unsigned long long)count videosCount:(unsigned long long)count uploadedPhotosCount:(unsigned long long)count uploadedVideosCount:(unsigned long long)count;
...
- (id)initWithStatus:(unsigned short)status assetCount:(unsigned long long)count photosCount:(unsigned long long)count videosCount:(unsigned long long)count uploadedPhotosCount:(unsigned long long)count uploadedVideosCount:(unsigned long long)count shareURL:(id)url expiryDate:(id)date localizedTitle:(id)title startDate:(id)date endDate:(id)date;

@end

#endif /* _PXMomentShareMockMomentShare_h */
