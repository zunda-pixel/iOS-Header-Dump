...
+ (id)buildRequiredOnlyWithIdentifier:(id)identifier calendarURL:(id)url;
+ (id)buildWithIdentifier:(id)identifier visibleName:(id)name calendarURL:(id)url authenticationCredentialsAssetReference:(id)reference;
...
#endif /* RMModelAccountSubscribedCalendarDeclaration_h */
