...
#include "CNRecipientDraggingDelegate-Protocol.h"
...
@property (nonatomic) _Bool shouldAlwaysShowAddContactsButton;
@property (nonatomic) _Bool showGlassBackground;
...
- (_Bool)_hasRecipientsWithPresentationOptions:(unsigned long long)options;
...
- (_Bool)_recipientAtomHitInView:(id)view atLocation:(struct CGPoint { double x0; double x1; })location;
...
- (void)_updateAddButtonVisibilityAnimated:(_Bool)animated;
...
- (void)addRecipientsFromContactItemProviders:(id)providers;
...
- (id)selectedAtoms;
- (void)setAtomPresentationOptions:(unsigned long long)options forRecipient:(id)recipient;
- (void)setEditable:(_Bool)editable animated:(_Bool)animated;
- (void)setUsingActiveAppearance:(_Bool)appearance animated:(_Bool)animated;
- (void)shiftSelectAtom:(id)atom;
- (void)shiftSelectComposeRecipientAtom:(id)atom;
- (_Bool)shouldExpandRecipient:(id)recipient;
- (double)textFieldOffsetForNumberOfRowsToScroll:(unsigned long long)scroll numberOfRowsAboveField:(long long)field;
- (void)updateGlassCornerRadius;

@end

#endif /* CNComposeRecipientTextView_h */
