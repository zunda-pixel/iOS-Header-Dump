...
- (struct Offset<siri::speech::qss_fb::AsrItnMessage> { unsigned int x0; })addObjectToBuffer:(void *)buffer;
- (id)flatbuffData;
- (id)initAndVerifyWithFlatbuffData:(id)data;
- (id)initWithFlatbuffData:(id)data;
- (id)initWithFlatbuffData:(id)data root:(const struct AsrItnMessage { unsigned char x0[1]; } *)root;
- (id)initWithFlatbuffData:(id)data root:(const struct AsrItnMessage { unsigned char x0[1]; } *)root verify:(_Bool)verify;

@end

#endif /* FTAsrItnMessage_h */
