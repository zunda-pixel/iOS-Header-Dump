...
- (struct Offset<siri::speech::qss_fb::TtsTextToSpeechMessage> { unsigned int x0; })addObjectToBuffer:(void *)buffer;
- (id)flatbuffData;
- (id)initAndVerifyWithFlatbuffData:(id)data;
- (id)initWithFlatbuffData:(id)data;
- (id)initWithFlatbuffData:(id)data root:(const struct TtsTextToSpeechMessage { unsigned char x0[1]; } *)root;
- (id)initWithFlatbuffData:(id)data root:(const struct TtsTextToSpeechMessage { unsigned char x0[1]; } *)root verify:(_Bool)verify;

@end

#endif /* FTTtsTextToSpeechMessage_h */
