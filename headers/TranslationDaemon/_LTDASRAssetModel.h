...
//
#ifndef _LTDASRAssetModel_h
#define _LTDASRAssetModel_h
@import Foundation;

#include "_LTDAssetModelProtocol-Protocol.h"

@class SFEntitledAssetConfig, _LTAssetProgress;
...
- (id)initWithAssetIdentifier:(id)identifier provider:(id)provider;
- (_Bool)supportsTaskHint:(long long)hint;

@end

#endif /* _LTDASRAssetModel_h */
