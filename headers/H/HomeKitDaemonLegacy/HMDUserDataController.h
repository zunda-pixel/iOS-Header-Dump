...
@property _Bool supportsHH2MigrationByOwnerManual;
@property _Bool supportsHH2MigrationByOwnerAuto;
...
- (_Bool)_userListeningHistoryValueFromModels:(id)models;
- (void)updateSupportsHH2MigrationByOwnerManual:(_Bool)manual supportsHH2MigrationByOwnerAuto:(_Bool)_auto completion:(id /* block */)completion;
