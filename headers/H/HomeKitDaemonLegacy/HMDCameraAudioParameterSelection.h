...
- (id)initWithSessionInfo:(id)info supportedAudioConfiguration:(id)configuration supportedRTPConfiguration:(id)rtpconfiguration streamingCapabilities:(id)capabilities;
