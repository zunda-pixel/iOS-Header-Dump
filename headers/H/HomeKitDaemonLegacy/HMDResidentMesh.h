...
- (void)_addConnectivityFromDeviceToAccessory:(id)accessory activateTimer:(_Bool)timer;
- (_Bool)_checkReachabilityWithTimerActivation:(_Bool)activation;
- (void)_removeConnectivityFromDeviceToAccessory:(id)accessory activateTimer:(_Bool)timer;
