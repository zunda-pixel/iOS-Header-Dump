...
@class HMAccessoryCapabilities, HMDAppleMediaAccessoryInfoSubscriber, HMDAudioAnalysisEventSubscriber, HMDAudioAnalysisRequestManager, HMFActivity, HMFPairingIdentity, HMFSoftwareVersion, HMFWiFiManager, HMFWiFiNetworkInfo, HMMediaDestination, HMMediaDestinationControllerData, HMSoftwareUpdateDescriptor, HMSoftwareUpdateProgress;
