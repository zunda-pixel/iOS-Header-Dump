...
@class HMAccessoryCategory, HMFMessageDispatcher, HMFObject, HMFVersion;
@protocol OS_dispatch_queue;

@interface HMDAccessory : HMFObject <HMDBulletinIdentifiers, HMDSoftwareUpdateDataSource, NSSecureCoding, HMDHomeMessageReceiver, HMDBackingStoreObjectProtocol, HMDDumpState, HMFLogging> {
    /* instance variables */
