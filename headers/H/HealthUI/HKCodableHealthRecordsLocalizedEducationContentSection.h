...
@interface HKCodableHealthRecordsLocalizedEducationContentSection : PBCodable <NSCopying> {
    /* instance variables */
    struct APPLE_HKCodableHealthRecordsLocalizedEducationContentSection_1 { unsigned int type:1; } _has;
}
...
@property (readonly, nonatomic) _Bool hasSectionLocaleIdentifier;
