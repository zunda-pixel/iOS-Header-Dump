...
#include "HKSleepChartPointInformationProviding-Protocol.h"
...
@property (readonly, nonatomic) id <HKSleepChartPointInformationProviding> chartPointInfoProvider;
...
- (id)initWithSeriesType:(long long)type chartPointInfoProvider:(id)provider;
