...
//
#ifndef HKStateOfMindSeries_h
#define HKStateOfMindSeries_h
@import Foundation;

#include "HKAxisLabelDataSource-Protocol.h"
#include "HKGraphSeries.h"

@interface HKStateOfMindSeries : HKGraphSeries <HKAxisLabelDataSource> { // (Swift)
    /* instance variables */
    q32@0:8@16q24 fixedAxisLabels;
    q32@0:8@16q24 $__lazy_storage_$_gradientFillStyle;
    q32@0:8@16q24 $__lazy_storage_$_inactiveFillStyle;
}
