...
@property (readonly, nonatomic) HKUIMetricColors *metricColors;
...
@property (readonly, nonatomic) _Bool useInBedAverage;
...
- (id)_attributedDurationStringFromDuration:(double)duration isSelected:(_Bool)selected;
- (id)_attributedTitleOverrideWithDuration:(double)duration;
- (id)_averagePhraseFromAverageValue:(double)value shortForm:(_Bool)form timeScope:(long long)scope;
- (double)_averageValueFromDaySummaries:(id)summaries useInBedAverage:(_Bool)average;
...
- (void)_updateRangeDataWithChartPoints:(id)points useInBedAverage:(_Bool)average isHighlighted:(_Bool)highlighted timeScope:(long long)scope;
- (id)baseDisplayTypeForOverlay:(long long)overlay;
- (id)contextItemForLastUpdate;
- (id)initWithBaseDisplayType:(id)type overlayDisplayType:(id)type overlayChartController:(id)controller useInBedAverage:(_Bool)average contextChangeDelegate:(id)delegate overlayAverageSeries:(id)series averageChartFormatter:(id)formatter;
