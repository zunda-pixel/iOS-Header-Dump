...
- (id)decodedObjects;
- (id)medicationDoseEventAtIndex:(unsigned long long)index;
- (unsigned long long)medicationDoseEventsCount;
- (_Bool)unitTest_isEquivalentToGeneratedObjectCollection:(id)collection;

@end

#endif /* HDCodableGeneratedObjectCollection_h */
