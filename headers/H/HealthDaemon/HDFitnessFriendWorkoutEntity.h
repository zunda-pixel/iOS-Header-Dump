...
+ (_Bool)enumerateWorkoutsWithPredicate:(id)predicate anchor:(id *)anchor profile:(id)profile error:(id *)error handler:(id /* block */)handler;

@end

#endif /* HDFitnessFriendWorkoutEntity_h */
