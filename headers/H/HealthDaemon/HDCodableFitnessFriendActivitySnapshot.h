...
@interface HDCodableFitnessFriendActivitySnapshot : PBCodable <HDDecoding, NSCopying> {
    /* instance variables */
    struct { unsigned int activeHours:1; unsigned int activeHoursGoal:1; unsigned int amm:1; unsigned int briskMinutes:1; unsigned int briskMinutesGoal:1; unsigned int date:1; unsigned int energyBurned:1; unsigned int energyBurnedGoal:1; unsigned int mmg:1; unsigned int mmv:1; unsigned int pushCount:1; unsigned int snapshotIndex:1; unsigned int stepCount:1; unsigned int timeZoneOffsetFromUTCForNoon:1; unsigned int uploadedDate:1; unsigned int walkingAndRunningDistance:1; unsigned int wheelchairUse:1; } _has;
}
