...
- (id)_addOrUpdateIssuerKey:(id)key forUser:(id)user toMatterAccessory:(id)accessory unifiedAccess:(_Bool)access flow:(id)flow;
...
- (id)addOrUpdateIssuerKey:(id)key forUser:(id)user toMatterAccessory:(id)accessory withControllerType:(id)type unifiedAccess:(_Bool)access flow:(id)flow;
- (id)addOrUpdateIssuerKeyForUser:(id)user toMatterAccessory:(id)accessory flow:(id)flow;
- (void)auditKeysLocallyOrRedispatchWithAccessoryUUID:(id)uuid issuerKey:(id)key withFlow:(id)flow;
...
- (id)configureReaderKey:(id)key onACWGAccessory:(id)acwgaccessory flow:(id)flow;
...
- (void)sendIssuerKeyUpdateMessageToPhone:(id)phone forAccessoryWithUUID:(id)uuid issuerKey:(id)key flow:(id)flow;
- (void)sendIssuerKeyUpdateMessageToPrimaryResidentforAccessoryWithUUID:(id)uuid issuerKey:(id)key flow:(id)flow;
