...
- (void)_handlePrimaryResidentResidentGenerationIDNotification:(id)idnotification;
...
- (void)_resendHomeLocationOnce:(id)once newSource:(long long)source;
...
- (void)accessoryReachabilityChanged:(int)changed previousReachableAccessoriesCount:(int)count reachableAppleMediaAccessoriesCount:(int)count previousReachableAppleMediaAccessoriesCount:(int)count;
