...
#include "HMDMetricsHomeDataChangedManager.h"
...
#include "HMDUserActivityStateDetectorLogEventAnalyzer.h"
...
@protocol HMDEWSLogging, HMMUptimeProvider, OS_dispatch_queue;
...
@property (readonly, nonatomic) HMDMetricsHomeDataChangedManager *metricsHomeDataChangedManager;
