...
#include "HMDAccessoryMediaPrivilegeCapable-Protocol.h"
...
@class HAPSocketInfo, HMCameraUserNotificationSettings, HMFPairingIdentity, HMFTimer, HMMTRAccessoryServer, HMSupportedAccessoryDiagnostics, NAFuture, OS_dispatch_queue;
...
@property (nonatomic) _Bool mediaPrivilegeUpdateScheduled;
...
@property _Bool supportsACWGProvisioning;
@property _Bool supportsACWGUWB;
...
@property _Bool supportsMatterWeekDaySchedule;
@property (copy, nonatomic) NSNumber *matterWeekDayScheduleCapacity;
@property _Bool supportsMatterYearDaySchedule;
...
- (void)_darkWakeHAPAccessory:(id /* block */)hapaccessory errorBlock:(id /* block */)block;
...
- (void)_handleAccessoryUpdateReachability:(_Bool)reachability linkType:(long long)type;
...
- (_Bool)_hh2ShouldFilterAccessoryProfile:(id)profile;
...
- (void)_postMatterEventNotificationWithEventReport:(id)report dictionary:(id)dictionary home:(id)home hapAccessory:(id)accessory;
- (void)_postUpdateEventsIfDifferent:(id)different;
- (id)_prepareMessagePayloadForCharacteristicRemoteWrite:(id)write;
- (void)_processMediaPrivilegeCharacteristicUpdate:(id)update;
...
- (void)_setMediaPrivilegeOnAccessory:(long long)accessory toCharacteristic:(id)characteristic;
...
- (_Bool)_shouldDarkPollAccessory:(id)accessory;
- (_Bool)_shouldDarkPollAccessory:(id)accessory override:(_Bool)override;
- (_Bool)_shouldFilterAccessoryProfileForUnentitledClients:(id)clients;
- (_Bool)_shouldPostHMDAccessoryMatterEventReportNotification:(id)notification;
- (_Bool)_shouldTrackAccessoryWithPriority:(_Bool *)priority;
- (_Bool)_shouldUpdateMediaPrivilegeCharacteristic:(id)characteristic toNew:(long long)_new;
...
- (id)_targetHMDHAPAccessoryForHAPAccessory:(id)hapaccessory home:(id)home;
...
- (_Bool)canDarkPollForErrorCode:(long long)code;
- (_Bool)canDarkPollForOperation:(long long)operation characteristicType:(id)type;
...
- (id)climateMessageBindingForMessage:(id)message;
...
- (void)configureAsValenciaThermostatWithCompletionHandler:(id /* block */)handler;
...
- (void)evaluateSupportsAdaptiveTemperatureAutomations:(id /* block */)automations;
- (void)evaluateSupportsCleanEnergyAutomation:(id /* block */)automation;
- (id)eventForwarder;
...
- (void)handleAccessoryHasOnboardedForAdaptiveTemperatureAutomationsMessage:(id)message;
- (void)handleAccessoryHasOnboardedForCleanEnergyAutomationMessage:(id)message;
...
- (void)handleAdaptiveTemperatureDriverSettingsChanged:(id)changed;
...
- (void)handleCharacteristicChangeNotification:(id)notification;
...
- (_Bool)handleDarkPollRequestToPerformOperation:(long long)operation characteristic:(id)characteristic error:(id)error operationBlock:(id /* block */)block errorBlock:(id /* block */)block;
- (_Bool)handleDarkPollRequestWithOverride:(_Bool)override;
- (void)handleEventReport:(id)report dictionary:(id)dictionary flow:(id)flow hapAccessory:(id)accessory;
- (void)handleFetchAdaptiveThermostatDriverSettingsMessage:(id)message;
- (void)handleFetchThermostatSleepScheduleMessage:(id)message;
...
- (void)handleMatterAttributeChanged:(id)changed;
...
- (void)handleNotificationToEvaluateClimateFeatureSupport:(id)support;
...
- (void)handleSetAdaptiveThermostatDriverMessage:(id)message;
- (void)handleSetHasOnboardedForNaturalLighting:(id)lighting;
- (void)handleSetStartUpColorTemperature:(id)temperature;
- (void)handleSetThermostatSleepScheduleMessage:(id)message;
- (void)handleSleepScheduleRulesUpdated:(id)updated;
...
- (void)handleUpdatedMediaPeerToPeerEnabled:(_Bool)enabled;
...
- (void)handleValenciaTimerFiredWithNotification:(id)notification;
...
- (_Bool)isAdaptiveTemperatureAutomationsEnabled;
...
- (_Bool)isConfiguredAsValenciaThermostat;
...
- (void)notifyClientsOfUpdatedAdaptiveTemperatureAutomations:(_Bool)automations;
- (void)notifyClientsOfUpdatedCleanEnergyAutomations:(_Bool)automations;
...
- (void)profile:(id)profile didUpdateWoWLANInfos:(id)wlaninfos darkPollMinimumInterval:(id)interval;
...
- (_Bool)requiresWaitingToBecomeReachableAfterRemoteAdd;
...
- (id)runtimeState;
- (id)saveBLEUWBSupportedVersions:(id)versions flow:(id)flow;
- (void)saveBluetoothAddress:(id)address;
- (id)saveExpeditedTransactionSupportedVersions:(id)versions flow:(id)flow;
- (void)saveHardwareSupport:(_Bool)support;
- (id)saveNaturalLightingEnabled:(id)enabled;
- (void)savePublicKeyToKeyStore:(id)store;
- (void)savePublicKeyToKeychain;
- (id)saveReaderGroupSubIdentifier:(id)identifier flow:(id)flow;
- (id)saveSupportsACWGProvisioning:(id)acwgprovisioning flow:(id)flow;
- (id)saveSupportsACWGUWB:(id)acwguwb flow:(id)flow;
- (id)saveSupportsMatterAccessCode:(id)code flow:(id)flow;
- (id)saveSupportsMatterWalletKey:(id)key flow:(id)flow;
- (id)saveSupportsMatterWeekDaySchedule:(id)schedule flow:(id)flow;
- (id)saveSupportsMatterYearDaySchedule:(id)schedule flow:(id)flow;
- (id)saveSupportsNaturalLighting:(id)lighting;
- (void)saveTargetUUIDs:(id)uuids;
- (id)saveWeekDayScheduleCapacity:(id)capacity flow:(id)flow;
- (id)saveYearDayScheduleCapacity:(id)capacity flow:(id)flow;
...
- (_Bool)supportsAccessCodesForUser:(id)user;
- (_Bool)supportsClimateAutomations;
- (_Bool)supportsConfiguredSchedule:(id)schedule;
- (_Bool)supportsMinimumUserPrivilege;
- (_Bool)supportsNetworkProtection;
- (_Bool)supportsPersonalRequests;
- (_Bool)supportsPresenceDetectionViaMatter;
- (_Bool)supportsThread;
- (_Bool)supportsThreadCommissioning;
- (_Bool)supportsUnreachablePing;
- (_Bool)supportsWalletKeyForUser:(id)user withFlow:(id)flow;
- (_Bool)supportsWoL;
...
- (void)updateBLEAdvertisingVersion:(id)version flow:(id)flow;
- (void)updateBLEUWBSupportedVersions:(id)versions flow:(id)flow;
...
- (void)updateExpeditedTransactionSupportedVersions:(id)versions flow:(id)flow;
- (void)updateHasPostedBulletinForWalletKeyOnboarding:(_Bool)onboarding;
- (void)updateLastDarkPollDate:(id)date;
- (void)updateLightProfilesSettings;
- (void)updateMatterWeekDayScheduleCapacity:(id)capacity flow:(id)flow;
- (void)updateMatterYearDayScheduleCapacity:(id)capacity flow:(id)flow;
...
- (void)updateRGSI:(id)rgsi flow:(id)flow;
- (void)updateSupportsMatterAccessCodeForFeatureMap:(id)map flow:(id)flow;
- (void)updateSupportsMatterAccessSchedulesForFeatureMap:(id)map flow:(id)flow;
- (void)updateSupportsMatterWallet:(id)wallet flow:(id)flow;
- (void)updateSupportsUWBForFeatureMap:(id)map appleClusterFeatureMap:(id)map flow:(id)flow;
