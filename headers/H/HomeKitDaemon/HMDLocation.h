...
#include "HMDRTRoutineManager-Protocol.h"
...
@property (readonly, nonatomic) NSMapTable *nploiMonitoringDelegatesToLocations;
...
@property (retain, nonatomic) id <HMDRTRoutineManager> routineManager;
@property (readonly, nonatomic) _Bool nploiMonitoringAllowed;
...
- (void)_registerForNPLOIMonitoring:(id)nploimonitoring forLocation:(id)location;
- (void)_startUpdateOrStopNPLOIMonitoring;
- (void)_stopNPLOIMonitoring;
- (void)_unregisterForNPLOIMonitoring:(id)nploimonitoring;
...
- (void)fetchLocationOfInterestAtLocation:(id)location withCompletion:(id /* block */)completion;
- (void)getCoreRoutineLOIForCurrentLocationWithCompletionHandler:(id /* block */)handler;
- (_Bool)isCurrentLocationSimulated;
- (_Bool)isNPLOIMonitoringAllowed;
- (void)processPredictedContextResult:(id)result error:(id)error;
- (void)registerForNPLOIMonitoring:(id)nploimonitoring forLocation:(id)location;
...
- (void)unregisterForNPLOIMonitoring:(id)nploimonitoring;
