...
@interface HKCodableCondensedWorkout : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int condenserDate:1; unsigned int condenserVersion:1; unsigned int creationDate:1; unsigned int duration:1; unsigned int endDate:1; unsigned int persistentID:1; unsigned int startDate:1; unsigned int type:1; } _has;
}
