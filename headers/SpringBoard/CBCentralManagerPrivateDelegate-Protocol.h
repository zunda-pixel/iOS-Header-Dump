...
- (void)centralManager:(id)manager application:(id)application isActive:(_Bool)active;
...
- (void)centralManager:(id)manager didUpdatePhyStatisticEvent:(id)event results:(id)results error:(id)error;
...
- (void)centralManager:(id)manager didUpdateSynchronizationEventForPeripheral:(id)peripheral results:(id)results;
