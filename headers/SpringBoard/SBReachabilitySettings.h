...
@property (retain, nonatomic) SBFCAColorMatrixSettings *jindoTintColorMatrixSettings;
@property (nonatomic) double jindoInertDisableOffset;
...
#endif /* SBReachabilitySettings_h */
