...
#include "SFOpenCalculationCommand-Protocol.h"
#include "SFTopic.h"

@interface SFOpenCalculationCommand : SFCommand <SFOpenCalculationCommand, NSSecureCoding, NSCopying> {
    /* instance variables */
    struct { unsigned int shouldOpenCurrencyConversionProvider:1; } _has;
}
...
- (_Bool)hasShouldOpenCurrencyConversionProvider;

@end

#endif /* SFOpenCalculationCommand_h */
