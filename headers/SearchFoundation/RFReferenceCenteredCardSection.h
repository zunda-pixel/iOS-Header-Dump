...
//
#ifndef RFReferenceCenteredCardSection_h
#define RFReferenceCenteredCardSection_h
@import Foundation;

#include "RFReferenceCenteredCardSection-Protocol.h"
...
@interface RFReferenceCenteredCardSection : SFCardSection <RFReferenceCenteredCardSection, NSSecureCoding, NSCopying> {
    /* instance variables */
    struct { unsigned int add_tint:1; } _has;
}
...
#endif /* RFReferenceCenteredCardSection_h */
