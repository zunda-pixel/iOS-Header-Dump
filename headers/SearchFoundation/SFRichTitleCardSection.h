...
@interface SFRichTitleCardSection : SFTitleCardSection <SFRichTitleCardSection, NSSecureCoding, NSCopying> {
    /* instance variables */
    struct { unsigned int reviewNewLine:1; unsigned int auxiliaryBottomTextColor:1; unsigned int hideVerticalDivider:1; unsigned int titleAlign:1; unsigned int titleNoWrap:1; unsigned int thumbnailCropCircle:1; unsigned int playActionAlign:1; unsigned int subtitleIsEmphasized:1; } _has;
}
