...
//
#ifndef RFSummaryItemButtonCardSection_h
#define RFSummaryItemButtonCardSection_h
@import Foundation;

#include "RFSummaryItemButtonCardSection-Protocol.h"
...
@interface RFSummaryItemButtonCardSection : SFCardSection <RFSummaryItemButtonCardSection, NSSecureCoding, NSCopying> {
    /* instance variables */
    struct { unsigned int buttonItemsAreTrailing:1; } _has;
}
...
#endif /* RFSummaryItemButtonCardSection_h */
