...
//
#ifndef _SFPBRFFactItemHeroNumberCardSection_Protocol_h
#define _SFPBRFFactItemHeroNumberCardSection_Protocol_h
@import Foundation;
...
#endif /* _SFPBRFFactItemHeroNumberCardSection_Protocol_h */
