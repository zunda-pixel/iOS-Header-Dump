...
//
#ifndef RFExpandableStandardCardSection_h
#define RFExpandableStandardCardSection_h
@import Foundation;
...
@interface RFExpandableStandardCardSection : SFCardSection <RFExpandableStandardCardSection, NSSecureCoding, NSCopying> {
    /* instance variables */
    struct { unsigned int summary_item_standard_card_section:1; } _has;
}
...
- (_Bool)hasSummary_item_standard_card_section;

@end

#endif /* RFExpandableStandardCardSection_h */
