...
//
#ifndef RFSummaryItemExpandableCardSection_h
#define RFSummaryItemExpandableCardSection_h
@import Foundation;

#include "RFSummaryItemAttribution.h"
#include "RFSummaryItemExpandableCardSection-Protocol.h"
...
@interface RFSummaryItemExpandableCardSection : SFCardSection <RFSummaryItemExpandableCardSection, NSSecureCoding, NSCopying> {
    /* instance variables */
    struct { unsigned int attribution_ignores_expansion:1; } _has;
}
...
- (_Bool)hasAttribution_ignores_expansion;

@end

#endif /* RFSummaryItemExpandableCardSection_h */
