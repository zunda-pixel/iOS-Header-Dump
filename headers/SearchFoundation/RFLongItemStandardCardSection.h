...
//
#ifndef RFLongItemStandardCardSection_h
#define RFLongItemStandardCardSection_h
@import Foundation;

#include "RFLongItemStandardCardSection-Protocol.h"
...
@interface RFLongItemStandardCardSection : SFCardSection <RFLongItemStandardCardSection, NSSecureCoding, NSCopying> {
    /* instance variables */
    struct { unsigned int is_quote:1; unsigned int has_background_platter:1; unsigned int is_fresh:1; unsigned int is_markdown:1; } _has;
}
...
- (_Bool)hasHas_background_platter;
- (_Bool)hasIs_fresh;
- (_Bool)hasIs_markdown;
- (_Bool)hasIs_quote;

@end

#endif /* RFLongItemStandardCardSection_h */
