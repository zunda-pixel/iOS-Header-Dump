...
//
#ifndef _SFPBRFFactItemShortNumberCardSection_Protocol_h
#define _SFPBRFFactItemShortNumberCardSection_Protocol_h
@import Foundation;
...
#endif /* _SFPBRFFactItemShortNumberCardSection_Protocol_h */
