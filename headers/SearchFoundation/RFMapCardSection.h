...
//
#ifndef RFMapCardSection_h
#define RFMapCardSection_h
@import Foundation;

#include "RFMapCardSection-Protocol.h"
...
@interface RFMapCardSection : SFCardSection <RFMapCardSection, NSSecureCoding, NSCopying> {
    /* instance variables */
    struct { unsigned int sizeFormat:1; unsigned int cameraDistance:1; unsigned int showsUserLocation:1; } _has;
}
...
- (_Bool)hasCameraDistance;
- (_Bool)hasShowsUserLocation;
- (_Bool)hasSizeFormat;

@end

#endif /* RFMapCardSection_h */
