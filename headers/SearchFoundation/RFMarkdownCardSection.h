...
//
#ifndef RFMarkdownCardSection_h
#define RFMarkdownCardSection_h
@import Foundation;

#include "RFMarkdownCardSection-Protocol.h"
...
@interface RFMarkdownCardSection : SFCardSection <RFMarkdownCardSection, NSSecureCoding, NSCopying> {
    /* instance variables */
    struct { unsigned int streaming_state:1; } _has;
}
...
- (_Bool)hasStreaming_state;

@end

#endif /* RFMarkdownCardSection_h */
