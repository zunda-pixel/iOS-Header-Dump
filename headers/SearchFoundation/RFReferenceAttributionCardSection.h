...
//
#ifndef RFReferenceAttributionCardSection_h
#define RFReferenceAttributionCardSection_h
@import Foundation;

#include "RFReferenceAttributionCardSection-Protocol.h"
...
@interface RFReferenceAttributionCardSection : SFCardSection <RFReferenceAttributionCardSection, NSSecureCoding, NSCopying> {
    /* instance variables */
    struct { unsigned int attribution_type:1; unsigned int expansion_type:1; unsigned int add_tint:1; } _has;
}
...
- (_Bool)hasAdd_tint;
- (_Bool)hasAttribution_type;
- (_Bool)hasExpansion_type;

@end

#endif /* RFReferenceAttributionCardSection_h */
