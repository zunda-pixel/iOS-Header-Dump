...
- (id)initWithConfiguration:(id)configuration triggerTokens:(id)tokens useKeywordSpotting:(_Bool)spotting;
- (void)recognizeWavData:(const short *)data length:(int)length;
- (void)runRecognitionWithCallback:(id /* block */)callback;

@end

#endif /* VTTranscriber_h */
