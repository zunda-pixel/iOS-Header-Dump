...
//
#ifndef CFXRemoteRenderCommandEncoder_h
#define CFXRemoteRenderCommandEncoder_h
@import Foundation;
...
- (unsigned long long)_resourceIDForBuffer:(id)buffer;
...
- (id)initWithRemoteFrameBuilder:(struct __CFXRemoteFrameBuilder *)builder;
...
#endif /* CFXRemoteRenderCommandEncoder_h */
