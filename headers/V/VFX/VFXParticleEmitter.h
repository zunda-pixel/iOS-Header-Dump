...
//
#ifndef VFXParticleEmitter_h
#define VFXParticleEmitter_h
@import Foundation;
...
+ (id)particleEmitterWithEntityHandle:(id)handle;
+ (id)particleEmitterWithEntityObject:(id)object;
...
- (void)retargetWithRemapTable:(struct __CFDictionary *)table;

@end

#endif /* VFXParticleEmitter_h */
