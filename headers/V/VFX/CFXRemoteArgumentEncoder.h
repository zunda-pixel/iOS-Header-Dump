...
//
#ifndef CFXRemoteArgumentEncoder_h
#define CFXRemoteArgumentEncoder_h
@import Foundation;
...
- (id)initWithRemoteFrameBuilder:(struct __CFXRemoteFrameBuilder *)builder encoder:(id)encoder;

@end

#endif /* CFXRemoteArgumentEncoder_h */
