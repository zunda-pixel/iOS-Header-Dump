...
//
#ifndef CSLRCFedRecord_h
#define CSLRCFedRecord_h
@import Foundation;

#include "CSLRCFedRecordLRCFedClientMetadata.h"
...
@property (retain, nonatomic) NSData *lrcRecordFedHash;
