...
@interface _UIPageIndicatorStore : NSObject {
    /* instance variables */
    struct { struct SizeForMaximumContentSizeCache { unsigned int dirty:1; double fittingLength; struct CGSize { double width; double height; } maximumSize; } fittingSize; struct NumberOfVisibleIndicatorsForStartIndexCache { unsigned int dirty:1; double fittingLength; long long startIndex; long long numberOfIndicators; } indicatorCount; struct ContentSizeForNumberOfPagesCache { unsigned int dirty:1; double numberOfPages; struct CGSize { double width; double height; } contentSize; } contentSize; struct MinimumContentSizeForIndicatorsInRangeCache { unsigned int dirty:1; struct _NSRange { unsigned long long location; unsigned long long length; } range; struct CGSize { double width; double height; } contentSize; } contentSizeInRange; } _cache;
...
- (struct CGSize { double x0; double x1; })minimumContentSizeForIndicatorsInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })range hasExpandedActiveIndicator:(_Bool)indicator;
- (id)customActiveIndicatorImageForPage:(long long)page;
- (long long)numberOfVisibleIndicatorsForStartIndex:(long long)index fittingLength:(double)length hasExpandedActiveIndicator:(_Bool)indicator;
- (struct CGSize { double x0; double x1; })resolvedIndicatorLayoutSizeForPage:(long long)page;
- (void)_resetStore;
- (struct CGSize { double x0; double x1; })_contentSizeForIndicatorsInRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })range hasExpandedActiveIndicator:(_Bool)indicator;
- (struct CGSize { double x0; double x1; })_sizeForMaximumContentSizeFittingLength:(double)length hasExpandedActiveIndicator:(_Bool)indicator;
...
- (void)_insertImage:(id)image forPage:(long long)page active:(_Bool)active;
...
- (void)_updateImage:(id)image forPage:(long long)page active:(_Bool)active;
- (struct CGSize { double x0; double x1; })_indicatorSizeForObject:(id)object;
- (long long)objectIndexForPage:(long long)page;
- (struct CGSize { double x0; double x1; })contentSizeForNumberOfPages:(long long)pages hasExpandedActiveIndicator:(_Bool)indicator;
- (void)_removeImageForPage:(long long)page active:(_Bool)active;
- (struct CGSize { double x0; double x1; })defaultIndicatorSize;
- (struct CGSize { double x0; double x1; })sizeForMaximumContentSizeFittingLength:(double)length hasExpandedActiveIndicator:(_Bool)indicator;
- (id)init;
