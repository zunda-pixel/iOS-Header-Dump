...
//
#ifndef UITrackingWindowView_h
#define UITrackingWindowView_h
@import Foundation;

#include "UIKBRenderConfig.h"
#include "UIScreen.h"
#include "UITrackingElementHostView.h"
#include "_UIViewHost-Protocol.h"

@interface UITrackingWindowView : UITrackingElementHostView <_UIViewHost> {
    /* instance variables */
