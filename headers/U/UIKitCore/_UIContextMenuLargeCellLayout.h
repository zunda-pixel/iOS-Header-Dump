...
@property (retain, nonatomic) NSLayoutConstraint *labelStackViewTrailingToDecorationViewLeading;
@property (retain, nonatomic) NSLayoutConstraint *keyboardShortcutTrailingToTrailing;
@property (retain, nonatomic) NSLayoutConstraint *labelStackViewTrailingToKeyboardShortcutLeading;
...
#endif /* _UIContextMenuLargeCellLayout_h */
