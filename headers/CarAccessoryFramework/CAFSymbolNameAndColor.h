...
//
#ifndef CAFSymbolNameAndColor_h
#define CAFSymbolNameAndColor_h
@import Foundation;

@interface CAFSymbolNameAndColor : NSObject <NSFastEnumeration>

@property (readonly, nonatomic) NSArray *symbolImageWithColors;
...
- (id)initWithSymbolImageWithColors:(id)colors;

@end

#endif /* CAFSymbolNameAndColor_h */
