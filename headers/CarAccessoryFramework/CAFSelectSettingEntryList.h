...
//
#ifndef CAFSelectSettingEntryList_h
#define CAFSelectSettingEntryList_h
@import Foundation;

@interface CAFSelectSettingEntryList : NSObject <NSFastEnumeration>

@property (readonly, nonatomic) NSArray *selectSettingEntrys;
...
- (id)initWithSelectSettingEntrys:(id)entrys;

@end

#endif /* CAFSelectSettingEntryList_h */
