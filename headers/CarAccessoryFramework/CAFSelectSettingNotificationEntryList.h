...
//
#ifndef CAFSelectSettingNotificationEntryList_h
#define CAFSelectSettingNotificationEntryList_h
@import Foundation;

@interface CAFSelectSettingNotificationEntryList : NSObject <NSFastEnumeration>

@property (readonly, nonatomic) NSArray *selectSettingNotificationEntrys;
...
- (id)initWithSelectSettingNotificationEntrys:(id)entrys;

@end

#endif /* CAFSelectSettingNotificationEntryList_h */
