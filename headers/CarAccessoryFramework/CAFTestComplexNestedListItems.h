...
//
#ifndef CAFTestComplexNestedListItems_h
#define CAFTestComplexNestedListItems_h
@import Foundation;

@interface CAFTestComplexNestedListItems : NSObject <NSFastEnumeration>

@property (readonly, nonatomic) NSArray *testComplexNestedListItems;
...
- (id)initWithTestComplexNestedListItems:(id)items;

@end

#endif /* CAFTestComplexNestedListItems_h */
