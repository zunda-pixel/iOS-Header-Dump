...
//
#ifndef CAFSupportedColors_h
#define CAFSupportedColors_h
@import Foundation;

@interface CAFSupportedColors : NSObject <NSFastEnumeration>

@property (readonly, nonatomic) NSArray *supportedColors;
...
- (id)initWithSupportedColors:(id)colors;

@end

#endif /* CAFSupportedColors_h */
