...
/* instance methods */
- (id)backgroundColor;
- (id)initWithContainerSize:(struct CGSize { double x0; double x1; })size insets:(struct UIEdgeInsets { double x0; double x1; double x2; double x3; })insets userInfoViewHeight:(double)height screenScale:(double)scale RTL:(_Bool)rtl showSideGroupPicker:(_Bool)picker;
- (id)initWithContainerSize:(struct CGSize { double x0; double x1; })size insets:(struct UIEdgeInsets { double x0; double x1; double x2; double x3; })insets userInfoViewHeight:(double)height screenScale:(double)scale RTL:(_Bool)rtl showSideGroupPicker:(_Bool)picker maxGroupLabelWidth:(double)width;
- (void)raiseExceptionForPropertyString:(id)string;

@end

#endif /* AVTAvatarAttributeEditorLayout_h */
