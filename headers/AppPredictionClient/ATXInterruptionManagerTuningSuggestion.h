...
- (id)initWithSuggestionType:(long long)type;
- (_Bool)isEqualToATXInterruptionManagerTuningSuggestion:(id)suggestion;

@end

#endif /* ATXInterruptionManagerTuningSuggestion_h */
