...
@class PKPartialShareInvitation;
...
- (_Bool)isEqualToSharingMessageExtensionRelayServerLocalProperties:(id)properties;

@end

#endif /* PKSharingMessageExtensionRelayServerLocalProperties_h */
