...
//
#ifndef GDGraphBehaviorActivityEvent_h
#define GDGraphBehaviorActivityEvent_h
@import Foundation;

#include "GDGraphActivityEventTypeEntityIdentifier.h"
#include "GDGraphBehaviorActivityEventEntityIdentifier.h"
...
/* instance methods */
- (id)initWithEntityIdentifierField:(id)field nameField:(id)field dateField:(id)field attendeesField:(id)field locationsField:(id)field startLocationField:(id)field endLocationField:(id)field activityTypeObjectField:(id)field activityTypeField:(id)field confidenceField:(id)field behaviorTypeField:(id)field allNameField:(id)field allDateField:(id)field allStartLocationField:(id)field allEndLocationField:(id)field allActivityTypeObjectField:(id)field allActivityTypeField:(id)field allConfidenceField:(id)field allBehaviorTypeField:(id)field;

@end

#endif /* GDGraphBehaviorActivityEvent_h */
