...
//
#ifndef GDGraphGamingActivityEvent_h
#define GDGraphGamingActivityEvent_h
@import Foundation;

#include "GDGraphActivityEventTypeEntityIdentifier.h"
#include "GDGraphDateRelationship.h"
#include "GDGraphGamingActivityEventEntityIdentifier.h"
#include "GDGraphLocationEntityIdentifier.h"
#include "GDGraphObject-Protocol.h"
#include "GDGraphSoftwareRelationship.h"
...
/* instance methods */
- (id)initWithEntityIdentifierField:(id)field nameField:(id)field dateField:(id)field attendeesField:(id)field locationsField:(id)field startLocationField:(id)field endLocationField:(id)field activityTypeObjectField:(id)field activityTypeField:(id)field confidenceField:(id)field softwareField:(id)field allNameField:(id)field allDateField:(id)field allStartLocationField:(id)field allEndLocationField:(id)field allActivityTypeObjectField:(id)field allActivityTypeField:(id)field allConfidenceField:(id)field allSoftwareField:(id)field;

@end

#endif /* GDGraphGamingActivityEvent_h */
