...
//
#ifndef GDKTSContextAggregateRepresentation_h
#define GDKTSContextAggregateRepresentation_h
@import Foundation;
...
- (id)initWithOriginContexts:(id)contexts ktsContexts:(id)contexts destinationContexts:(id)contexts;

@end

#endif /* GDKTSContextAggregateRepresentation_h */
