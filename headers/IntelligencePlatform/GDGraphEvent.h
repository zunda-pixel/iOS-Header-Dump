...
//
#ifndef GDGraphEvent_h
#define GDGraphEvent_h
@import Foundation;

#include "GDGraphDateRelationship.h"
#include "GDGraphEventEntityIdentifier.h"
...
/* instance methods */
- (id)initWithEntityIdentifierField:(id)field eventTypesField:(id)field nameField:(id)field dateField:(id)field attendeesField:(id)field cooccurringEventsField:(id)field locationsField:(id)field startLocationField:(id)field endLocationField:(id)field allNameField:(id)field allDateField:(id)field allStartLocationField:(id)field allEndLocationField:(id)field;

@end

#endif /* GDGraphEvent_h */
