...
#include "_CPFeedbackPayload-Protocol.h"
...
- (void)updateQueryId:(unsigned long long)id;
- (void)updateResults:(id)results withId:(unsigned long long)id;

@end

#endif /* _CPFeedbackPayload_h */
