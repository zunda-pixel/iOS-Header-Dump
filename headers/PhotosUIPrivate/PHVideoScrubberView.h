...
@protocol PHVideoScrubberFilmstripViewProvider, PHVideoScrubberViewInteractionDelegate;
...
@property (retain, nonatomic) UIView<PHVideoScrubberFilmstripView> *_filmStripView;
@property (retain, nonatomic) PXVideoScrubberController *_videoScrubberController;
@property (retain, nonatomic) UIScrollView *scrollView;
@property (retain, nonatomic) PUPlayheadView *_playheadView;
