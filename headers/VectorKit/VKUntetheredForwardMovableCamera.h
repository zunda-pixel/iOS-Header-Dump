...
//
#ifndef VKUntetheredForwardMovableCamera_h
#define VKUntetheredForwardMovableCamera_h
@import Foundation;
...
/* instance methods */
- (void)setMoveableCamera:(id)camera;
...
#endif /* VKUntetheredForwardMovableCamera_h */
