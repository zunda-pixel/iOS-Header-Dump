...
@interface NTPBAdEngagement : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int videoAdDuration:1; unsigned int videoAdPlayTime:1; unsigned int adCreativeType:1; unsigned int adEngagementType:1; unsigned int adImpressionTimeThreshold:1; unsigned int adLocation:1; unsigned int adType:1; unsigned int feedType:1; unsigned int groupType:1; unsigned int newsProductType:1; unsigned int videoAdPlacementPosition:1; unsigned int videoAdType:1; unsigned int videoAdViewComplete:1; } _has;
}
