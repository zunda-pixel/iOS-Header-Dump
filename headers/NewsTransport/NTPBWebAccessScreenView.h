...
@interface NTPBWebAccessScreenView : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int paidSubscriptionConversionPointType:1; unsigned int parentFeedType:1; unsigned int resultType:1; unsigned int userAction:1; unsigned int webAccessScreenPresentationReason:1; unsigned int arrivedFromAd:1; unsigned int subscriptionOnlyArticlePreview:1; } _has;
}
