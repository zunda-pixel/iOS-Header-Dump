...
@interface NTPBMediaExposure : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int backendArticleVersionInt64:1; unsigned int personalizationTreatmentId:1; unsigned int previousArticlePublisherArticleVersion:1; unsigned int publisherArticleVersionInt64:1; unsigned int articleType:1; unsigned int backendArticleVersion:1; unsigned int countOfImagesExposed:1; unsigned int countOfImagesInGallery:1; unsigned int feedCellSection:1; unsigned int feedType:1; unsigned int galleryType:1; unsigned int mediaLocation:1; unsigned int mediaType:1; unsigned int publisherArticleVersion:1; unsigned int videoType:1; unsigned int adSupportedChannel:1; unsigned int isDigitalReplicaAd:1; unsigned int isNativeAd:1; unsigned int isUserSubscribedToFeed:1; unsigned int isVideoInFeed:1; } _has;
}
