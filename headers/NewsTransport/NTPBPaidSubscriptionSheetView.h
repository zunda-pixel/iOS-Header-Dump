...
@interface NTPBPaidSubscriptionSheetView : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int groupType:1; unsigned int paidSubscriptionConversionPointExposureLocation:1; unsigned int paidSubscriptionConversionPointType:1; unsigned int paidSubscriptionSheetViewPresentationReason:1; unsigned int parentFeedType:1; unsigned int userAction:1; unsigned int arrivedFromAd:1; unsigned int subscriptionOnlyArticlePreview:1; } _has;
}
