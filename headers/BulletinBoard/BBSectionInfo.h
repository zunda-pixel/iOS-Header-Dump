...
- (id)effectiveSectionInfoWithDefaultContentPreviewSetting:(long long)setting globalAnnounceSetting:(long long)setting globalScheduledDeliverySetting:(long long)setting globalSummarizationSetting:(long long)setting globalPrioritizationSetting:(long long)setting hasPairedVehiclesForCarPlay:(_Bool)play hasDestinationForRemoteNotifications:(_Bool)notifications;
- (id)effectiveSectionInfoWithFactoryInfo:(id)info defaultContentPreviewSetting:(long long)setting globalAnnounceSetting:(long long)setting globalScheduledDeliverySetting:(long long)setting globalSummarizationSetting:(long long)setting globalPrioritizationSetting:(long long)setting hasPairedVehiclesForCarPlay:(_Bool)play hasDestinationForRemoteNotifications:(_Bool)notifications;

@end

#endif /* BBSectionInfo_h */
