...
//
#ifndef COMAPPLEPETCOMMONPETMetadata_h
#define COMAPPLEPETCOMMONPETMetadata_h
@import Foundation;
...
@interface COMAPPLEPETCOMMONPETMetadata : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int uploadTime:1; unsigned int configVersion:1; unsigned int typeId:1; unsigned int uploadService:1; unsigned int isConfigEnabled:1; unsigned int isGm:1; unsigned int isInternal:1; unsigned int isInternalCarry:1; unsigned int isSeed:1; unsigned int isTestingData:1; unsigned int isTrialUpload:1; } _has;
}
...
#endif /* COMAPPLEPETCOMMONPETMetadata_h */
