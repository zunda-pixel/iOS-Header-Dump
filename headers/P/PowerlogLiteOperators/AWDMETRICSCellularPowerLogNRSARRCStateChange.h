...
@interface AWDMETRICSCellularPowerLogNRSARRCStateChange : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int timestamp:1; unsigned int cause:1; unsigned int fr:1; unsigned int prevState:1; unsigned int prevStateDurMs:1; unsigned int state:1; unsigned int subsId:1; } _has;
}
...
#endif /* AWDMETRICSCellularPowerLogNRSARRCStateChange_h */
