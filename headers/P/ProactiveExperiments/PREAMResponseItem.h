...
@interface PREAMResponseItem : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int ageGroup:1; unsigned int modelId:1; unsigned int position:1; unsigned int replyTextId:1; unsigned int responseClassId:1; unsigned int isApricotDevice:1; unsigned int isCustomResponse:1; unsigned int isRobotResponse:1; } _has;
}
