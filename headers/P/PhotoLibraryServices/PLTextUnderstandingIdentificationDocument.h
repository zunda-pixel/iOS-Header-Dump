...
//
#ifndef PLTextUnderstandingIdentificationDocument_h
#define PLTextUnderstandingIdentificationDocument_h
@import Foundation;
...
+ (id)_csCardTypeFromIdentificationDocumentKind:(long long)kind;
+ (id)_dateFromDateComponents:(id)components;
+ (id)textUnderstandingIdentificationDocumentFromData:(id)data error:(id *)error;
...
#endif /* PLTextUnderstandingIdentificationDocument_h */
