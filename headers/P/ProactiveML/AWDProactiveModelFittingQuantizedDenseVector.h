...
@interface AWDProactiveModelFittingQuantizedDenseVector : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int bucketSize:1; unsigned int minValue:1; } _has;
}
...
/* class methods */
+ (id)quantizedDenseVectorFromDenseVector:(id)vector numberOfBuckets:(unsigned long long)buckets;
