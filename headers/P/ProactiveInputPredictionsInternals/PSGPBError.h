...
@interface PSGPBError : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int errorType:1; unsigned int maxPredictionItems:1; unsigned int maxStructuredInfoItems:1; unsigned int maxTextualResponseItems:1; unsigned int triggerSourceType:1; unsigned int hasContextBeforeInput:1; unsigned int hasRecipientNames:1; unsigned int hasResponseContext:1; unsigned int isDocumentEmpty:1; unsigned int isResponseContextBlacklisted:1; } _has;
}
