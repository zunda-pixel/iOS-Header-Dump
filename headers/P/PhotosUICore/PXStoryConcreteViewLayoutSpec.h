...
@class PXExtendedImageConfiguration, PXFeatureSpec, UIColor, UIImage, UIImageConfiguration;
...
- (double)_predictedChromeTextBoxHeightWithAttributes:(id)attributes numberOfLines:(long long)lines;
- (id)chromeSongAttributedStringWithString:(id)string;
- (id)chromeSongStringWithTitle:(id)title artist:(id)artist;
- (id)initWithExtendedTraitCollection:(id)collection options:(unsigned long long)options storyConfigurationOptions:(unsigned long long)options customGeneralChromeTitleConfiguration:(id)configuration;

@end

#endif /* PXStoryConcreteViewLayoutSpec_h */
