...
/* instance methods */
- (id)init;
- (id)initWithPhotosLayout:(id)layout dateType:(unsigned long long)type dateIntervalGranularity:(unsigned long long)granularity;

@end

#endif /* PXPhotosVisibleContentSnapshot_h */
