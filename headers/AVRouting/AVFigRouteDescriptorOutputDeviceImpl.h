...
- (id)initWithRouteDescriptor:(struct __CFDictionary *)descriptor routeDiscoverer:(struct OpaqueFigRouteDiscoverer *)discoverer volumeController:(struct OpaqueFigVolumeControllerState *)controller routingContextFactory:(id)factory useRouteConfigUpdatedNotification:(_Bool)notification routingContext:(struct OpaqueFigRoutingContext *)context;
...
#endif /* AVFigRouteDescriptorOutputDeviceImpl_h */
