...
@class SFSearchResult, WBSCompletionQuery, WBSQuerySuggestion, WBSQuickWebsiteSearchProvider, WBSRichSearchSuggestion;
...
- (id)initWithProvider:(id)provider query:(id)query forQueryID:(long long)id;
- (id)reflectedStringForUserTypedString:(id)string;
- (id)searchFieldIconForCompletionList:(id)list;

@end

#endif /* QuickWebsiteSearchCompletionItem_h */
