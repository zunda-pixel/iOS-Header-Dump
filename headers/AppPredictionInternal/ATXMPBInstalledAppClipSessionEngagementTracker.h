...
@interface ATXMPBInstalledAppClipSessionEngagementTracker : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int engagementType:1; unsigned int numSuggestionsShown:1; } _has;
}
...
@property (nonatomic) _Bool hasNumSuggestionsShown;
...
#endif /* ATXMPBInstalledAppClipSessionEngagementTracker_h */
