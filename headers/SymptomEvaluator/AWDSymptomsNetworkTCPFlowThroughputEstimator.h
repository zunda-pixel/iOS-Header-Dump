...
@interface AWDSymptomsNetworkTCPFlowThroughputEstimator : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int timestamp:1; unsigned int networkType:1; } _has;
}
...
- (id)flowThroughputEventAtIndex:(unsigned long long)index;
- (unsigned long long)flowThroughputEventsCount;

@end

#endif /* AWDSymptomsNetworkTCPFlowThroughputEstimator_h */
