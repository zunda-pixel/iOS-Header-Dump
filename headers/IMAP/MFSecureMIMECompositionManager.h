...
- (_Bool)_nts_copySigningIdentity:(struct __SecIdentity * *)identity error:(id *)error;
...
- (_Bool)_nts_copyEncryptionIdentity:(struct __SecIdentity * *)identity error:(id *)error certificatesByRecipient:(id *)recipient errorsByRecipient:(id *)recipient;
