...
- (id)description;
- (id)initWithIdentifier:(id)identifier organization:(id)organization organizationalUnit:(id)unit iconData:(id)data iconURL:(id)url iconDigest:(id)digest iconDigestAlgorithm:(unsigned long long)algorithm iconMediaType:(id)type privacyPolicyURL:(id)url merchantCategoryCode:(id)code;

@end

#endif /* DCPresentmentProposalReaderMetadata_h */
