...
@property (readonly, nonatomic) _Bool isHeartbeatRegister;
...
/* instance methods */
- (id)initWithGuid:(id)guid success:(_Bool)success connectionType:(unsigned int)type resultCode:(unsigned int)code registrationType:(unsigned int)type isHeartbeatRegister:(_Bool)_register heartbeatDelay:(id)delay genericError:(id)error URLError:(id)urlerror POSIXError:(id)posixerror;
