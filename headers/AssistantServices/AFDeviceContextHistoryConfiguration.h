...
@property (readonly, nonatomic) _Bool keepsHistory;
...
- (id)initWithKeepsHistory:(_Bool)history historyBufferSize:(unsigned long long)size;
...
#endif /* AFDeviceContextHistoryConfiguration_h */
