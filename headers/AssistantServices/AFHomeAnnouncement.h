...
- (id)initWithIdentifier:(id)identifier startedHostTime:(unsigned long long)time finishedHostTime:(unsigned long long)time startedDate:(id)date finishedDate:(id)date;

@end

#endif /* AFHomeAnnouncement_h */
