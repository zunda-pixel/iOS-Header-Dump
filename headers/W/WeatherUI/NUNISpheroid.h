...
@class " vector, " x16, 1, 2, 4, ?=, __int128 x10, __int128 x12, __int128 x4, a x9, e x15, e x7, g x2, int32_t, int32_t f, u x13, u x5;
...
- (void)date:(id)date toEquatorRotation:(float *)rotation toAngle:(float *)angle toLight:(4 *)light toDistance:(float *)distance toRadius:(float *)radius;
