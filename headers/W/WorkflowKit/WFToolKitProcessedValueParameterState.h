...
//
#ifndef WFToolKitProcessedValueParameterState_h
#define WFToolKitProcessedValueParameterState_h
@import Foundation;
...
- (id)initWithProcessedValue:(id)value;
...
#endif /* WFToolKitProcessedValueParameterState_h */
