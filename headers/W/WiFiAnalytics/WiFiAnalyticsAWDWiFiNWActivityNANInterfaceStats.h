...
//
#ifndef WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats_h
#define WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats_h
@import Foundation;
...
@interface WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int enabled:1; unsigned int peerCount:1; unsigned int peersAdded:1; unsigned int peersRemoved:1; } _has;
}
...
#endif /* WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats_h */
