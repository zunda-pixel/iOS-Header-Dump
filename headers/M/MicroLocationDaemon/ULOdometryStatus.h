...
//
#ifndef ULOdometryStatus_h
#define ULOdometryStatus_h
@import Foundation;
...
/* instance methods */
- (id)initWithOdometrySourceType:(long long)type deltaPositionX:(id)x deltaPositionY:(id)y deltaPositionZ:(id)z alignmentAngleRad:(id)rad alignmentAngleErrorEstimateRad:(id)rad quaternionX:(id)x quaternionY:(id)y quaternionZ:(id)z quaternionW:(id)w date:(id)date;

@end

#endif /* ULOdometryStatus_h */
