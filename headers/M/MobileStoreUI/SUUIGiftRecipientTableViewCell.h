...
//
#ifndef SUUIGiftRecipientTableViewCell_h
#define SUUIGiftRecipientTableViewCell_h
@import Foundation;

#include "CNComposeRecipientTextViewDelegate-Protocol.h"
#include "CNContactPickerDelegate-Protocol.h"
#include "SUUIGiftContactSearchController.h"
#include "SUUIGiftContactSearchDelegate-Protocol.h"

@class CNComposeRecipientTextView, CNContactPickerViewController, CNContactStore, UILabel, UITableViewCell, UIView;

@interface SUUIGiftRecipientTableViewCell : UITableViewCell <CNContactPickerDelegate, CNComposeRecipientTextViewDelegate, SUUIGiftContactSearchDelegate> {
    /* instance variables */
...
#endif /* SUUIGiftRecipientTableViewCell_h */
