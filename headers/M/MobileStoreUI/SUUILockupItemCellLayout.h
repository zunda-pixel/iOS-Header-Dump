...
//
#ifndef SUUILockupItemCellLayout_h
#define SUUILockupItemCellLayout_h
@import Foundation;

#include "SUUIEmbeddedMediaView.h"
#include "SUUIItemCellLayout.h"
#include "SUUILockupMetadataView.h"
...
+ (double)heightForLockupStyle:(struct SUUILockupStyle { long long x0; long long x1; unsigned long long x2; })style item:(id)item editorial:(id)editorial clientContext:(id)context;
...
#endif /* SUUILockupItemCellLayout_h */
