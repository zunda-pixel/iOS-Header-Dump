...
//
#ifndef MDFUpdateAppAttributesRequest_h
#define MDFUpdateAppAttributesRequest_h
@import Foundation;

#include "MDFAppRequest.h"

@interface MDFUpdateAppAttributesRequest : MDFAppRequest
...
#endif /* MDFUpdateAppAttributesRequest_h */
