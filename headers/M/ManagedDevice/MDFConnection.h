...
//
#ifndef MDFConnection_h
#define MDFConnection_h
@import Foundation;

#include "CATTaskClientDelegate-Protocol.h"
#include "MDFTransportProvider-Protocol.h"

@class CATOperationQueue, CATTaskClient;

@interface MDFConnection : NSObject <CATTaskClientDelegate, MDFTransportProvider>

@property (readonly, weak, nonatomic) id <MDFTransportProvider> transportProvider;
