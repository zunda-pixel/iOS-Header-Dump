...
@property (nonatomic) unsigned long long counterStride;
@property (nonatomic) unsigned long long skipElements;
@property (nonatomic) _Bool incrementKey;
