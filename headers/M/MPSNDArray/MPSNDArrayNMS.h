...
//
#ifndef MPSNDArrayNMS_h
#define MPSNDArrayNMS_h
@import Foundation;
...
@property (nonatomic) long long maxBoxes;
...
- (id)initWithDevice:(id)device scoreThreshold:(float)threshold;
- (unsigned long long)kernelDimensionalityForSourceArrays:(id)arrays;

@end

#endif /* MPSNDArrayNMS_h */
