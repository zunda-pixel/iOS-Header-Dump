...
@property (nonatomic) const struct MPSScaleTransform { double x0; double x1; double x2; double x3; } * scaleTransform;
@property (nonatomic) unsigned int resampleMode;
