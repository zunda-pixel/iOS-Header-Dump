...
//
#ifndef MPSNDArrayFusedDepthwisePointwiseConvolution_h
#define MPSNDArrayFusedDepthwisePointwiseConvolution_h
@import Foundation;
...
- (id)initWithDevice:(id)device ndArrayFusedConvolutionDescriptor:(id)descriptor;
- (id)initWithDevice:(id)device ndArrayFusedConvolutionDescriptor:(id)descriptor sourceCount:(unsigned long long)count;
...
#endif /* MPSNDArrayFusedDepthwisePointwiseConvolution_h */
