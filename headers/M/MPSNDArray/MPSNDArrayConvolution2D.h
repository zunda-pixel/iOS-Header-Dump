...
#include "MPSAutoTuneKernel-Protocol.h"
...
- (_Bool)advanceAutoTuneIteration;
...
- (id)initWithDevice:(id)device ndArrayConvolution2DDescriptor:(id)ddescriptor sourceCount:(unsigned long long)count;
...
#endif /* MPSNDArrayConvolution2D_h */
