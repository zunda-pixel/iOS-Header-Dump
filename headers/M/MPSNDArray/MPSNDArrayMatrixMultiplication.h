...
#include "MPSNDArrayNormFusionDescriptor.h"
#include "MPSNDArrayQuantizationDescriptor.h"
#include "MPSNDArrayStitchedReductionRMSNorm.h"
#include "MPSNDArrayStitchedReductionSoftmax.h"

@class 1, MPSKernelDAGObject, MPSMatrixMultiplication, MPSNDArray;
...
- (void)encodeToCommandEncoder:(id)encoder commandBuffer:(id)buffer sourceArrays:(id)arrays normScaleArray:(id)array resultState:(id)state destinationArray:(id)array kernelDAGObject:(id)dagobject;
