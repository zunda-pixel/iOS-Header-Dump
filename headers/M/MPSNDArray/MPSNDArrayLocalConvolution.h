...
@property (nonatomic) struct MPSNDArrayConvolutionSizes { unsigned long long x0[2]; } kernelSizes;
@property (nonatomic) struct MPSNDArrayConvolutionSizes { unsigned long long x0[2]; } dilationRates;
...
#endif /* MPSNDArrayLocalConvolution_h */
