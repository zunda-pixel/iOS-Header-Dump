...
//
#ifndef MPSNDArrayCol2imKernel_h
#define MPSNDArrayCol2imKernel_h
@import Foundation;
...
@property (nonatomic) unsigned int paddingLeft;
@property (nonatomic) unsigned int paddingRight;
@property (nonatomic) unsigned int paddingTop;
@property (nonatomic) unsigned int paddingBottom;
@property (nonatomic) unsigned int strideHeight;
@property (nonatomic) unsigned int strideWidth;
@property (nonatomic) unsigned int dilationHeight;
@property (nonatomic) unsigned int dilationWidth;
...
- (id)initWithDevice:(id)device ndArrayIm2colDescriptor:(id)descriptor;
- (unsigned long long)kernelDimensionalityForSourceArrays:(id)arrays;

@end

#endif /* MPSNDArrayCol2imKernel_h */
