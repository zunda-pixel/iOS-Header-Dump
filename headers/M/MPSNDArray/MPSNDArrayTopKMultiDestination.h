...
- (id)initWithDevice:(id)device K:(unsigned long long)k computeGradient:(_Bool)gradient;
...
- (id)initWithDevice:(id)device K:(unsigned long long)k;
- (unsigned long long)kernelDimensionalityForSourceArrays:(id)arrays;

@end

#endif /* MPSNDArrayTopKMultiDestination_h */
