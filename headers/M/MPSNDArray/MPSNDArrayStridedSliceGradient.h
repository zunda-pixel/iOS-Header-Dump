...
- (void)encodeToCommandBuffer:(id)buffer sourceArray:(id)array sourceGradient:(id)gradient gradientState:(id)state destinationArray:(id)array;
...
#endif /* MPSNDArrayStridedSliceGradient_h */
