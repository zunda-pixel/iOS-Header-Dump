...
//
#ifndef MPSNDArrayAffineInt4Dequantize_h
#define MPSNDArrayAffineInt4Dequantize_h
@import Foundation;

#include "MPSNDArrayAffineQuantizationDescriptor.h"
...
- (id)initWithDevice:(id)device quantizationDescriptor:(id)descriptor;
- (id)initWithDevice:(id)device quantizationDescriptor:(id)descriptor sourceCount:(unsigned long long)count;
...
#endif /* MPSNDArrayAffineInt4Dequantize_h */
