...
//
#ifndef MPSNDArrayCostVolume_h
#define MPSNDArrayCostVolume_h
@import Foundation;
...
- (id)initWithDevice:(id)device ndArrayCostVolumeDescriptor:(id)descriptor;
- (unsigned long long)kernelDimensionalityForSourceArrays:(id)arrays;

@end

#endif /* MPSNDArrayCostVolume_h */
