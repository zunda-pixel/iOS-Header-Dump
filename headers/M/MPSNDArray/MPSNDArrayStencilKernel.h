...
@property (nonatomic) int reductionMode;
@property (nonatomic) struct MPSNDArrayStencilOffsets_s { long long x0[4]; } stencilOffsets;
@property (nonatomic) struct MPSNDArrayStencilSizes_s { unsigned long long x0[4]; } stencilStrides;
@property (nonatomic) struct MPSNDArrayStencilSizes_s { unsigned long long x0[4]; } stencilDilationRates;
...
#endif /* MPSNDArrayStencilKernel_h */
