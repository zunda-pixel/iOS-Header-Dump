...
- (void)encodeTransformToCommandBuffer:(id)buffer sourceTexture:(id)texture sourceHistogram:(id)histogram sourceHistogramOffset:(unsigned long long)offset desiredHistogram:(id)histogram desiredHistogramOffset:(unsigned long long)offset;

@end

#endif /* MPSImageHistogramSpecification_h */
