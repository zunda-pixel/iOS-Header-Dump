...
@interface MPSImageLanczosScale : MPSImageScale {
    /* instance variables */
    struct { <MTLTexture> *weights; double scale; double offset; unsigned int limit; unsigned int phaseCount; float phaseStride; float kernelTaps; unsigned int phaseMask; unsigned int kernelSize; } weights[2];
}
