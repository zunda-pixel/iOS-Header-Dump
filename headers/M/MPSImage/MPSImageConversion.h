...
@interface MPSImageConversion : MPSUnaryImageKernel {
    ...
    struct ConversionInfoPtrs_s { struct StageData_s *stages; int *data; float *fData; id *texLUTs; id *trcLUTs; id *dummyLUTs; <MTLBuffer> *devFloatData; unsigned long long offsetToStageClampValues; } convertInfoPtrs;
...
- (id)initWithDevice:(id)device srcAlpha:(unsigned long long)alpha destAlpha:(unsigned long long)alpha backgroundColor:(double *)color conversionInfo:(struct CGColorConversionInfo *)info;
- (void)encodeToCommandBuffer:(id)buffer sourceTexture:(id)texture sourceDecode:(const float *)decode destinationTexture:(id)texture destinationDecode:(const float *)decode;
- (id)initWithDevice:(id)device transform:(id)transform;

@end

#endif /* MPSImageConversion_h */
