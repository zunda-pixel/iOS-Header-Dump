...
@property (nonatomic) unsigned long long zoneWidth;
@property (nonatomic) unsigned long long zoneHeight;
@property (nonatomic) unsigned long long numberOfZonesInX;
@property (nonatomic) unsigned long long numberOfZonesInY;
...
- (void)encodeToCommandBuffer:(id)buffer sourceTexture:(id)texture destinationBuffer:(id)buffer destinationOffset:(unsigned long long)offset;

@end

#endif /* MPSImageScreenTelemetry_h */
