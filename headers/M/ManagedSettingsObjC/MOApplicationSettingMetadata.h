...
- (id)initWithSettingName:(id)name defaultApplication:(id)application combineOperator:(long long)_operator isPublic:(_Bool)_public scope:(id)scope isPrivacySensitive:(_Bool)sensitive;
