...
@property (readonly, nonatomic) _Bool alignCorners;
...
- (id)initWithDevice:(id)device resizeWidth:(unsigned long long)width resizeHeight:(unsigned long long)height alignCorners:(_Bool)corners;

@end

#endif /* MPSNNResizeBilinear_h */
