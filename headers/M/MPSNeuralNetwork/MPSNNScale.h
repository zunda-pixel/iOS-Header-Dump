...
- (id)initWithDevice:(id)device transformProvider:(id)provider handle:(id)handle outputSize:(struct { unsigned long long x0; unsigned long long x1; unsigned long long x2; })size scaleClass:(Class)_class;
