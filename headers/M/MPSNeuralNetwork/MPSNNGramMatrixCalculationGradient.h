...
@interface MPSNNGramMatrixCalculationGradient : MPSCNNGradientKernel {
    /* instance variables */
    struct MPSCNNGramGradientFilters_s { struct MPSCNNGramFilters_s { MPSImageCopyToMatrix *i2mCopy; MPSMatrixCopyToImage *m2iCopy; MPSMatrixMultiplication *gemm_TN; } fwdFilters; MPSMatrixMultiplication *gemm_NN; } _filters;
}
...
#endif /* MPSNNGramMatrixCalculationGradient_h */
