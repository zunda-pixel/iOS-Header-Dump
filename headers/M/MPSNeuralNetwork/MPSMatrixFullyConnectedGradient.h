...
- (void)encodeGradientForDataToCommandBuffer:(id)buffer gradientMatrix:(id)matrix weightMatrix:(id)matrix resultGradientForDataMatrix:(id)matrix;
- (void)encodeGradientForWeightsAndBiasToCommandBuffer:(id)buffer gradientMatrix:(id)matrix inputMatrix:(id)matrix resultGradientForWeightMatrix:(id)matrix resultGradientForBiasVector:(id)vector;

@end

#endif /* MPSMatrixFullyConnectedGradient_h */
