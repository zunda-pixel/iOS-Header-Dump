...
- (id)initWithDevice:(id)device kernelWidth:(unsigned long long)width kernelHeight:(unsigned long long)height;
...
- (void)setKernelWidth:(unsigned long long)width kernelHeight:(unsigned long long)height strideInPixelsX:(unsigned long long)x strideInPixelsY:(unsigned long long)y;
