...
- (id)encodeBatchToCommandBuffer:(id)buffer sourceImages:(id)images labels:(id)labels;
- (id)initWithDevice:(id)device lossDescriptor:(id)descriptor;
- (float)countPresetobjectsSourceImages:(id)images labels:(id)labels;
- (void)encodeBatchToCommandBuffer:(id)buffer sourceImages:(id)images labels:(id)labels destinationImages:(id)images;
- (id)encodeToCommandBuffer:(id)buffer sourceImage:(id)image labels:(id)labels;
- (void)encodeToCommandBuffer:(id)buffer sourceImage:(id)image labels:(id)labels destinationImage:(id)image;
- (void)initializeSupportFiltersWithDevice:(id)device lossDescriptor:(id)descriptor;
- (id)resultStateForSourceImage:(id)image sourceStates:(id)states;
- (id)temporaryResultStateForCommandBuffer:(id)buffer sourceImage:(id)image sourceStates:(id)states;

@end

#endif /* MPSCNNYOLOLoss_h */
