...
- (id)encodeBatchToCommandBuffer:(id)buffer sourceGradients:(id)gradients sourceImages:(id)images batchNormalizationState:(id)state;
- (void)encodeBatchToCommandBuffer:(id)buffer sourceGradients:(id)gradients sourceImages:(id)images batchNormalizationState:(id)state destinationGradients:(id)gradients;
- (id)encodeToCommandBuffer:(id)buffer sourceGradient:(id)gradient sourceImage:(id)image batchNormalizationState:(id)state;
- (void)encodeToCommandBuffer:(id)buffer sourceGradient:(id)gradient sourceImage:(id)image batchNormalizationState:(id)state destinationGradient:(id)gradient;
- (id)initWithDevice:(id)device fusedNeuronDescriptor:(id)descriptor;

@end

#endif /* MPSCNNBatchNormalizationGradient_h */
