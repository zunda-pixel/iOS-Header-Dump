...
@class MPSImageCopyToMatrix, MPSMatrixCopyToImage, MPSMatrixMultiplication;
...
@interface MPSNNGramMatrixCalculation : MPSCNNKernel {
    ...
    struct MPSCNNGramFilters_s { MPSImageCopyToMatrix *i2mCopy; MPSMatrixCopyToImage *m2iCopy; MPSMatrixMultiplication *gemm_TN; } _filters;
}
...
- (id)initWithDevice:(id)device alpha:(float)alpha;

@end

#endif /* MPSNNGramMatrixCalculation_h */
