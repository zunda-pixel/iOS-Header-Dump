...
- (void)encodeToCommandBuffer:(id)buffer sourceMatrices:(id)matrices resultMatrix:(id)matrix scaleVector:(id)vector offsetVector:(id)vector biasVector:(id)vector startIndex:(unsigned long long)index;
- (id)initWithDevice:(id)device count:(unsigned long long)count rows:(unsigned long long)rows columns:(unsigned long long)columns transpose:(_Bool)transpose;
- (void)encodeToCommandBuffer:(id)buffer encoder:(id)encoder sourceMatrices:(id)matrices resultMatrix:(id)matrix scaleVector:(id)vector offsetVector:(id)vector biasVector:(id)vector startIndex:(unsigned long long)index;
