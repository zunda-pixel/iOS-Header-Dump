...
//
#ifndef MTLLegacySVComputeCommandEncoder_h
#define MTLLegacySVComputeCommandEncoder_h
@import Foundation;
...
@interface MTLLegacySVComputeCommandEncoder : MTLToolsComputeCommandEncoder <MTLLegacySVCommandEncoder> {
    ...
    struct MTLLegacySVStageBufferHandles { unsigned long long handles[31]; <MTLLegacySVResource> *resources[31]; unsigned long long offsets[31]; unsigned long long strides[31]; unsigned int lengths[31]; unsigned long long gpu_address[2] x[31]; _Bool needsFlush; } _handles;
    struct MTLLegacySVThreadgroupLengths { unsigned int threadgroupSizes[31]; struct GPUDebugThreadgroupTableEntry { unsigned int offset; unsigned int length; } entries[32]; _Bool needsFlush; } _threadgroup;
    ...
    struct MTLLegacySVBufferSubAlloc { <MTLBuffer> *buffer; unsigned long long offset; } _reportBuffer;
...
- (void)setBufferUsageTable:(id)table textureUsageTable:(id)table;
- (void)setKernelReportBuffer:(id)buffer offset:(unsigned long long)offset;
...
#endif /* MTLLegacySVComputeCommandEncoder_h */
