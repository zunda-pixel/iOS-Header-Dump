...
//
#ifndef MTLLegacySVRenderCommandEncoder_h
#define MTLLegacySVRenderCommandEncoder_h
@import Foundation;
...
@interface MTLLegacySVRenderCommandEncoder : MTLToolsRenderCommandEncoder <MTLLegacySVCommandEncoder> {
    ...
    struct MTLLegacySVStageBufferHandles { unsigned long long handles[31]; <MTLLegacySVResource> *resources[31]; unsigned long long offsets[31]; unsigned long long strides[31]; unsigned int lengths[31]; unsigned long long gpu_address[2] x[31]; _Bool needsFlush; } _vertexHandles;
    struct MTLLegacySVStageBufferHandles { unsigned long long handles[31]; <MTLLegacySVResource> *resources[31]; unsigned long long offsets[31]; unsigned long long strides[31]; unsigned int lengths[31]; unsigned long long gpu_address[2] x[31]; _Bool needsFlush; } _fragmentHandles;
    struct MTLLegacySVStageBufferHandles { unsigned long long handles[31]; <MTLLegacySVResource> *resources[31]; unsigned long long offsets[31]; unsigned long long strides[31]; unsigned int lengths[31]; unsigned long long gpu_address[2] x[31]; _Bool needsFlush; } _tileHandles;
    struct MTLLegacySVTileThreadgroup { struct GPUDebugThreadgroupTableEntry { unsigned int offset; unsigned int length; } entries[32]; _Bool needsFlush; } _tileThreadgroup;
    struct MTLLegacySVStageBufferHandles { unsigned long long handles[31]; <MTLLegacySVResource> *resources[31]; unsigned long long offsets[31]; unsigned long long strides[31]; unsigned int lengths[31]; unsigned long long gpu_address[2] x[31]; _Bool needsFlush; } _objectHandles;
    struct MTLLegacySVStageBufferHandles { unsigned long long handles[31]; <MTLLegacySVResource> *resources[31]; unsigned long long offsets[31]; unsigned long long strides[31]; unsigned int lengths[31]; unsigned long long gpu_address[2] x[31]; _Bool needsFlush; } _meshHandles;
    struct MTLLegacySVThreadgroupLengths { unsigned int threadgroupSizes[31]; struct GPUDebugThreadgroupTableEntry { unsigned int offset; unsigned int length; } entries[32]; _Bool needsFlush; } _meshThreadgroup;
    ...
    struct MTLLegacySVBufferSubAlloc { <MTLBuffer> *buffer; unsigned long long offset; } _vertexReportBuffer;
    struct MTLLegacySVBufferSubAlloc { <MTLBuffer> *buffer; unsigned long long offset; } _fragmentReportBuffer;
    struct MTLLegacySVBufferSubAlloc { <MTLBuffer> *buffer; unsigned long long offset; } _tileReportBuffer;
    struct MTLLegacySVBufferSubAlloc { <MTLBuffer> *buffer; unsigned long long offset; } _objectReportBuffer;
    struct MTLLegacySVBufferSubAlloc { <MTLBuffer> *buffer; unsigned long long offset; } _meshReportBuffer;
...
- (void)setBufferUsageTable:(id)table textureUsageTable:(id)table forStage:(unsigned long long)stage;
- (void)setMeshReportBuffer:(id)buffer offset:(unsigned long long)offset;
- (void)setObjectReportBuffer:(id)buffer offset:(unsigned long long)offset;
- (void)setRenderPipelineStateBuffers:(id)buffers;
- (void)setTessellationControlPointIndexBuffer:(id)buffer offset:(unsigned long long)offset;
- (void)setTileReportBuffer:(id)buffer offset:(unsigned long long)offset;
- (void)setVertexReportBuffer:(id)buffer offset:(unsigned long long)offset;
...
#endif /* MTLLegacySVRenderCommandEncoder_h */
