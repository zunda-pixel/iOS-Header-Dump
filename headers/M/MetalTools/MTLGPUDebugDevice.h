...
#include "MTLGPUDebugSynchronizedResidencySet.h"
...
@interface MTLGPUDebugDevice : MTLToolsDevice {
    /* instance variables */
    struct MetalBufferHeap { struct mutex { struct _opaque_pthread_mutex_t { long long __sig; signed char __opaque[56]; } __m_; } _mutex; struct vector<id<MTLBuffer>, std::allocator<id<MTLBuffer>>> { id *__begin_; id __end_;  * *x2; struct { id *__cap_; } x3; } _buffers; struct vector<unsigned int, std::allocator<unsigned int>> { unsigned int *__begin_; unsigned int *__end_; struct { unsigned int *__cap_; } x2; } _freeList; int _currentFreeIndex; unsigned long long _totalMemoryAllocated; unsigned long long _totalMemoryInUse; unsigned long long _bufferLength; MTLGPUDebugDevice *_device; } bufferHeap;
