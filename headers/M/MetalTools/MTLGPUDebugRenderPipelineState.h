...
- (id)initWithRenderPipelineState:(id)state descriptor:(id)descriptor device:(id)device;
- (id)initWithRenderPipelineState:(id)state descriptor:(id)descriptor dynamicLinkingDescriptor:(id)descriptor device:(id)device;
...
- (id)initWithRenderPipelineState:(id)state originalObject:(id)object descriptor:(id)descriptor device:(id)device;
...
- (id)initWithRenderPipelineState:(id)state vertexBinaryFunctions:(id)functions fragmentBinaryFunctions:(id)functions tileBinaryFunctions:(id)functions objectBinaryFunctions:(id)functions meshBinaryFunctions:(id)functions withState:(id)state device:(id)device;
...
#endif /* MTLGPUDebugRenderPipelineState_h */
