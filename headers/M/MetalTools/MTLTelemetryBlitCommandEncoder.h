...
- (void)accumulateBlitDistribution:(unsigned long long)distribution samples:(unsigned long long)samples bytesPerRow:(unsigned long long)row bytesPerImage:(unsigned long long)image bufferSize:(unsigned long long)size type:(unsigned long long)type option:(unsigned long long)option src:(unsigned long long)src;
- (id)initWithBlitCommandEncoder:(id)encoder commandBuffer:(id)buffer descriptor:(id)descriptor;

@end

#endif /* MTLTelemetryBlitCommandEncoder_h */
