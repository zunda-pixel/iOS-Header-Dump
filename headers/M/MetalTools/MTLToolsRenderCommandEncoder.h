...
- (void)setAccelerationStructure:(id)structure atBufferIndex:(unsigned long long)index stage:(unsigned long long)stage;
- (void)setColorResolveTexture:(id)texture slice:(unsigned long long)slice depthPlane:(unsigned long long)plane level:(unsigned long long)level atIndex:(unsigned long long)index yInvert:(_Bool)invert;
- (void)setIntersectionFunctionTable:(id)table atBufferIndex:(unsigned long long)index stage:(unsigned long long)stage;
- (void)setIntersectionFunctionTables:(const id *)tables withBufferRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })range stage:(unsigned long long)stage;
- (void)setVisibleFunctionTable:(id)table atBufferIndex:(unsigned long long)index stage:(unsigned long long)stage;
- (void)setVisibleFunctionTables:(const id *)tables withBufferRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })range stage:(unsigned long long)stage;
- (void)useRenderPipelineState:(id)state;
- (void)useRenderPipelineStates:(const id *)states count:(unsigned long long)count;
