...
- (id)initWithBaseObject:(id)object structType:(id)type parent:(id)parent;
- (void)setArgumentBuffer:(id)buffer startOffset:(unsigned long long)offset elementIndex:(unsigned long long)index;

@end

#endif /* MTLDebugArgumentEncoder_h */
