...
//
#ifndef _MFXTemporalScalingEffectDebug_h
#define _MFXTemporalScalingEffectDebug_h
@import Foundation;

#include "MTLFXTemporalScalerSPI-Protocol.h"
#include "_MTLFXTemporalScaler.h"

@protocol MTLComputePipelineState, MTLFence, MTLTexture;
...
- (id)initWithDevice:(id)device descriptor:(id)descriptor mode:(unsigned long long)mode enableJitterViz:(_Bool)viz;
...
#endif /* _MFXTemporalScalingEffectDebug_h */
