...
@property (nonatomic) _Bool hasPresentedConfirmation;
...
/* class methods */
+ (id)confirmationButtonWithMessage:(id)message confirmationLabel:(id)label handler:(id /* block */)handler;
