...
+ (int)_actionForCertificate:(struct __SecCertificate *)certificate policy:(struct __SecPolicy *)policy uncommentedAddress:(id)address;
+ (int)actionForEncryptionCertificate:(struct __SecCertificate *)certificate address:(id)address;
+ (int)actionForSigningIdentity:(struct __SecIdentity *)identity address:(id)address;
