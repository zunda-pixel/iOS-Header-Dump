...
//
#ifndef MTRBaseClusterJointFabricAdministrator_h
#define MTRBaseClusterJointFabricAdministrator_h
@import Foundation;
...
+ (void)readAttributeAdministratorFabricIndexWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
...
/* instance methods */
- (void)ICACCSRRequestWithCompletion:(id /* block */)completion;
- (void)ICACCSRRequestWithParams:(id)params completion:(id /* block */)completion;
- (void)addICACWithParams:(id)params completion:(id /* block */)completion;
- (void)announceJointFabricAdministratorWithParams:(id)params completion:(id /* block */)completion;
- (void)openJointCommissioningWindowWithParams:(id)params completion:(id /* block */)completion;
- (void)readAttributeAcceptedCommandListWithCompletion:(id /* block */)completion;
- (void)readAttributeAdministratorFabricIndexWithCompletion:(id /* block */)completion;
...
- (void)subscribeAttributeAdministratorFabricIndexWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
...
- (void)transferAnchorCompleteWithCompletion:(id /* block */)completion;
- (void)transferAnchorCompleteWithParams:(id)params completion:(id /* block */)completion;
- (void)transferAnchorRequestWithCompletion:(id /* block */)completion;
- (void)transferAnchorRequestWithParams:(id)params completion:(id /* block */)completion;

@end

#endif /* MTRBaseClusterJointFabricAdministrator_h */
