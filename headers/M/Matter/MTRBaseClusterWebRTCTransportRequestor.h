...
//
#ifndef MTRBaseClusterWebRTCTransportRequestor_h
#define MTRBaseClusterWebRTCTransportRequestor_h
@import Foundation;
...
/* instance methods */
- (void)ICECandidatesWithParams:(id)params completion:(id /* block */)completion;
- (void)answerWithParams:(id)params completion:(id /* block */)completion;
- (void)endWithParams:(id)params completion:(id /* block */)completion;
- (void)offerWithParams:(id)params completion:(id /* block */)completion;
...
#endif /* MTRBaseClusterWebRTCTransportRequestor_h */
