...
+ (void)readAttributeCurrentOutputWithAttributeCache:(id)cache endpoint:(id)endpoint queue:(id)queue completionHandler:(id /* block */)handler;
+ (void)readAttributeCurrentOutputWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
...
+ (void)readAttributeOutputListWithAttributeCache:(id)cache endpoint:(id)endpoint queue:(id)queue completionHandler:(id /* block */)handler;
+ (void)readAttributeOutputListWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
...
- (void)readAttributeCurrentOutputWithCompletion:(id /* block */)completion;
- (void)readAttributeCurrentOutputWithCompletionHandler:(id /* block */)handler;
...
- (void)readAttributeOutputListWithCompletion:(id /* block */)completion;
- (void)readAttributeOutputListWithCompletionHandler:(id /* block */)handler;
- (void)renameOutputWithParams:(id)params completion:(id /* block */)completion;
- (void)renameOutputWithParams:(id)params completionHandler:(id /* block */)handler;
- (void)selectOutputWithParams:(id)params completion:(id /* block */)completion;
- (void)selectOutputWithParams:(id)params completionHandler:(id /* block */)handler;
...
- (void)subscribeAttributeCurrentOutputWithMinInterval:(id)interval maxInterval:(id)interval params:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)subscribeAttributeCurrentOutputWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
...
- (void)subscribeAttributeOutputListWithMinInterval:(id)interval maxInterval:(id)interval params:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)subscribeAttributeOutputListWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;

@end

#endif /* MTRBaseClusterAudioOutput_h */
