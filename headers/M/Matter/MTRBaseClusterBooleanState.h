...
+ (void)readAttributeStateValueWithAttributeCache:(id)cache endpoint:(id)endpoint queue:(id)queue completionHandler:(id /* block */)handler;
+ (void)readAttributeStateValueWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
...
- (void)readAttributeStateValueWithCompletion:(id /* block */)completion;
- (void)readAttributeStateValueWithCompletionHandler:(id /* block */)handler;
...
- (void)subscribeAttributeStateValueWithMinInterval:(id)interval maxInterval:(id)interval params:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)subscribeAttributeStateValueWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;

@end

#endif /* MTRBaseClusterBooleanState_h */
