...
- (void)retrieveLogsRequestWithParams:(id)params completion:(id /* block */)completion;
- (void)retrieveLogsRequestWithParams:(id)params completionHandler:(id /* block */)handler;
...
#endif /* MTRBaseClusterDiagnosticLogs_h */
