...
//
#ifndef MTRBaseClusterContentAppObserver_h
#define MTRBaseClusterContentAppObserver_h
@import Foundation;
...
/* instance methods */
- (void)contentAppMessageWithParams:(id)params completion:(id /* block */)completion;
...
#endif /* MTRBaseClusterContentAppObserver_h */
