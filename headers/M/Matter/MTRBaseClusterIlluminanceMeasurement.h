...
+ (void)readAttributeLightSensorTypeWithAttributeCache:(id)cache endpoint:(id)endpoint queue:(id)queue completionHandler:(id /* block */)handler;
+ (void)readAttributeLightSensorTypeWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
...
- (void)readAttributeLightSensorTypeWithCompletion:(id /* block */)completion;
- (void)readAttributeLightSensorTypeWithCompletionHandler:(id /* block */)handler;
...
- (void)subscribeAttributeLightSensorTypeWithMinInterval:(id)interval maxInterval:(id)interval params:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)subscribeAttributeLightSensorTypeWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
...
#endif /* MTRBaseClusterIlluminanceMeasurement_h */
