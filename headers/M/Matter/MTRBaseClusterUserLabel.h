...
- (void)writeAttributeLabelListWithValue:(id)value completion:(id /* block */)completion;
- (void)writeAttributeLabelListWithValue:(id)value completionHandler:(id /* block */)handler;
- (void)writeAttributeLabelListWithValue:(id)value params:(id)params completion:(id /* block */)completion;
- (void)writeAttributeLabelListWithValue:(id)value params:(id)params completionHandler:(id /* block */)handler;

@end

#endif /* MTRBaseClusterUserLabel_h */
