...
+ (void)readAttributeBindingWithAttributeCache:(id)cache endpoint:(id)endpoint queue:(id)queue completionHandler:(id /* block */)handler;
+ (void)readAttributeBindingWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
...
- (void)readAttributeBindingWithParams:(id)params completion:(id /* block */)completion;
- (void)readAttributeBindingWithParams:(id)params completionHandler:(id /* block */)handler;
...
- (void)subscribeAttributeBindingWithMinInterval:(id)interval maxInterval:(id)interval params:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)subscribeAttributeBindingWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
...
- (void)writeAttributeBindingWithValue:(id)value completion:(id /* block */)completion;
- (void)writeAttributeBindingWithValue:(id)value completionHandler:(id /* block */)handler;
- (void)writeAttributeBindingWithValue:(id)value params:(id)params completion:(id /* block */)completion;
- (void)writeAttributeBindingWithValue:(id)value params:(id)params completionHandler:(id /* block */)handler;

@end

#endif /* MTRBaseClusterBinding_h */
