...
//
#ifndef MTRBaseClusterCommodityMetering_h
#define MTRBaseClusterCommodityMetering_h
@import Foundation;
...
+ (void)readAttributeMaximumMeteredQuantitiesWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
+ (void)readAttributeMeteredQuantityTimestampWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
+ (void)readAttributeMeteredQuantityWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;
...
- (void)readAttributeMaximumMeteredQuantitiesWithCompletion:(id /* block */)completion;
- (void)readAttributeMeteredQuantityTimestampWithCompletion:(id /* block */)completion;
- (void)readAttributeMeteredQuantityWithCompletion:(id /* block */)completion;
...
- (void)subscribeAttributeMaximumMeteredQuantitiesWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)subscribeAttributeMeteredQuantityTimestampWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
- (void)subscribeAttributeMeteredQuantityWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;
...
#endif /* MTRBaseClusterCommodityMetering_h */
