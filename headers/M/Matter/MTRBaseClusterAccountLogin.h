...
- (void)getSetupPINWithParams:(id)params completion:(id /* block */)completion;
- (void)getSetupPINWithParams:(id)params completionHandler:(id /* block */)handler;
- (void)loginWithParams:(id)params completion:(id /* block */)completion;
- (void)loginWithParams:(id)params completionHandler:(id /* block */)handler;
- (void)logoutWithCompletion:(id /* block */)completion;
- (void)logoutWithCompletionHandler:(id /* block */)handler;
- (void)logoutWithParams:(id)params completion:(id /* block */)completion;
- (void)logoutWithParams:(id)params completionHandler:(id /* block */)handler;
...
#endif /* MTRBaseClusterAccountLogin_h */
