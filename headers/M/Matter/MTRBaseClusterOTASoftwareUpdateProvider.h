...
- (void)applyUpdateRequestWithParams:(id)params completionHandler:(id /* block */)handler;
- (void)notifyUpdateAppliedWithParams:(id)params completionHandler:(id /* block */)handler;
- (void)queryImageWithParams:(id)params completionHandler:(id /* block */)handler;
...
#endif /* MTRBaseClusterOtaSoftwareUpdateProvider_h */
