...
//
#ifndef MTRBaseClusterCommissionerControl_h
#define MTRBaseClusterCommissionerControl_h
@import Foundation;
...
+ (void)readAttributeSupportedDeviceCategoriesWithClusterStateCache:(id)cache endpoint:(id)endpoint queue:(id)queue completion:(id /* block */)completion;

/* instance methods */
- (void)commissionNodeWithParams:(id)params completion:(id /* block */)completion;
...
- (void)readAttributeSupportedDeviceCategoriesWithCompletion:(id /* block */)completion;
- (void)requestCommissioningApprovalWithParams:(id)params completion:(id /* block */)completion;
...
- (void)subscribeAttributeSupportedDeviceCategoriesWithParams:(id)params subscriptionEstablished:(id /* block */)established reportHandler:(id /* block */)handler;

@end

#endif /* MTRBaseClusterCommissionerControl_h */
