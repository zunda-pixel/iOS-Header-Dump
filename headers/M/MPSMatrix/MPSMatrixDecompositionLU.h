...
@property (nonatomic) id /* block */ copyBlock;
...
/* instance methods */
- (void)dealloc;
- (void)encodeToCommandBuffer:(id)buffer sourceMatrix:(id)matrix resultMatrix:(id)matrix pivotIndices:(id)indices status:(id)status;
- (void)encodeToCommandEncoder:(id)encoder commandBuffer:(id)buffer sourceMatrix:(id)matrix resultMatrix:(id)matrix pivotIndices:(id)indices status:(id)status;
- (id)initWithDevice:(id)device rows:(unsigned long long)rows columns:(unsigned long long)columns;

@end

#endif /* MPSMatrixDecompositionLU_h */
