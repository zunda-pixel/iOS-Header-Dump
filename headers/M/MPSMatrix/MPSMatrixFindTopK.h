...
@property (nonatomic) _Bool alongColumns;
...
- (void)encodeToCommandBuffer:(id)buffer inputMatrix:(id)matrix resultIndexMatrix:(id)matrix resultValueMatrix:(id)matrix;
- (id)initWithDevice:(id)device numberOfTopKValues:(unsigned long long)kvalues;
