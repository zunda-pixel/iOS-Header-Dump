...
- (id)conflictingExpressPassIdentifiersAtIndex:(unsigned long long)index;
- (unsigned long long)conflictingExpressPassIdentifiersCount;
- (id)conflictingReferenceExpressPassIdentifiersAtIndex:(unsigned long long)index;
- (unsigned long long)conflictingReferenceExpressPassIdentifiersCount;

@end

#endif /* NPKProtoConflictingExpressPassIdentifiersForPassInformationResponse_h */
