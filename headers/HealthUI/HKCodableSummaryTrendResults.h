...
@interface HKCodableSummaryTrendResults : PBCodable <NSCopying> {
    /* instance variables */
    struct APPLE_HKCodableSummaryTrendResults_1 { unsigned int latestSupportedVersion:1; unsigned int minimumSupportedVersion:1; } _has;
}
...
#endif /* HKCodableSummaryTrendResults_h */
