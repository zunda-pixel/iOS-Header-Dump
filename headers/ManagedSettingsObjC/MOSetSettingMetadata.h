...
- (id)initWithSettingName:(id)name defaultSet:(id)set combineOperator:(long long)_operator maximumCount:(unsigned long long)count isPublic:(_Bool)_public scope:(id)scope isPrivacySensitive:(_Bool)sensitive;
