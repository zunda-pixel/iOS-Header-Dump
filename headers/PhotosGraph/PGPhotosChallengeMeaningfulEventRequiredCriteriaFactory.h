...
+ (id)_requiredCriteriaForIdentifiers:(id)identifiers inferenceType:(unsigned long long)type graph:(id)graph sceneTaxonomy:(id)taxonomy params:(id)params;
...
+ (id)requiredCriteriaForIdentifiers:(id)identifiers inferenceType:(unsigned long long)type graph:(id)graph sceneTaxonomy:(id)taxonomy params:(id)params;

@end

#endif /* PGPhotosChallengeMeaningfulEventRequiredCriteriaFactory_h */
