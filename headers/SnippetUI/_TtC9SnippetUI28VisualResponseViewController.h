...
@class SnippetUI.AnyRootView, SnippetUI.Context, UIViewController;

@interface _TtC9SnippetUI28VisualResponseViewController : UIViewController <VRXVisualResponse> { // (Swift)
    /* instance variables */
