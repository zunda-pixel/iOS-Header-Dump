...
@class FBSDisplayConfigurationRequest, FBSDisplayMode, FBSSceneClientSettings;
...
- (_Bool)isUISubclass;
- (id)keyDescriptionForOtherSetting:(unsigned long long)setting;
...
- (id)valueDescriptionForFlag:(long long)flag object:(id)object ofOtherSetting:(unsigned long long)setting;

@end

#endif /* UIApplicationSceneClientSettings_h */
