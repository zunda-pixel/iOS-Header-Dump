...
@property (nonatomic) _Bool isSourceList;
...
- (id)initWithSourceListStyle:(_Bool)style;
...
- (void)positionOnCellFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })frame above:(_Bool)above;
