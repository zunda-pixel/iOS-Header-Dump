...
@interface GEOCompanionDriveStep : PBCodable <GEOCompanionManeuverStep, NSCopying> {
    ...
    struct { unsigned int has_drivingSide:1; unsigned int has_junctionType:1; unsigned int has_maneuverType:1; unsigned int has_shieldType:1; unsigned int has_toFreeway:1; unsigned int read_junctionElements:1; unsigned int read_artworkOverride:1; unsigned int read_chargingInfo:1; unsigned int read_evInfo:1; unsigned int read_exitNumber:1; unsigned int read_maneuverNames:1; unsigned int read_shield:1; unsigned int read_signposts:1; unsigned int wrote_anyField:1; } _flags;
}
