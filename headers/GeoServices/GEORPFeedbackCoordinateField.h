...
@interface GEORPFeedbackCoordinateField : PBCodable <NSCopying> {
    ...
    struct { unsigned int read_editedTile:1; unsigned int read_edited:1; unsigned int read_originalTile:1; unsigned int read_original:1; unsigned int wrote_anyField:1; } _flags;
}
