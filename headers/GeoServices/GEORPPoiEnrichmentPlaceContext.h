...
@interface GEORPPoiEnrichmentPlaceContext : PBCodable <NSCopying> {
    ...
    struct { unsigned int read_entityNames:1; unsigned int read_localizedAddress:1; unsigned int read_mapsCategoryId:1; unsigned int read_placeCenter:1; unsigned int read_placeId:1; unsigned int read_walletCategoryId:1; unsigned int wrote_anyField:1; } _flags;
}
