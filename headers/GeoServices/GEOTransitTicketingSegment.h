...
@interface GEOTransitTicketingSegment : PBCodable <NSCopying> {
    ...
    struct { unsigned int read_unknownFields:1; unsigned int read_paths:1; unsigned int read_segmentName:1; unsigned int read_ticketingUrl:1; unsigned int wrote_anyField:1; } _flags;
}
