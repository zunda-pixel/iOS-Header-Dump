...
@interface GEOVLFSuccessDetails : PBCodable <NSCopying> {
    ...
    struct { unsigned int has_poseConfidence:1; unsigned int read_unknownFields:1; unsigned int read_inlierSuccessIndices:1; unsigned int read_correction:1; unsigned int wrote_anyField:1; } _flags;
}
