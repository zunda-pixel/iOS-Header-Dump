...
@interface GEOPDQueryUnderstandingParameters : PBCodable <NSCopying> {
    ...
    int _type;
    int _workflow;
    struct { unsigned int has_type:1; unsigned int has_workflow:1; unsigned int read_unknownFields:1; unsigned int read_searchString:1; unsigned int read_taxonomyLookupParameters:1; unsigned int read_taxonomySearchParameters:1; unsigned int read_viewportInfo:1; unsigned int wrote_anyField:1; } _flags;
}
