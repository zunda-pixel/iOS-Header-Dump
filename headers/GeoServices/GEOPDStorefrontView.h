...
@interface GEOPDStorefrontView : PBCodable <NSCopying> {
    ...
    struct { unsigned int has_imdataId:1; unsigned int read_lookAtGeo:1; unsigned int read_lookAt:1; unsigned int read_photoPosition:1; unsigned int read_viewpointGeo:1; unsigned int wrote_anyField:1; } _flags;
}
