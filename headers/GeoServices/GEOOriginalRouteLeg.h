...
@interface GEOOriginalRouteLeg : PBCodable <NSCopying> {
    ...
    struct { unsigned int has_encryptedTourMuid:1; unsigned int read_unknownFields:1; unsigned int read_destinationWaypointInfo:1; unsigned int read_evStateInfo:1; unsigned int read_originWaypointInfo:1; unsigned int read_pathLeg:1; unsigned int read_zilchPoints:1; unsigned int wrote_anyField:1; } _flags;
}
