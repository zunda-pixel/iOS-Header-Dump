...
@interface GEORPEditedAccessPoint : PBCodable <NSCopying> {
    ...
    struct { unsigned int read_unknownFields:1; unsigned int read_corrected:1; unsigned int read_name:1; unsigned int read_original:1; unsigned int wrote_anyField:1; } _flags;
}
