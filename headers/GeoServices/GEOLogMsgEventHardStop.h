...
@interface GEOLogMsgEventHardStop : PBCodable <NSCopying> {
    ...
    struct { unsigned int has_score:1; unsigned int read_unknownFields:1; unsigned int read_digits:1; unsigned int read_cities:1; unsigned int wrote_anyField:1; } _flags;
}
