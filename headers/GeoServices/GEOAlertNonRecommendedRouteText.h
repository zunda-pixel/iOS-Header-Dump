...
@interface GEOAlertNonRecommendedRouteText : PBCodable <NSCopying> {
    ...
    struct { unsigned int read_unknownFields:1; unsigned int read_body:1; unsigned int read_responseAlertPrimary:1; unsigned int read_responseAlertSecondary:1; unsigned int read_title:1; unsigned int wrote_anyField:1; } _flags;
}
...
#endif /* GEOAlertNonRecommendedRouteText_h */
