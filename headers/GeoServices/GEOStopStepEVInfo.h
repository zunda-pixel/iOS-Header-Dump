...
@interface GEOStopStepEVInfo : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int has_gainedBatteryPercentage:1; unsigned int has_muid:1; unsigned int has_remainingBatteryPercentage:1; unsigned int has_chargingTime:1; unsigned int has_gainedBatteryCharge:1; unsigned int has_gainedTravelRange:1; unsigned int has_zilchPathIndex:1; } _flags;
}
