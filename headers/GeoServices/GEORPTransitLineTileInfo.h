...
@interface GEORPTransitLineTileInfo : PBCodable <NSCopying> {
    ...
    struct { unsigned int has_transitLineMuid:1; unsigned int read_transitLineName:1; unsigned int read_transitSystemName:1; unsigned int wrote_anyField:1; } _flags;
}
...
#endif /* GEORPTransitLineTileInfo_h */
