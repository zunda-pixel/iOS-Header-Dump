...
@interface GEORPFeedbackFieldOption : PBCodable <NSCopying> {
    ...
    struct { unsigned int has_key:1; unsigned int read_annotations:1; unsigned int read_defaultText:1; unsigned int read_localizedText:1; unsigned int read_tags:1; unsigned int wrote_anyField:1; } _flags;
}
