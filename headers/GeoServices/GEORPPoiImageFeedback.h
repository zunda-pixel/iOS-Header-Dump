...
@interface GEORPPoiImageFeedback : PBCodable <NSCopying> {
    ...
    struct { unsigned int read_unknownFields:1; unsigned int read_poiImageContext:1; unsigned int read_poiImageCorrections:1; unsigned int wrote_anyField:1; } _flags;
}
