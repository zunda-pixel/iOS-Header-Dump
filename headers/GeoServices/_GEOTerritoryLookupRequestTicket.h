...
- (id)initWithLatLngs:(id)lngs shiftLocationsIfNeeded:(_Bool)needed traits:(id)traits;
- (id)initForGEOIPLookup:(id)geoiplookup;

@end

#endif /* _GEOTerritoryLookupRequestTicket_h */
