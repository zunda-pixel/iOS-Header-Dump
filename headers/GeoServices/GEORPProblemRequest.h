...
@interface GEORPProblemRequest : PBRequest <NSCopying> {
    ...
    struct { unsigned int read_analyticMetadata:1; unsigned int read_clientCapabilities:1; unsigned int read_clientMetadata:1; unsigned int read_debugSettings:1; unsigned int read_devicePushToken:1; unsigned int read_inputLanguage:1; unsigned int read_problemUuid:1; unsigned int read_problem:1; unsigned int read_userCredentials:1; unsigned int read_userEmail:1; unsigned int wrote_anyField:1; } _flags;
}
