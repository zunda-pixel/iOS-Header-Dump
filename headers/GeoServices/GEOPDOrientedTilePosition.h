...
@interface GEOPDOrientedTilePosition : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int has_altitude:1; unsigned int has_pitch:1; unsigned int has_roll:1; unsigned int has_x:1; unsigned int has_yaw:1; unsigned int has_y:1; } _flags;
}
