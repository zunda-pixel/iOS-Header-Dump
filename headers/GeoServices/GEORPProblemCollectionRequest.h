...
@interface GEORPProblemCollectionRequest : PBRequest <NSCopying> {
    ...
    struct { unsigned int read_countryCode:1; unsigned int read_debugSettings:1; unsigned int read_devicePushToken:1; unsigned int read_hwMachine:1; unsigned int read_inputLanguage:1; unsigned int read_osRelease:1; unsigned int read_requestElements:1; unsigned int read_userCredentials:1; unsigned int read_userEmail:1; unsigned int read_userLocation:1; unsigned int wrote_anyField:1; } _flags;
}
