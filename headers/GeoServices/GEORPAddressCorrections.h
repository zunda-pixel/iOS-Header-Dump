...
@interface GEORPAddressCorrections : PBCodable <NSCopying> {
    ...
    struct { unsigned int read_unknownFields:1; unsigned int read_accessPoint:1; unsigned int read_addressFields:1; unsigned int read_coordinate:1; unsigned int read_mapLocation:1; unsigned int read_originalAddressFields:1; unsigned int wrote_anyField:1; } _flags;
}
