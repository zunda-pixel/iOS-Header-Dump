...
@interface GEOMapItemCorrectedLocationAttributes : PBCodable <NSCopying> {
    ...
    struct { unsigned int has_lastUpdateDate:1; unsigned int has_hasSubmittedRAP:1; unsigned int read_unknownFields:1; unsigned int read_correctedAddressSecondaryStreetLine:1; unsigned int read_correctedAddress:1; unsigned int read_correctedCoordinate:1; unsigned int read_customLabel:1; unsigned int wrote_anyField:1; } _flags;
}
