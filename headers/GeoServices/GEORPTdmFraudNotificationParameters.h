...
@interface GEORPTdmFraudNotificationParameters : PBCodable <NSCopying> {
    ...
    struct { unsigned int read_unknownFields:1; unsigned int read_anonymousId:1; unsigned int read_fsrData:1; unsigned int read_tdmNamespace:1; unsigned int read_token:1; unsigned int read_transactionId:1; unsigned int wrote_anyField:1; } _flags;
}
