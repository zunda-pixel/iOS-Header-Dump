...
@interface SIRINLUINTERNALEMBEDDINGEmbeddingTensorOutput : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int embeddingDim:1; unsigned int isStableEmbeddingsVersion:1; } _has;
}

@property (readonly, nonatomic) _Bool hasEmbeddingVersion;
...
@property (nonatomic) _Bool hasIsStableEmbeddingsVersion;
@property (nonatomic) _Bool isStableEmbeddingsVersion;
