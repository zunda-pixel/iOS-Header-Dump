...
//
#ifndef SFSafariTableOfContentsCardSection_h
#define SFSafariTableOfContentsCardSection_h
@import Foundation;
...
#include "SFSafariTableOfContentsCardSection-Protocol.h"
...
@interface SFSafariTableOfContentsCardSection : SFCardSection <SFSafariTableOfContentsCardSection, NSSecureCoding, NSCopying> {
    /* instance variables */
    struct { unsigned int tableOfContentsType:1; unsigned int tableOfContentsSource:1; } _has;
}
...
- (_Bool)hasTableOfContentsSource;
- (_Bool)hasTableOfContentsType;

@end

#endif /* SFSafariTableOfContentsCardSection_h */
