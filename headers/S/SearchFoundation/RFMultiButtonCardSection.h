...
//
#ifndef RFMultiButtonCardSection_h
#define RFMultiButtonCardSection_h
@import Foundation;

#include "RFMultiButtonCardSection-Protocol.h"
...
@interface RFMultiButtonCardSection : SFCardSection <RFMultiButtonCardSection, NSSecureCoding, NSCopying> {
    /* instance variables */
    struct { unsigned int layoutType:1; } _has;
}
...
#endif /* RFMultiButtonCardSection_h */
