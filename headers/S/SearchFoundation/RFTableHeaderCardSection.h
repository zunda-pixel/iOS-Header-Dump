...
//
#ifndef RFTableHeaderCardSection_h
#define RFTableHeaderCardSection_h
@import Foundation;
...
@interface RFTableHeaderCardSection : SFCardSection <RFTableHeaderCardSection, NSSecureCoding, NSCopying> {
    /* instance variables */
    struct { unsigned int should_repeat_header_in_flow_layout:1; unsigned int vertical_alignment:1; } _has;
}
...
- (_Bool)hasShould_repeat_header_in_flow_layout;
- (_Bool)hasVertical_alignment;

@end

#endif /* RFTableHeaderCardSection_h */
