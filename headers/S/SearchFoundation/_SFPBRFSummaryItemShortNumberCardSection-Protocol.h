...
//
#ifndef _SFPBRFSummaryItemShortNumberCardSection_Protocol_h
#define _SFPBRFSummaryItemShortNumberCardSection_Protocol_h
@import Foundation;
...
#endif /* _SFPBRFSummaryItemShortNumberCardSection_Protocol_h */
