...
@interface SFDetailedRowCardSection : SFCardSection <SFDetailedRowCardSection, NSSecureCoding, NSCopying> {
    /* instance variables */
    struct { unsigned int preventThumbnailImageScaling:1; unsigned int isSecondaryTitleDetached:1; unsigned int shouldUseCompactDisplay:1; unsigned int buttonItemsAreTrailing:1; } _has;
}
