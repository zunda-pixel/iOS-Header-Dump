...
//
#ifndef _SFPBRFSummaryItemDetailedTextCardSection_Protocol_h
#define _SFPBRFSummaryItemDetailedTextCardSection_Protocol_h
@import Foundation;
...
#endif /* _SFPBRFSummaryItemDetailedTextCardSection_Protocol_h */
