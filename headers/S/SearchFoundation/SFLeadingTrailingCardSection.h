...
#include "SFLeadingTrailingCardSection-Protocol.h"
...
@interface SFLeadingTrailingCardSection : SFCardSection <SFLeadingTrailingCardSection, NSSecureCoding, NSCopying> {
    /* instance variables */
    struct { unsigned int leadingToTrailingRatio:1; } _has;
}
...
- (_Bool)hasLeadingToTrailingRatio;

@end

#endif /* SFLeadingTrailingCardSection_h */
