...
//
#ifndef RFTableRowCardSection_h
#define RFTableRowCardSection_h
@import Foundation;
...
@interface RFTableRowCardSection : SFCardSection <RFTableRowCardSection, NSSecureCoding, NSCopying> {
    /* instance variables */
    struct { unsigned int vertical_alignment:1; unsigned int scale_to_fit:1; } _has;
}
...
- (_Bool)hasScale_to_fit;
- (_Bool)hasVertical_alignment;

@end

#endif /* RFTableRowCardSection_h */
