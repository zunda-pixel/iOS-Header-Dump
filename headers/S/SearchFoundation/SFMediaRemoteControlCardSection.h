...
#include "SFMediaRemoteControlCardSection-Protocol.h"
...
@interface SFMediaRemoteControlCardSection : SFCardSection <SFMediaRemoteControlCardSection, NSSecureCoding, NSCopying> {
    /* instance variables */
    struct { unsigned int playbackRouteUniqueIdentifierIsEncrypted:1; } _has;
}
...
#endif /* SFMediaRemoteControlCardSection_h */
