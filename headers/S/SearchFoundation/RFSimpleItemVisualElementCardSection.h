...
//
#ifndef RFSimpleItemVisualElementCardSection_h
#define RFSimpleItemVisualElementCardSection_h
@import Foundation;

#include "RFSimpleItemVisualElementCardSection-Protocol.h"
...
@interface RFSimpleItemVisualElementCardSection : SFCardSection <RFSimpleItemVisualElementCardSection, NSSecureCoding, NSCopying> {
    /* instance variables */
    struct { unsigned int horizontal_alignment:1; unsigned int attribution_style:1; } _has;
}
...
- (_Bool)hasAttribution_style;
- (_Bool)hasHorizontal_alignment;

@end

#endif /* RFSimpleItemVisualElementCardSection_h */
