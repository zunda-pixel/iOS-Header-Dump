...
//
#ifndef RFSummaryItemStandardCardSection_h
#define RFSummaryItemStandardCardSection_h
@import Foundation;

#include "RFSummaryItemStandardCardSection-Protocol.h"
...
@interface RFSummaryItemStandardCardSection : SFCardSection <RFSummaryItemStandardCardSection, NSSecureCoding, NSCopying> {
    /* instance variables */
    struct { unsigned int suppress_text_2_if_text_1_exceeds_a_single_line:1; } _has;
}
...
- (_Bool)hasSuppress_text_2_if_text_1_exceeds_a_single_line;

@end

#endif /* RFSummaryItemStandardCardSection_h */
