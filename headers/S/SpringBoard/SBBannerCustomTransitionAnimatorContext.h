...
//
#ifndef SBBannerCustomTransitionAnimatorContext_h
#define SBBannerCustomTransitionAnimatorContext_h
@import Foundation;
...
@property (nonatomic) _Bool presentationTransition;
...
- (_Bool)isPresentationTransition;

@end

#endif /* SBBannerCustomTransitionAnimatorContext_h */
