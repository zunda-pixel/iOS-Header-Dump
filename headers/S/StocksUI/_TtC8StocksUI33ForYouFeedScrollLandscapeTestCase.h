...
@interface _TtC8StocksUI33ForYouFeedScrollLandscapeTestCase : NSObject <SNTestCaseScroll, SNTestRunOptions> // (Swift)
...
#endif /* _TtC8StocksUI33ForYouFeedScrollLandscapeTestCase_h */
