...
- (void)_setConnectionMetricsFromNSPControlConnection:(id)connection withCompletion:(id /* block */)completion;
...
- (void)setConnectionMetricsFromConnection:(id)connection isPop:(_Bool)pop isMPTCP:(_Bool)mptcp attemptedEndpoints:(id)endpoints completion:(id /* block */)completion;
- (void)setConnectionMetricsFromNWConnectionForDirect:(id)direct isMPTCP:(_Bool)mptcp attemptedEndpoints:(id)endpoints withCompletion:(id /* block */)completion;
- (void)setConnectionMetricsFromNWConnectionForPOP:(id)pop withCompletion:(id /* block */)completion;
- (void)setConnectionMetricsFromStream:(id)stream isPop:(_Bool)pop withCompletion:(id /* block */)completion;
