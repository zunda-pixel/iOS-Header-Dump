...
@interface MHSchemaMHStatisticDistributionInfo : SISchemaInstrumentationMessage {
    /* instance variables */
    struct { unsigned int num:1; unsigned int max:1; unsigned int min:1; unsigned int avg:1; unsigned int median:1; unsigned int p95:1; unsigned int std:1; unsigned int warmup:1; } _has;
}
...
#endif /* MHSchemaMHStatisticDistributionInfo_h */
