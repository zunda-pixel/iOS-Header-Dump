...
//
#ifndef PFAProcessedClockStatistics_h
#define PFAProcessedClockStatistics_h
@import Foundation;
...
@interface PFAProcessedClockStatistics : SISchemaInstrumentationMessage {
    /* instance variables */
    struct { unsigned int messageCount:1; } _has;
}
...
- (id)redactedEventStatisticsAtIndex:(unsigned long long)index;
