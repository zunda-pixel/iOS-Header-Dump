...
@property (nonatomic) _Bool hasAvAudioSessionInterruptorName;
@property (copy, nonatomic) NSString *avAudioSessionInterruptionType;
@property (nonatomic) _Bool hasAvAudioSessionInterruptionType;
...
#endif /* MHSchemaMHAssistantDaemonAudioRecordingInterruptionStarted_h */
