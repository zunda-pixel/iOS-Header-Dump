...
//
#ifndef PFAPreprocessorSessionStartStatsReported_h
#define PFAPreprocessorSessionStartStatsReported_h
@import Foundation;
...
- (id)anyEventTypeStatisticsAtIndex:(unsigned long long)index;
...
#endif /* PFAPreprocessorSessionStartStatsReported_h */
