...
@interface USOSchemaUSOEntitySpan : SISchemaInstrumentationMessage {
    /* instance variables */
    struct { unsigned int nodeIndex:1; unsigned int sourceComponent:1; unsigned int startIndex:1; unsigned int endIndex:1; unsigned int originAppBundleIdType:1; } _has;
}
...
@property (nonatomic) _Bool hasPayloadAttachmentInfo;
