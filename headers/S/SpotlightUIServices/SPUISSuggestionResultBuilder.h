...
//
#ifndef SPUISSuggestionResultBuilder_h
#define SPUISSuggestionResultBuilder_h
@import Foundation;

#include "SPUISResultBuilder.h"

@class CSSuggestion, SFSearchSuggestion, SPSearchEntity;
...
#endif /* SPUISSuggestionResultBuilder_h */
