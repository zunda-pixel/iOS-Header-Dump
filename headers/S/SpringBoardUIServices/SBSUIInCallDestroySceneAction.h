...
- (id)initWithDestructionReason:(long long)reason analyticsSource:(id)source timeout:(double)timeout withResponseHandler:(id /* block */)handler;

@end

#endif /* SBSUIInCallDestroySceneAction_h */
