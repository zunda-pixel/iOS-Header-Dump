...
//
#ifndef WBSSiteMetadataImageCacheDelegate_Protocol_h
#define WBSSiteMetadataImageCacheDelegate_Protocol_h
@import Foundation;
...
#endif /* WBSSiteMetadataImageCacheDelegate_Protocol_h */
