...
- (id)initWithInput_1:(id)input_1 Confidence:(id)confidence Detected:(id)detected thresholdedHistoryOut:(id)out detectedHistoryOut:(id)out;

@end

#endif /* SNSoundPrintASmokeAlarmModelOutput_h */
