...
- (1)textureSize;
- (struct __C3DTexture *)__prepareFramebufferWithSize:(struct CGSize { double x0; double x1; })size withEngineContext:(struct __C3DEngineContext *)context textureSampler:(struct __C3DTextureSampler { struct __CFRuntimeBase { unsigned long long x0; _Atomic unsigned long long x1; } x0; int x1; int x2; int x3; int x4; int x5; int x6; struct C3DColor4 { union { float x0[4]; struct { float x0; float x1; float x2; float x3; } x1; } x0; } x7; float x8; unsigned char x9; int x10; unsigned long long x11; } *)sampler needsStencil:(_Bool)stencil;
- (void)_bindFramebuffer:(struct __C3DEngineContext *)framebuffer;
- (void)_createFramebufferWithEngineContext:(struct __C3DEngineContext *)context size:(struct CGSize { double x0; double x1; })size;
- (void)_unbindFramebuffer:(struct __C3DEngineContext *)framebuffer;
