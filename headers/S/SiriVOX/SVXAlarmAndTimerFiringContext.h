...
@property (readonly, nonatomic) _Bool hasOtherRunningTimers;
...
- (id)initWithOrderedFiringAlarms:(id)alarms orderedFiringTimers:(id)timers hasOtherRunningTimers:(_Bool)timers;

@end

#endif /* SVXAlarmAndTimerFiringContext_h */
