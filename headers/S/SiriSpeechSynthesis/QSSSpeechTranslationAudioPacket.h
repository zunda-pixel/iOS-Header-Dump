...
- (id)initWithFlatbuffData:(id)data root:(const struct SpeechTranslationAudioPacket { unsigned char x0[1]; } *)root verify:(_Bool)verify;

@end

#endif /* QSSSpeechTranslationAudioPacket_h */
