...
- (id)initWithFlatbuffData:(id)data root:(const struct StartMultilingualSpeechRequest { unsigned char x0[1]; } *)root verify:(_Bool)verify;

@end

#endif /* QSSStartMultilingualSpeechRequest_h */
