...
- (id)initWithFlatbuffData:(id)data root:(const struct TextToSpeechRequestMeta { unsigned char x0[1]; } *)root verify:(_Bool)verify;

@end

#endif /* QSSTextToSpeechRequestMeta_h */
