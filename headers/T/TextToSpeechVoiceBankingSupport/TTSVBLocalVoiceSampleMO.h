...
//
#ifndef TTSVBLocalVoiceSampleMO_h
#define TTSVBLocalVoiceSampleMO_h
@import Foundation;
...
@interface TTSVBLocalVoiceSampleMO : NSManagedObject // (Swift)
...
#endif /* TTSVBLocalVoiceSampleMO_h */
