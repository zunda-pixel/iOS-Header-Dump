...
//
#ifndef TTSVBLocalVoiceModelMO_h
#define TTSVBLocalVoiceModelMO_h
@import Foundation;

#include "TTSVBLocalVoiceMO.h"

@class NSManagedObject;

@interface TTSVBLocalVoiceModelMO : NSManagedObject // (Swift)
...
#endif /* TTSVBLocalVoiceModelMO_h */
