...
//
#ifndef _TXHtmlParser_h
#define _TXHtmlParser_h
@import Foundation;
...
@interface _TXHtmlParser : NSObject {
    ...
    struct _opaque_pthread_mutex_t { long long __sig; signed char __opaque[56]; } _plainTextContentLock;
...
@property (readonly, nonatomic) NSSet *appleAnchorHrefs;
...
- (id)init;
- (id)initWithUTF8DataEnumerator:(id)enumerator;

@end

#endif /* _TXHtmlParser_h */
