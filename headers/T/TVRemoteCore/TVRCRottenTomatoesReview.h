...
//
#ifndef TVRCRottenTomatoesReview_h
#define TVRCRottenTomatoesReview_h
@import Foundation;
...
+ (id)rottenTomatoesReviewWithDictionary:(id)dictionary;
...
- (_Bool)isEqualToRottenTomatoesReview:(id)review;

@end

#endif /* TVRCRottenTomatoesReview_h */
