...
- (struct Offset<siri::speech::qss_fb::AsrGraphemeToPhonemeMessage> { unsigned int x0; })addObjectToBuffer:(void *)buffer;
- (id)flatbuffData;
- (id)initAndVerifyWithFlatbuffData:(id)data;
- (id)initWithFlatbuffData:(id)data;
- (id)initWithFlatbuffData:(id)data root:(const struct AsrGraphemeToPhonemeMessage { unsigned char x0[1]; } *)root;
- (id)initWithFlatbuffData:(id)data root:(const struct AsrGraphemeToPhonemeMessage { unsigned char x0[1]; } *)root verify:(_Bool)verify;

@end

#endif /* FTAsrGraphemeToPhonemeMessage_h */
