...
@property (nonatomic) struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } captureRect;
...
#endif /* PXGMetalCaptureSpriteTexture_h */
