...
+ (id)recordWithDeployment:(id)deployment rampId:(id)id activeFactorPackSetId:(id)id activeTargetingRuleIndex:(id)index targetedFactorPackSetId:(id)id targetedTargetingRuleIndex:(id)index status:(long long)status namespaces:(id)namespaces;
...
- (id)initWithDeployment:(id)deployment rampId:(id)id activeFactorPackSetId:(id)id activeTargetingRuleIndex:(id)index targetedFactorPackSetId:(id)id targetedTargetingRuleIndex:(id)index status:(long long)status namespaces:(id)namespaces;
