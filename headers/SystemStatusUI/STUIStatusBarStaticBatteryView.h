...
//
#ifndef STUIStatusBarStaticBatteryView_h
#define STUIStatusBarStaticBatteryView_h
@import Foundation;

#include "STUIStatusBarDisplayable-Protocol.h"

@class UIAccessibilityHUDItem, _UIStaticBatteryView;
...
#endif /* STUIStatusBarStaticBatteryView_h */
