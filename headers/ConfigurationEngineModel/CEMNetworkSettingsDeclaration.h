...
+ (id)buildWithIdentifier:(id)identifier withForceWiFiWhitelisting:(id)whitelisting withAllowVPNCreation:(id)vpncreation;
...
#endif /* CEMNetworkSettingsDeclaration_h */
