...
+ (id)buildWithIdentifier:(id)identifier withForceAirPlayOutgoingRequestsPairingPassword:(id)password withForceAirPlayIncomingRequestsPairingPassword:(id)password withAllowAirPlayIncomingRequests:(id)requests;
...
#endif /* CEMSystemAirPlaySettingsDeclaration_h */
