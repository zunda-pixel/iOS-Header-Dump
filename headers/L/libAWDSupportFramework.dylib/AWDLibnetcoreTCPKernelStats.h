...
//
#ifndef AWDLibnetcoreTCPKernelStats_h
#define AWDLibnetcoreTCPKernelStats_h
@import Foundation;
...
@interface AWDLibnetcoreTCPKernelStats : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int numTfoBlackholed:1; unsigned int numTfoCookieInvalid:1; unsigned int numTfoCookieRcv:1; unsigned int numTfoCookieReq:1; unsigned int numTfoCookieReqRcv:1; unsigned int numTfoCookieSent:1; unsigned int numTfoFallback:1; unsigned int numTfoSynDataAcked:1; unsigned int numTfoSynDataRcv:1; unsigned int numTfoSynDataSent:1; unsigned int timestamp:1; } _has;
}
...
#endif /* AWDLibnetcoreTCPKernelStats_h */
