...
//
#ifndef AWDIDSRegistrationOperation_h
#define AWDIDSRegistrationOperation_h
@import Foundation;
...
@interface AWDIDSRegistrationOperation : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int timestamp:1; unsigned int connectionType:1; unsigned int genericError:1; unsigned int heartbeatDelay:1; unsigned int heartbeatRegister:1; unsigned int pOSIXError:1; unsigned int registrationError:1; unsigned int resultCode:1; unsigned int success:1; unsigned int uRLError:1; } _has;
}
...
#endif /* AWDIDSRegistrationOperation_h */
