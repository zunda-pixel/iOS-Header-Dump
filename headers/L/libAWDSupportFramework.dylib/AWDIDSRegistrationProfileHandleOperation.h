...
//
#ifndef AWDIDSRegistrationProfileHandleOperation_h
#define AWDIDSRegistrationProfileHandleOperation_h
@import Foundation;
...
@interface AWDIDSRegistrationProfileHandleOperation : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int timestamp:1; unsigned int connectionType:1; unsigned int genericError:1; unsigned int pOSIXError:1; unsigned int registrationError:1; unsigned int resultCode:1; unsigned int success:1; unsigned int uRLError:1; unsigned int vettingStatus:1; } _has;
}
...
#endif /* AWDIDSRegistrationProfileHandleOperation_h */
