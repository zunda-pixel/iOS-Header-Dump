...
//
#ifndef AWDIMessageNicknameRetrieved_h
#define AWDIMessageNicknameRetrieved_h
@import Foundation;
...
@interface AWDIMessageNicknameRetrieved : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int timeTaken:1; unsigned int timestamp:1; unsigned int connectionType:1; unsigned int hasAvatar:1; unsigned int linkQuality:1; unsigned int publicOperationalErrorCode:1; unsigned int publicSuccess:1; unsigned int updated:1; } _has;
}
...
#endif /* AWDIMessageNicknameRetrieved_h */
