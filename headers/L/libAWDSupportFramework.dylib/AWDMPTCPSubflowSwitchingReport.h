...
//
#ifndef AWDMPTCPSubflowSwitchingReport_h
#define AWDMPTCPSubflowSwitchingReport_h
@import Foundation;
...
@interface AWDMPTCPSubflowSwitchingReport : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int timestamp:1; unsigned int switchCount:1; } _has;
}
...
#endif /* AWDMPTCPSubflowSwitchingReport_h */
