...
//
#ifndef AWDIDSStreamingReport_h
#define AWDIDSStreamingReport_h
@import Foundation;
...
@interface AWDIDSStreamingReport : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int bytesReceived:1; unsigned int bytesSent:1; unsigned int packetsReceived:1; unsigned int packetsSent:1; unsigned int priority:1; unsigned int samplingInterval:1; unsigned int timestamp:1; } _has;
}
