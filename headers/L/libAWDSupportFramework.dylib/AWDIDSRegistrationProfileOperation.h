...
//
#ifndef AWDIDSRegistrationProfileOperation_h
#define AWDIDSRegistrationProfileOperation_h
@import Foundation;
...
@interface AWDIDSRegistrationProfileOperation : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int timestamp:1; unsigned int connectionType:1; unsigned int genericError:1; unsigned int pOSIXError:1; unsigned int registrationError:1; unsigned int resultCode:1; unsigned int success:1; unsigned int uRLError:1; } _has;
}
...
#endif /* AWDIDSRegistrationProfileOperation_h */
