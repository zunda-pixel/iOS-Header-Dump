...
/* instance methods */
- (long long)_recalculateSharedAssetContainerValuesForEntityNamed:(id)named propertiesToFetch:(id)fetch inContext:(id)context error:(id *)error;
- (long long)performActionWithManagedObjectContext:(id)context error:(id *)error;

@end

#endif /* PLModelMigrationAction_PopulateInitialSharedAssetCollectionStats_h */
