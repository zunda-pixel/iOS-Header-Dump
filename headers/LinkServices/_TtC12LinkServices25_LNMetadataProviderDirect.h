...
@class Swift.Bool, ppIntents_SQLite.Connection;

@interface _TtC12LinkServices25_LNMetadataProviderDirect : NSObject <LNAutoShortcutsProviderInterface, LNMetadataProviderInterface> { // (Swift)
    /* instance variables */
    _Atomic ppIntents_SQLite.Connection connection;
    Swift.Bool requiresAssertion;
}
...
- (void)diagnoseBundleIdentifier:(NSString *)identifier completionHandler:(id /* block */)handler;
...
- (id)initWithConnection:(id)connection options:(long long)options error:(id *)error;

@end

#endif /* _TtC12LinkServices25_LNMetadataProviderDirect_h */
