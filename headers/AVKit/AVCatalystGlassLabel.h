...
//
#ifndef AVCatalystGlassLabel_h
#define AVCatalystGlassLabel_h
@import Foundation;
...
@interface AVCatalystGlassLabel : UIView <AVPlaybackControlsViewItem>
