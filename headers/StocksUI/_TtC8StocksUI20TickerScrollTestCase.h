...
@class _$sSS, _$sSaySSG, _$sSd, _$sSi, __C.TestAggregate, __C.TestScrollDirection;

@interface _TtC8StocksUI20TickerScrollTestCase : NSObject <SNTestCaseScroll> // (Swift)
...
#endif /* _TtC8StocksUI20TickerScrollTestCase_h */
