...
//
#ifndef FCRecipeItem_h
#define FCRecipeItem_h
@import Foundation;

#include "FCFeedPersonalizedItemScoreProfile.h"
#include "FCRecipeScorable-Protocol.h"

@class COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata, NTPBRecipeItem;
...
- (id)initWithRecipeRecord:(id)record surfacedBy:(id)by order:(long long)order error:(id *)error;
- (id)recipeRecord;

@end

#endif /* FCRecipeItem_h */
