...
#include "FCSportsEventLiveStreamVideo.h"
...
@class NTPBPublisherPaidDescriptionStrings, NTPBSportsEventRecord;
...
/* class methods */
+ (_Bool)_useLiveStreamVideoOverrides;
+ (_Bool)isSportsEventIdentifier:(id)identifier;
...
- (void)_inflateSportsDataFromJSONDictionary:(id)jsondictionary sportsEventRecord:(id)record assetManager:(id)manager;
