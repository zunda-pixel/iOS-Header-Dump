...
@property (readonly, nonatomic) unsigned long long edgeMode;
@property (readonly, nonatomic) NSNumber *constantValue;
@property (nonatomic) double constantValueImagPart;
@property (readonly, nonatomic) struct MPSNDArrayPaddingSize { unsigned long long x0[2] x[16]; } paddingSize;
...
- (id)initWithDevice:(id)device edgeMode:(unsigned long long)mode constantValue:(id)value paddingSize:(struct MPSNDArrayPaddingSize { unsigned long long x0[2] x[16]; })size;
