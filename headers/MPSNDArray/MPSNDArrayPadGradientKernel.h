...
- (id)initWithDevice:(id)device edgeMode:(unsigned long long)mode paddingSize:(struct MPSNDArrayPaddingSize { unsigned long long x0[2] x[16]; })size;
- (1)dimensionsToBeRetained;
- (unsigned long long)kernelDimensionalityForSourceArrays:(id)arrays;

@end

#endif /* MPSNDArrayPadGradientKernel_h */
