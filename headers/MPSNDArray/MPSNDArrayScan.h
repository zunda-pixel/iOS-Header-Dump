...
- (id)initWithDevice:(id)device axis:(unsigned long long)axis operation:(int)operation exclusive:(_Bool)exclusive reverse:(_Bool)reverse;
- (id)initWithDevice:(id)device operation:(int)operation;
- (unsigned long long)kernelDimensionalityForSourceArrays:(id)arrays;

@end

#endif /* MPSNDArrayScan_h */
