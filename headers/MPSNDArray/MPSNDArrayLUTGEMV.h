...
//
#ifndef MPSNDArrayLUTGEMV_h
#define MPSNDArrayLUTGEMV_h
@import Foundation;
...
@property (nonatomic) _Bool hasLUTLHS;
@property (nonatomic) _Bool hasLUTRHS;
...
- (id)initWithDevice:(id)device lhsDesc:(id)desc rhsDesc:(id)desc;
- (id)initWithDevice:(id)device hasLUTLHS:(_Bool)lutlhs hasLUTRHS:(_Bool)lutrhs;
