...
@property (nonatomic) struct MPSNDArrayConv3dOffsets_s { long long x0[3]; } windowOffsets;
@property (nonatomic) struct MPSNDArrayConv3dSizes_s { unsigned long long x0[3]; } convStrides;
@property (nonatomic) struct MPSNDArrayConv3dSizes_s { unsigned long long x0[3]; } convDilationRates;
@property (nonatomic) unsigned long long channelAxis;
@property (nonatomic) int kernelType;
...
#endif /* MPSNDArrayDepthwiseConvolutionKernel_h */
