...
@property (nonatomic) _Bool denseSparse;
@property (nonatomic) _Bool transposeSparse;
@property (nonatomic) unsigned int sparseFormat;
@property (nonatomic) _Bool structuredSparse;
...
#endif /* MPSNDArrayMatrixMultiplicationSparse_h */
