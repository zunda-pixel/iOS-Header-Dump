...
//
#ifndef MPSNDArrayFourierTransform_h
#define MPSNDArrayFourierTransform_h
@import Foundation;
...
@property (nonatomic) unsigned int axesMask;
...
- (id)initWithDevice:(id)device axesMask:(unsigned int)mask scale:(double)scale scalingMode:(int)mode inverse:(_Bool)inverse;
...
#endif /* MPSNDArrayFourierTransform_h */
