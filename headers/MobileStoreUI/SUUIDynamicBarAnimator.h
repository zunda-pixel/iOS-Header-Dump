...
//
#ifndef SUUIDynamicBarAnimator_h
#define SUUIDynamicBarAnimator_h
@import Foundation;
...
@property (weak, nonatomic) id <SUUIDynamicBarAnimatorDelegate> delegate;
...
- (double)_topBarHeightForBottomBarOffset:(double)offset;

@end

#endif /* SUUIDynamicBarAnimator_h */
