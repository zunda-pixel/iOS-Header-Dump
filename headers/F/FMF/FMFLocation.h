...
@class CLLocation, FMAccuracyOverlay, UIColor, UIImage;
...
@property (nonatomic) _Bool locatingInProgress;
...
- (id)initWithHandle:(id)handle locationType:(long long)type location:(id)location activityState:(long long)state label:(id)label locatingInProgress:(_Bool)progress shortAddress:(id)address longAddress:(id)address placemark:(id)placemark;
- (_Bool)isLocatingInProgress;
- (_Bool)isMoreRecentThan:(id)than;
- (id)locationAge;
