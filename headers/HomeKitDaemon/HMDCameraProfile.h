...
#include "HMDCameraSignificantEventNotificationObserver-Protocol.h"
...
- (void)_postNotificationForUpdatedSignificantEvent:(id)event allClipSignificantEvents:(id)events caption:(id)caption notificationReasons:(unsigned long long)reasons;
- (void)_setControlSupport;
- (void)_setUpBulletinNotificationManagerObserver;
- (_Bool)_shouldNotifyForSignificantEvent:(id)event notificationReasons:(unsigned long long)reasons;
...
- (void)initiateCertificateSigningRequestWithCompletion:(id /* block */)completion;
...
- (void)provisionCameraWithCMAFIngestUsingPublishingPointURL:(id)url serverCertificates:(id)certificates expirationDate:(id)date completion:(id /* block */)completion;
- (void)provisionCameraWithClientCertificate:(id)certificate signedByRootCertificate:(id)certificate completion:(id /* block */)completion;
