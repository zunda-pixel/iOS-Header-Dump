...
/* instance methods */
- (id)initWithTopic:(id)topic countForTopic:(unsigned long long)topic userNotificationSettings:(id)settings;

@end

#endif /* HMDBulletinNotificationDailyTotalLogEvent_h */
