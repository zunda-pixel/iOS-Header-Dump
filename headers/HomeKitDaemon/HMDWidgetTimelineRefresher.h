...
#include "HMDActionSetStateSubscriptionManagerObserver-Protocol.h"
...
#include "_TtCE13HomeKitDaemonCSo26HMDWidgetTimelineRefresherP33_E4AFB2A25343A8F5063AD1A14CCEA93715SwiftExtensions.h"

@class HMFObject;
@protocol HMDarwinNotificationProvider, OS_dispatch_queue, OS_dispatch_source;
...
- (void)_startActionSetPrimaryStateUpdateCoalesceTimerContextForActionSetUUID:(id)uuid expectedState:(id)state;
- (id)accessoriesMonitoredForReachability;
- (_Bool)actionSetIsOn:(id)on;
- (id)actionSetsByHome:(id)home;
- (void)configureSwiftExtensions;
- (id)createDataSource;
- (void)didUpdateStateActionSetUUID:(id)uuid state:(_Bool)state;
- (_Bool)evaluateActionSetStateOnPrimaryEnabledForHome:(id)home;
...
- (void)handleMonitorMTRAttributes:(id)mtrattributes;
...
- (void)monitorDeviceNodeID:(id)id controller:(id)controller attributes:(id)attributes;
...
- (void)updateMonitoredMTRAttributes:(id)mtrattributes forWidget:(id)widget;
