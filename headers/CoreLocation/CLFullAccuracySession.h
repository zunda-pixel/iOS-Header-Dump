...
//
#ifndef CLFullAccuracySession_h
#define CLFullAccuracySession_h
@import Foundation;
...
/* class methods */
+ (id)fullAccuracySessionWithLocationManager:(id)manager purposeKey:(id)key queue:(id)queue handler:(id /* block */)handler;
...
- (id)initWithLocationManager:(id)manager purposeKey:(id)key queue:(id)queue handler:(id /* block */)handler;
- (void)manageConnection;
- (void)updateIdentityToken:(id)token withStorageToken:(id)token;

@end

#endif /* CLFullAccuracySession_h */
