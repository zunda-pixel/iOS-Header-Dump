...
- (void)encodeBidirectionalSequenceToCommandBuffer:(id)buffer sourceSequence:(id)sequence destinationForwardMatrices:(id)matrices destinationBackwardMatrices:(id)matrices;
- (void)encodeSequenceToCommandBuffer:(id)buffer sourceMatrices:(id)matrices destinationMatrices:(id)matrices recurrentInputState:(id)state recurrentOutputStates:(id)states;
- (void)encodeSequenceToCommandBuffer:(id)buffer sourceMatrices:(id)matrices sourceOffsets:(unsigned long long *)offsets destinationMatrices:(id)matrices destinationOffsets:(unsigned long long *)offsets recurrentInputState:(id)state recurrentOutputStates:(id)states;
- (id)initWithDevice:(id)device rnnDescriptor:(id)descriptor;
- (id)initWithDevice:(id)device rnnDescriptors:(id)descriptors;
- (id)recurrentStateForBatchSize:(unsigned long long)size;
- (id)temporaryRecurrentStateForCommandBuffer:(id)buffer batchSize:(unsigned long long)size;

@end

#endif /* MPSRNNMatrixInferenceLayer_h */
