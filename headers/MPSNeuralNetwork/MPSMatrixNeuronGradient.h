...
- (void)encodeToCommandBuffer:(id)buffer gradientMatrix:(id)matrix inputMatrix:(id)matrix biasVector:(id)vector resultGradientForDataMatrix:(id)matrix resultGradientForBiasVector:(id)vector;

@end

#endif /* MPSMatrixNeuronGradient_h */
