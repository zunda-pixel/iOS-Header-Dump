...
@property (nonatomic) _Bool computeStatistics;
...
- (void)encodeToCommandBuffer:(id)buffer inputMatrix:(id)matrix meanVector:(id)vector varianceVector:(id)vector gammaVector:(id)vector betaVector:(id)vector resultMatrix:(id)matrix;
