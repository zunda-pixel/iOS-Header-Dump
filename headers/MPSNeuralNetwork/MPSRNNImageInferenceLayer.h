...
- (void)encodeBidirectionalSequenceToCommandBuffer:(id)buffer sourceSequence:(id)sequence destinationForwardImages:(id)images destinationBackwardImages:(id)images;
- (void)encodeSequenceToCommandBuffer:(id)buffer sourceImages:(id)images destinationImages:(id)images recurrentInputState:(id)state recurrentOutputStates:(id)states;
- (id)initWithDevice:(id)device rnnDescriptor:(id)descriptor;
- (id)initWithDevice:(id)device rnnDescriptors:(id)descriptors;

@end

#endif /* MPSRNNImageInferenceLayer_h */
