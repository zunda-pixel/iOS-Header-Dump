...
- (void)encodeToCommandBuffer:(id)buffer gradientMatrix:(id)matrix inputMatrix:(id)matrix meanVector:(id)vector varianceVector:(id)vector gammaVector:(id)vector betaVector:(id)vector resultGradientForDataMatrix:(id)matrix resultGradientForGammaVector:(id)vector resultGradientForBetaVector:(id)vector;

@end

#endif /* MPSMatrixBatchNormalizationGradient_h */
