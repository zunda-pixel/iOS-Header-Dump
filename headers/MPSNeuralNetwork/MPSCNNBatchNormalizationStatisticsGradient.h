...
- (void)encodeBatchToCommandBuffer:(id)buffer sourceGradients:(id)gradients sourceImages:(id)images batchNormalizationState:(id)state;
- (id)initWithDevice:(id)device fusedNeuronDescriptor:(id)descriptor;

@end

#endif /* MPSCNNBatchNormalizationStatisticsGradient_h */
