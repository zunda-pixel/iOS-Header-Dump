...
- (id)initWithDevice:(id)device filterType:(unsigned long long)type integerScaleFactorX:(unsigned long long)x integerScaleFactorY:(unsigned long long)y alignCorners:(_Bool)corners;
