...
- (id)initWithDevice:(id)device filterType:(unsigned long long)type integerScaleFactorX:(unsigned long long)x integerScaleFactorY:(unsigned long long)y;

@end

#endif /* MPSCNNUpsamplingGradient_h */
