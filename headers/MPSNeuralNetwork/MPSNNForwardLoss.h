...
- (id)encodeBatchToCommandBuffer:(id)buffer sourceImages:(id)images labels:(id)labels weights:(id)weights destinationStates:(id *)states destinationStateIsTemporary:(_Bool)temporary;
- (id)destinationImageDescriptorForSourceImages:(id)images sourceStates:(id)states;
- (void)encodeBatchToCommandBuffer:(id)buffer sourceImages:(id)images labels:(id)labels weights:(id)weights destinationStates:(id)states destinationImages:(id)images;

@end

#endif /* MPSNNForwardLoss_h */
