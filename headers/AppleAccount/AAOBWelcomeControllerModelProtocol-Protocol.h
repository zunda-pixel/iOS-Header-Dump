...
//
#ifndef AAOBWelcomeControllerModelProtocol_Protocol_h
#define AAOBWelcomeControllerModelProtocol_Protocol_h
@import Foundation;
...
#endif /* AAOBWelcomeControllerModelProtocol_Protocol_h */
