...
//
#ifndef DNDRemoteServiceServerSettingsProtocol_Protocol_h
#define DNDRemoteServiceServerSettingsProtocol_Protocol_h
@import Foundation;
...
#endif /* DNDRemoteServiceServerSettingsProtocol_Protocol_h */
