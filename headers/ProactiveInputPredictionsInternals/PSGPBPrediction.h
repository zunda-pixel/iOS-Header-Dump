...
@interface PSGPBPrediction : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int dataSourceType:1; unsigned int maxPredictionItems:1; unsigned int maxStructuredInfoItems:1; unsigned int maxTextualResponseItems:1; unsigned int numStructuredInfoItems:1; unsigned int numTextualResponseItems:1; unsigned int triggerSourceType:1; unsigned int hasContextBeforeInput:1; unsigned int hasRecipientNames:1; unsigned int hasResponseContext:1; unsigned int isDocumentEmpty:1; unsigned int isResponseContextBlacklisted:1; unsigned int portraitTimeout:1; unsigned int requiredAppUnavailable:1; } _has;
}
...
@property (nonatomic) _Bool portraitTimeout;
@property (nonatomic) _Bool hasRequiredAppUnavailable;
@property (nonatomic) _Bool requiredAppUnavailable;
