...
#include "_TtC19HomeKitDaemonLegacy28HMDRemoteConnectivityMonitor.h"
#include "_TtP19HomeKitDaemonLegacy36HMDRemoteConnectivityMonitorDelegate_-Protocol.h"

@class HMEMessageDatagramClient, HMFMessageDispatcher;
@protocol OS_dispatch_queue, OS_os_log;

@interface HMDRemoteEventRouterClient : NSObject <HMFMessageReceiver, _TtP19HomeKitDaemonLegacy36HMDRemoteConnectivityMonitorDelegate_, HMFLogging, HMEMessageDatagramClientDataSource, HMEMessageDatagramClientDelegate, HMDRemoteEventRouterAssertionClient> {
    /* instance variables */
...
@property (readonly) _TtC19HomeKitDaemonLegacy28HMDRemoteConnectivityMonitor *connectivityMonitor;
