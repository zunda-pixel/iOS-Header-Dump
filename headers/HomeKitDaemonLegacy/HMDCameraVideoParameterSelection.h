...
- (id)initWithSessionInfo:(id)info videoTierParameters:(id)parameters supportedVideoConfiguration:(id)configuration supportedRTPConfiguration:(id)rtpconfiguration streamingCapabilities:(id)capabilities;
