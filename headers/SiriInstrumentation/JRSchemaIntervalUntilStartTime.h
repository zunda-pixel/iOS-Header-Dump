...
//
#ifndef JRSchemaIntervalUntilStartTime_h
#define JRSchemaIntervalUntilStartTime_h
@import Foundation;
...
- (id)candidateBooleanMaskAtIndex:(unsigned long long)index;
- (unsigned long long)candidateBooleanMaskCount;
- (id)candidateTimeIntervalMatrixAtIndex:(unsigned long long)index;
...
#endif /* JRSchemaIntervalUntilStartTime_h */
