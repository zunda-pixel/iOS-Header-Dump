...
//
#ifndef ODDSiriSchemaODDOptInProperties_h
#define ODDSiriSchemaODDOptInProperties_h
@import Foundation;
...
@interface ODDSiriSchemaODDOptInProperties : SISchemaInstrumentationMessage {
    /* instance variables */
    struct { unsigned int isMteUploadEnabled:1; unsigned int dataSharingOptInStatus:1; unsigned int isServerUserDataSyncEnabled:1; } _has;
}
...
#endif /* ODDSiriSchemaODDOptInProperties_h */
