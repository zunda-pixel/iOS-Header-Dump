...
//
#ifndef ASVSchemaASVOutputVolumeQueried_h
#define ASVSchemaASVOutputVolumeQueried_h
@import Foundation;
...
@interface ASVSchemaASVOutputVolumeQueried : SISchemaInstrumentationMessage {
    /* instance variables */
    struct { unsigned int outputVolume:1; unsigned int speakerDistance:1; unsigned int speakerSpeechLevel:1; unsigned int musicLoudnessLevel:1; unsigned int backgroundNoiseLevel:1; unsigned int backgroundNoiseActivityLevel:1; unsigned int isMediaPlaybackOn:1; unsigned int invocationType:1; unsigned int isPermanentOffsetEnabled:1; unsigned int permanentOffsetFactor:1; } _has;
}
...
#endif /* ASVSchemaASVOutputVolumeQueried_h */
