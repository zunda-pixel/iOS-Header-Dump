...
//
#ifndef QDSchemaQDToolSource_h
#define QDSchemaQDToolSource_h
@import Foundation;
...
- (id)contexualMatchesAtIndex:(unsigned long long)index;
- (unsigned long long)contexualMatchesCount;
- (void)deleteContexualMatches;
- (void)deleteSpanMatches;
- (id)spanMatchesAtIndex:(unsigned long long)index;
- (unsigned long long)spanMatchesCount;

@end

#endif /* QDSchemaQDToolSource_h */
