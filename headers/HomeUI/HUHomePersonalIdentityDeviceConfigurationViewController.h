...
@class NSLayoutConstraint, OBLinkTrayButton, OBTableWelcomeController, OBTrayButton;
...
- (id)initWithMediaProfileAndLanguageInfo:(id)info;
- (Class)onboardingFlowClass;

@end

#endif /* HUHomePersonalIdentityDeviceConfigurationViewController_h */
