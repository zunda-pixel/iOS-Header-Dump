...
@property (retain, nonatomic) UIViewController<HUConfigurationViewController> *setupViewController;
...
+ (_Bool)home:(id)home canShowNaturalLightingOnboardingWithUsageOptions:(id)options;
...
#endif /* HUNaturalLightingOnboardingFlow_h */
