...
@class HFAccessoryItemProvider, HFCameraItemProvider, HFGenericAccessoryItemProvider, HFItemManager, HFMediaAccessoryItemProvider, HFServiceItemProvider, HFTargetControlItemProvider;
...
/* instance methods */
- (id)initWithHomeKitObjectUUID:(id)uuid type:(unsigned long long)type;
...
#endif /* HUQuickControlPresentationItemManager_h */
