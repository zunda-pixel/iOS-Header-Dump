...
/* class methods */
+ (id)confirmationRequiredWithBinarySettingValueToConfirm:(long long)confirm;
+ (id)successWithResolvedBinarySettingValue:(long long)value;
...
#endif /* INBinarySettingValueResolutionResult_h */
