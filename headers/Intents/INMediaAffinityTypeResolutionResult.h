...
/* class methods */
+ (id)confirmationRequiredWithMediaAffinityTypeToConfirm:(long long)confirm;
+ (id)successWithResolvedMediaAffinityType:(long long)type;
...
#endif /* INMediaAffinityTypeResolutionResult_h */
