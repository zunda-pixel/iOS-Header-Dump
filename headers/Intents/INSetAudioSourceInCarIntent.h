...
#include "INIntent.h"
#include "INSetAudioSourceInCarIntentExport-Protocol.h"
...
- (id)initWithAudioSource:(long long)source relativeAudioSourceReference:(long long)reference;
- (id)parametersByName;
...
#endif /* INSetAudioSourceInCarIntent_h */
