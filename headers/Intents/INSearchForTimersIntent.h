...
#include "INIntent.h"
#include "INSearchForTimersIntentExport-Protocol.h"
...
- (id)initWithLabel:(id)label duration:(double)duration state:(long long)state type:(long long)type;
- (id)parametersByName;
...
#endif /* INSearchForTimersIntent_h */
