...
#include "INIntent.h"
#include "INSetLabeledSettingIntentExport-Protocol.h"
...
- (id)initWithSettingMetadata:(id)metadata labeledValue:(id)value temporalEventTrigger:(id)trigger;
- (id)parametersByName;
...
#endif /* INSetLabeledSettingIntent_h */
