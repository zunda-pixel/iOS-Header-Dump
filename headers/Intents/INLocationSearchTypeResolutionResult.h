...
/* class methods */
+ (id)confirmationRequiredWithLocationSearchTypeToConfirm:(long long)confirm;
+ (id)successWithResolvedLocationSearchType:(long long)type;
...
#endif /* INLocationSearchTypeResolutionResult_h */
