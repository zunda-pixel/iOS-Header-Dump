...
- (_Bool)_displayAndCheckForDrawable:(_Bool)drawable renderDiscontinuity:(_Bool)discontinuity withCompletion:(id /* block */)completion;
- (void)_async_prepareAndRenderForTime:(double)time inGroup:(id)group checkForDrawable:(_Bool)drawable renderDiscontinuity:(_Bool)discontinuity completion:(id /* block */)completion;
- (void)_prepareAndRenderForTime:(double)time inGroup:(id)group checkForDrawable:(_Bool)drawable renderDiscontinuity:(_Bool)discontinuity completion:(id /* block */)completion;
- (_Bool)_sync_prepareAndRenderForTime:(double)time inGroup:(id)group checkForDrawable:(_Bool)drawable renderDiscontinuity:(_Bool)discontinuity completion:(id /* block */)completion;
