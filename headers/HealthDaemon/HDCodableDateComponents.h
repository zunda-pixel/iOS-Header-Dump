...
@interface HDCodableDateComponents : PBCodable <NSCopying> {
    /* instance variables */
    struct { unsigned int day:1; unsigned int era:1; unsigned int hour:1; unsigned int minute:1; unsigned int month:1; unsigned int nanosecond:1; unsigned int quarter:1; unsigned int second:1; unsigned int weekOfMonth:1; unsigned int weekOfYear:1; unsigned int weekday:1; unsigned int weekdayOrdinal:1; unsigned int year:1; unsigned int yearForWeekOfYear:1; } _has;
}
...
#endif /* HDCodableDateComponents_h */
