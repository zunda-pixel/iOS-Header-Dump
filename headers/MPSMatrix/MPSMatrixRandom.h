...
@property (readonly, nonatomic) unsigned long long distributionType;
...
- (id)initWithDevice:(id)device destinationDataType:(unsigned int)type distributionType:(unsigned long long)type;
