...
/* instance methods */
- (void)dealloc;
- (void)encodeToCommandBuffer:(id)buffer sourceMatrix:(id)matrix rightHandSideMatrix:(id)matrix pivotIndices:(id)indices solutionMatrix:(id)matrix;
- (void)encodeToCommandEncoder:(id)encoder commandBuffer:(id)buffer sourceMatrix:(id)matrix rightHandSideMatrix:(id)matrix pivotIndices:(id)indices solutionMatrix:(id)matrix;
- (id)initWithDevice:(id)device transpose:(_Bool)transpose order:(unsigned long long)order numberOfRightHandSides:(unsigned long long)sides;

@end

#endif /* MPSMatrixSolveLU_h */
