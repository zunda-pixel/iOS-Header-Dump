...
- (id)initWithDevice:(id)device upper:(_Bool)upper order:(unsigned long long)order numberOfRightHandSides:(unsigned long long)sides;

@end

#endif /* MPSMatrixSolveCholesky_h */
