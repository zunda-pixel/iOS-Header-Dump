...
- (id)sharingURL;
- (id)ensureFileAssets;
- (id)initWithIdentifier:(id)identifier name:(id)name shortDescription:(id)description longDescription:(id)description icon:(id)icon workflowRecord:(id)record searchable:(id)searchable minVersion:(long long)version hiddenRegions:(id)regions supportedIdioms:(id)idioms createdAt:(id)at modifiedAt:(id)at language:(id)language base:(id)base persistentIdentifier:(id)identifier shortcutFile:(id)file iconFile:(id)file;
