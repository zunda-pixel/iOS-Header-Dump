...
@property (nonatomic) struct MPAddKeepLocalControlStatus { long long x0; double x1; } controlStatus;
...
/* class methods */
+ (struct CGSize { double x0; double x1; })_expectedSizeForControlStatusType:(long long)type controlTitle:(id)title hasControlImage:(_Bool)image displayScale:(double)scale preferredHeight:(double)height;
