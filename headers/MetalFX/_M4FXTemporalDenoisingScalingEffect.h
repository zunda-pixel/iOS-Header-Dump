...
//
#ifndef _M4FXTemporalDenoisingScalingEffect_h
#define _M4FXTemporalDenoisingScalingEffect_h
@import Foundation;

#include "MTL4FXTemporalDenoisedScalerSPI-Protocol.h"
#include "_MTL4FXTemporalDenoisedScaler.h"

@class MPSGraph, MPSGraphExecutable, MPSGraphTensor, _CADeveloperHUDProperties;
@protocol MTL4ArgumentTable, MTL4MachineLearningPipelineState, MTLBuffer, MTLCommandQueue, MTLDevice, MTLEvent, MTLFence, MTLHeap, MTLTensor, MTLTexture, OS_dispatch_group, OS_dispatch_queue;
...
- (id)initWithDevice:(id)device compiler:(id)compiler descriptor:(id)descriptor history:(id)history;
...
#endif /* _M4FXTemporalDenoisingScalingEffect_h */
