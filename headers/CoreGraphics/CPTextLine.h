...
- (_Bool)overlapsHorizontally:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })horizontally;
- (_Bool)overlapsWith:(id)with;
- (void)recomputeBaseline;
- (_Bool)removeTextLines:(id)lines whereTrue:(void * /* function */)_true passing:(void *)passing;
