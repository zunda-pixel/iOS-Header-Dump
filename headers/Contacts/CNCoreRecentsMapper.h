...
//
#ifndef CNCoreRecentsMapper_h
#define CNCoreRecentsMapper_h
@import Foundation;
...
- (id)contactPairs:(id)pairs sortedWithOrder:(long long)order;
- (id)initWithDomains:(id)domains configuration:(id)configuration;
- (id)initWithDomains:(id)domains environment:(id)environment recentsLibrary:(id)library;

@end

#endif /* CNCoreRecentsMapper_h */
