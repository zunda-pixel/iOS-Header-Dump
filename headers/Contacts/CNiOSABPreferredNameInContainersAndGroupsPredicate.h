...
@interface CNiOSABPreferredNameInContainersAndGroupsPredicate : CNPredicate <CNCoreRecentsPredicate, CNiOSContactPredicate>
...
- (id)initWithContainerIdentifiers:(id)identifiers groupIdentifiers:(id)identifiers;

@end

#endif /* CNiOSABPreferredNameInContainersAndGroupsPredicate_h */
