...
#include "IMPlayedReceiptProcessingParameter-Protocol.h"
...
/* instance methods */
- (id)description;
- (id)initWithDefusedMessage:(id)message idsTrustedData:(id)data isFromDefaultPairedDevice:(_Bool)device;
- (id)initWithIdsTrustedData:(id)data GUID:(id)guid timestamp:(id)timestamp isFromStorage:(_Bool)storage isLastFromStorage:(_Bool)storage isFromDefaultPairedDevice:(_Bool)device;

@end

#endif /* IMPlayedReceiptPipelineParameter_h */
