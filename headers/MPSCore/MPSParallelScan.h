...
@property (readonly, nonatomic) unsigned int sourceDataType;
@property (readonly, nonatomic) unsigned int destinationDataType;
@property (nonatomic) unsigned long long scanImpl;
...
- (id)initWithDevice:(id)device sourceDataType:(unsigned int)type destinationDataType:(unsigned int)type;
- (id)initWithDevice:(id)device sourceDataType:(unsigned int)type destinationDataType:(unsigned int)type scanOp:(int)op;

@end

#endif /* MPSParallelScan_h */
